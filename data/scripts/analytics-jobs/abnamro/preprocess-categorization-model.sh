...
"--source database --market NL --categoryTypes EXPENSES,INCOME --unhandledCategory expenses:misc.uncategorized --startDate 2000-01-01 --workingDirectory /mnt/categorization/"

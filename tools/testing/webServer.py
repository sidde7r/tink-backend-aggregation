...
GET_HEADERS = {CLUSTER_ENVIRONMENT_KEY: CLUSTER_ENVIRONMENT_VALUE , CLUSTER_NAME_KEY: CLUSTER_NAME_VALUE, ACCEPT_KEY: APPLICATION_JSON, AGGREGATOR_NAME_KEY: AGGREGATOR_NAME_VALUE}
POST_HEADERS = {CLUSTER_ENVIRONMENT_KEY: CLUSTER_ENVIRONMENT_VALUE , CLUSTER_NAME_KEY: CLUSTER_NAME_VALUE, CONTENT_TYPE_KEY: APPLICATION_JSON, ACCEPT_KEY: APPLICATION_JSON, AGGREGATOR_NAME_KEY: AGGREGATOR_NAME_VALUE}

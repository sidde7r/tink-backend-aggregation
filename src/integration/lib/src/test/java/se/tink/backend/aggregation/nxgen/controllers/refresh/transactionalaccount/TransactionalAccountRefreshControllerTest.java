...
public class TransactionalAccountRefreshControllerTest {
    ...
    @Mock private AccountFetcher<TransactionalAccount> accountFetcher;
    ...
    public void ensureExceptionIsThrown_whenMetricRefreshController_isNull() {
        new TransactionalAccountRefreshController(
                null, updateController, accountFetcher, transactionFetcher);
    }
    ...
    public void ensureNullTransactionsList_isConverted_toEmptyList() {
        ...
        Mockito.when(
                        transactionFetcher.fetchTransactionsFor(
                                Mockito.any(TransactionalAccount.class)))
                .thenReturn(null);
        ...
        Mockito.verify(transactionFetcher)
                .fetchTransactionsFor(Mockito.any(TransactionalAccount.class));

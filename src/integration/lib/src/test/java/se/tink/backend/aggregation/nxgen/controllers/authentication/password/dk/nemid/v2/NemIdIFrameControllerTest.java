...
public class NemIdIFrameControllerTest {
    ...
    public void setUp() {
        ...
        controller = new NemIdIFrameController(webdriverHelper, sleeper);
    ...
    private void initializeWebElements() {
        ...
        given(nemIdTokenMock.getText()).willReturn("--- SAMPLE TOKEN ---");
    ...
    public void doLoginWithSucceedAndReturnsToken() throws AuthenticationException {
        ...
        // when
        String result = controller.doLoginWith(USERNAME, PASSWORD, NEM_ID_PARAMETERS_V_2);
    ...
    public void doLoginWithShouldFailWhenIframeIsNotPresent() {
        ...
        Throwable throwable =
                Assertions.catchThrowable(
                        () -> controller.doLoginWith(USERNAME, PASSWORD, NEM_ID_PARAMETERS_V_2));
    ...
    public void doLoginWithShouldFailWhenNemIdReturnKnownErrorForInvalidCredentials() {
        ...
        for (String errorMsg : errorMessages) {
            ...
            Throwable throwable =
                    Assertions.catchThrowable(
                            () ->
                                    controller.doLoginWith(
                                            USERNAME, PASSWORD, NEM_ID_PARAMETERS_V_2));

...
public final class FormTest {
    ...
    public void ensureBlankKeyAndValue() {
        final Form form = Form.builder().put("", "").build();
    ...
    public void ensureKeyValueForm() {
        final Form form = Form.builder().put("coding", "fun").build();
        Assert.assertEquals(form.serialize(), "coding=fun");
    }

    @Test
    public void ensureKeyValueForm2() {
        final Form form = Form.builder().put("coding", "fun").put("immutability", "good").build();
        Assert.assertEquals(form.serialize(), "coding=fun&immutability=good");
    }

    @Test
    public void ensureValuelessForm() {
        final Form form = Form.builder().put("compressResponse").build();
    ...
    public void ensureRebuiltForm2() {
        ...
        Assert.assertEquals(
                form2.serialize(),
                "coding&compressResponse=yes&immutability=better&new+thing=shining&new+empty+entry");
    }
}

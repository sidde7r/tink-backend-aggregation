...
public class OutboxItemTest {
    ...
    public void testCorrectBuilder() {
        ...
        assertThat(item.getSource().getAccountIdentifier().getIdentifier())
                .isEqualTo("33001212121212");
        assertThat(item.getDestination().getAccountIdentifier().getIdentifier())
                .isEqualTo("33001212121213");
    }
}

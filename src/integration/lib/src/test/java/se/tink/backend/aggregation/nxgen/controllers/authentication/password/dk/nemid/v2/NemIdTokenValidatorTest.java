...
import static se.tink.backend.aggregation.nxgen.controllers.authentication.password.dk.nemid.v2.NemIdConstantsV2.NemIdErrorCodes.REJECTED;
import static se.tink.backend.aggregation.nxgen.controllers.authentication.password.dk.nemid.v2.NemIdConstantsV2.NemIdErrorCodes.TIMEOUT;
    ...
    private static List<TokenValidatorTestCase> invalidTokenStatusWithExpectedException() {
        return Stream.of(
                        TokenValidatorTestCase.of(
                                NemIdTokenStatus.builder().code("fail").message(REJECTED).build(),
                                NemIdError.REJECTED.exception()),
                        TokenValidatorTestCase.of(
                                NemIdTokenStatus.builder().code("fail").message(TIMEOUT).build(),

...
public class OtpUtilsTest {
    private static final String FINGERPRINT = "CF190D3E7E8D6C460DADBB9D9C7E0E63FE5AD07E5E1A0B32320EBAF4978503E3";
    private static final String XFAD = "";
    ...
    public void testTimeXor() {
        ...
        Assert.assertEquals("(epoch>>4) ^ data did not match.", EXPECTED_TIME_XORED_DATA, timeDataHex);
    }
    ...
    public void testMashupChallenge() {
        ...
        byte[] mashup = OtpUtils.mashupChallenge(key, diversifier, 0, EPOCH_TIME,
    ...
    public void testCalculateOtp() {
        ...
        String otpResponse = OtpUtils.calculateOtp(
                FINGERPRINT,
                staticVector,
                key,
                0,
        ...
        Assert.assertEquals("Challenge response was not correct.", EXPECTED_CHALLENGE_0_RESPONSE, otpResponse);
    }

    @Test
    public void testCalculateDerivationCode() {
        StaticVector staticVector = StaticVector.createFromXfad(XFAD);
        String derivationCode = OtpUtils.calculateDerivationCode(
                FINGERPRINT,
                staticVector,
                EXPECTED_CHALLENGE_1_RESPONSE);

        Assert.assertEquals("Derivation code was not correct.", EXPECTED_DERIVATION_CODE, derivationCode);
    }
}

...
public class ClientRegistration {
    ...
    public static class Builder {
        ...
        public String build(JwtSigner signer) {
            ...
            String softwareStatementAssertion = softwareStatement.getAssertion().getAssertion();
        ...
        //                    .withClaim(OpenIdConstants.Params.SOFTWARE_ID, softwareId)
        //                    .withClaim(
        //                            OpenIdConstants.Params.SOFTWARE_STATEMENT,
        // softwareStatementAssertion)
        //                    .withClaim(OpenIdConstants.Params.SCOPE, scope)
        //                    .withClaim(
        //                            OpenIdConstants.Params.TOKEN_ENDPOINT_AUTH_METHOD,
        //                            tokenEndpointAuthMethod)
        //                    .withClaim(
        //                            OpenIdConstants.Params.ID_TOKEN_SIGNED_RESPONSE_ALG,
        // idTokenSigningAlg)
        //                    .withClaim(
        //                            OpenIdConstants.Params.TOKEN_ENDPOINT_AUTH_SIGNING_ALG,
        //                            tokenEndpointSigningAlg)
        ...
        //            object.put(OpenIdConstants.Params.SOFTWARE_STATEMENT,
        // softwareStatementAssertion);
        //            object.put(OpenIdConstants.Params.SCOPE, scope.split(" "));
        //            object.put(OpenIdConstants.Params.TOKEN_ENDPOINT_AUTH_METHOD,
        // tokenEndpointAuthMethod);
        //            object.put(OpenIdConstants.Params.ID_TOKEN_SIGNED_RESPONSE_ALG,
        // idTokenSigningAlg);
        //            object.put(
        //                    OpenIdConstants.Params.TOKEN_ENDPOINT_AUTH_SIGNING_ALG,
        //                    tokenEndpointSigningAlg);
        //            object.put(OpenIdConstants.Params.REQUEST_OBJECT_SIGNING_ALG,
        // requestObjectSigningAlg);
        //            object.put(OpenIdConstants.Params.APPLICATION_TYPE,
        // OpenIdConstants.ParamDefaults.WEB);
        //            object.put(
        //                    OpenIdConstants.Params.REDIRECT_URIS,
        // softwareStatement.getAllRedirectUris());
        //            object.put(OpenIdConstants.Params.GRANT_TYPES,
        // JwtUtils.listToStringArray(grantTypes));
        //            object.put(
        //                    OpenIdConstants.Params.RESPONSE_TYPES,
        //                    JwtUtils.listToStringArray(responseTypes));
        ...
        //            object.put(PAYLOAD_CLAIMS.TLS_CLIENT_AUTH_DN,
        // OpenIdConstants.TINK_TLS_AUTH_CLIENT_DN);
        //            return object;
        //        }
    }

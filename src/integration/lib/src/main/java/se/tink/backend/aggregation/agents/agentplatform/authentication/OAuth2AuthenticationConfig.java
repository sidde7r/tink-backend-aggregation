...
public class OAuth2AuthenticationConfig {
    ...
    public RedirectFetchRefreshableAccessTokenStep fetchAuthenticationTokensStep(
        ...
        return new RedirectFetchRefreshableAccessTokenStep(
                fetchTokenCall,
                errorVerifier(),
                agentRedirectTokensAuthenticationPersistedDataAccessorFactory());
    }
    ...
    public RefreshableAccessTokenValidator redirectTokensValidator() {
        return new RefreshableAccessTokenValidator();
    }

    public AgentRefreshableAccessTokenAuthenticationPersistedDataAccessorFactory
            agentRedirectTokensAuthenticationPersistedDataAccessorFactory() {

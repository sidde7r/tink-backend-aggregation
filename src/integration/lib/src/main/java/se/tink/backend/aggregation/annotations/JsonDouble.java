...
/**
 * Annotation used for serializing double values in a more controlled way (e.g. by limiting number
 * of decimals, trailing zeros, or by converting to String and setting grouping separator, prefix,
 * etc), by attaching to "getter" methods, or fields.
 *
 * <p>Example of default annotation behaviour:
 *
 * <pre>
 *     &#64;JsonDouble

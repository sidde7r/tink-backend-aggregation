...
public class InvestmentGenerator {
    ...
    public static Collection<InvestmentAccount> fetchInvestmentAccounts(
            String currency, DemoInvestmentAccount accountDefinition) {
    ...
    private static Portfolio generateFakePortolio(
            String accountId, double balance, Portfolio.Type type) {
    ...
    private static Instrument createFakeInstrument(
            String ISIN,
            String marketplace,
            String currency,
            String name,

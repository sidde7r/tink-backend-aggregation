...
@XmlType(
        ...
        propOrder = {"rfrdDocInf", "rfrdDocAmt", "cdtrRefInf", "invcr", "invcee", "addtlRmtInf"})
public class StructuredRemittanceInformation7 {
     ...
     * why there is not a <CODE>set</CODE> method for the rfrdDocInf property.
     *
     ...
     *
     * @return possible object is {@link RemittanceAmount1 }
     */
     ...
     *
     * @param value allowed object is {@link RemittanceAmount1 }
     */
     ...
     * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
     * modification you make to the returned list will be present inside the JAXB object. This is
     * why there is not a <CODE>set</CODE> method for the addtlRmtInf property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>

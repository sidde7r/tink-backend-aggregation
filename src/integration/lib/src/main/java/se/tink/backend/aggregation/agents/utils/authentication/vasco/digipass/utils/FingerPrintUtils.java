...
public class FingerPrintUtils {
    ...
    public static byte[] getFingerPrintDiversifier(String fingerprint, StaticVector staticVector) {
        ...
        Optional<Long> initialValue =
                staticVector.getFieldAsLong(DigipassConstants.StaticVectorFieldType.INITIAL_VALUE);
        ...
        if (initialValue.isPresent() && diversifierLength.isPresent()) {
            int CONSTANT =
                    3; // Unknown from where this value is taken from, possibly type `8` or `56`

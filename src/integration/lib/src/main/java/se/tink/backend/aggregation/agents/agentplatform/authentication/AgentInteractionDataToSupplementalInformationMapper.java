...
public class AgentInteractionDataToSupplementalInformationMapper {
    ...
    public ThirdPartyRequestWithStateParam toThirdPartyRequest(final String redirectURL) {
        return new ThirdPartyRequestWithStateParam(redirectURL, 9, TimeUnit.MINUTES);
    }
}

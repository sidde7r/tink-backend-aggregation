...
public class PlainTextMessageService {
    ...
    static ActivationFirstRequestBody createActivationFirstRequestBody(
    ...
    static ActivationSecondRequestBody createActivationSecondRequestBody(
            Map<String, String> encapStorage) {
    ...
    static AuthenticationFirstRequestBody createAuthenticationFirstRequestBody(
            Map<String, String> encapStorage) {
    ...
    static AuthenticationSecondRequestBody createAuthenticationSecondRequestBody(
            Map<String, String> encapStorage) {

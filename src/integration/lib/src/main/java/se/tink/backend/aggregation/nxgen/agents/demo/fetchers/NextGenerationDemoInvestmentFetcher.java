...
public class NextGenerationDemoInvestmentFetcher
        implements AccountFetcher<InvestmentAccount>, TransactionPaginator<InvestmentAccount> {

    private String currency;
    private DemoInvestmentAccount accountDefinition;

    public NextGenerationDemoInvestmentFetcher(

...
public class EnumMapper {
    ...
    public static final Map<IntegrationCredentials.Type, Credentials.Type> CREDENTIALS_TYPE =
            new ImmutableMap.Builder<IntegrationCredentials.Type, Credentials.Type>()
                    .put(IntegrationCredentials.Type.TYPE_PASSWORD, Credentials.Type.PASSWORD)
                    .put(
                            IntegrationCredentials.Type.TYPE_THIRD_PARTY_AUTHENTICATION,

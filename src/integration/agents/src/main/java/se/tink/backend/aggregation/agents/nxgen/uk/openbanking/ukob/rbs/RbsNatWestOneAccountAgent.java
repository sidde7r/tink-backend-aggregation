...
public class RbsNatWestOneAccountAgent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                UkOpenBankingAisConfiguration.builder()
                        ...
                        .withWellKnownURL(RbsConstants.NATWEST_ONE_ACCOUNT_WELL_KNOWN_URL)
                        .build();
    }

    @Inject
    public RbsNatWestOneAccountAgent(

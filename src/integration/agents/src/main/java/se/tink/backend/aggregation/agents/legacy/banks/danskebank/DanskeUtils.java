...
public class DanskeUtils {
    private static final ImmutableMap<ClearingNumber.Bank, String> BANK_ID_LOOKUP_TABLE =
            ImmutableMap.<ClearingNumber.Bank, String>builder()
                    ...
                    .put(
                            ClearingNumber.Bank.ERIK_PENSER_BANKAKTIEBOLAG,
                            "9590ERIK PENSER BANKAKTIEBOLAG")
                    ...
                    .put(
                            ClearingNumber.Bank.SANTANDER_CONSUMER_BANK,
                            "9460Santander Consumer Bank AS")
    ...
    public static final TypeMapper<Portfolio.Type> PORTFOLIO_TYPE_MAPPER =
    ...
    public static final TypeMapper<AccountTypes> ACCOUNT_TYPE_MAPPER =
            TypeMapper.<AccountTypes>builder().put(AccountTypes.CHECKING, "Danske Konto").build();
    ...
    public static String getBankId(AccountIdentifier accountIdentifier) {
        ...
        Optional<ClearingNumber.Details> clearing =

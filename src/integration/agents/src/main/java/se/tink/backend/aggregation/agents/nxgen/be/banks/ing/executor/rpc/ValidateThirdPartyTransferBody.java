...
public class ValidateThirdPartyTransferBody extends MultivaluedMapImpl {
    ...
    public ValidateThirdPartyTransferBody(
            Transfer transfer,
        ...
        add(
                IngConstants.Transfers.ValuePairs.B_ADDRESS.getKey(),
                IngConstants.Transfers.ValuePairs.B_ADDRESS.getValue());
        add(
                IngConstants.Transfers.ValuePairs.B_CITY.getKey(),
                IngConstants.Transfers.ValuePairs.B_CITY.getValue());
        add(
                IngConstants.Transfers.ValuePairs.B_COUNTRY.getKey(),

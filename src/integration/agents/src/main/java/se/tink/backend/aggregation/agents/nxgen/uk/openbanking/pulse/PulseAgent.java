package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.pulse;
...
public class PulseAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("pulse");
    }

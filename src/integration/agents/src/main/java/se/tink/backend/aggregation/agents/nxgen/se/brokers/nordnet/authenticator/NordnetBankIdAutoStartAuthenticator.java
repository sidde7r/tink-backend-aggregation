...
import se.tink.backend.aggregation.agents.nxgen.se.brokers.nordnet.authenticator.rpc.BankIdPollRequest;
import se.tink.backend.aggregation.agents.nxgen.se.brokers.nordnet.authenticator.rpc.InitBankIdResponse;
import se.tink.backend.aggregation.agents.nxgen.se.brokers.nordnet.authenticator.rpc.LoginResponse;
import se.tink.backend.aggregation.agents.nxgen.se.brokers.nordnet.authenticator.rpc.PollBankIdResponse;
...
public class NordnetBankIdAutoStartAuthenticator implements BankIdAuthenticator<String> {
    ...
    public NordnetBankIdAutoStartAuthenticator(
            NordnetApiClient apiClient, PersistentStorage persistentStorage) {

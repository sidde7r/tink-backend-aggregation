package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.lauraashley;
...
public class LauraAshleyAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("lauraashley");
    }

    @Inject
    public LauraAshleyAgent(

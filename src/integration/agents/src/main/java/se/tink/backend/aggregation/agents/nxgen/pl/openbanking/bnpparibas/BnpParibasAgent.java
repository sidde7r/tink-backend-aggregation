...
import static se.tink.backend.aggregation.agents.nxgen.pl.openbanking.bnpparibas.BnpParibasConstants.ACCOUNT_TYPE_MAPPER;
...
public class BnpParibasAgent extends PolishApiAgent {
    ...
    public PolishAccountsApiUrlFactory getAccountApiUrlFactory() {
        return new PolishPostAccountsApiUrlFactory(
                new URL(BnpParibasConstants.Urls.BASE_URL), BnpParibasConstants.Urls.VERSION);
    }

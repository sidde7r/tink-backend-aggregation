...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.ukopenbanking.v20.fetcher.authenticator.rpc.AccountPermissionResponseV20;
...
public class UkOpenBankingV20PisConfiguration implements UkOpenBankingPisConfig {
    ...
    public <T extends AccountPermissionResponse> Class<T> getIntentIdResponseType() {
        return (Class<T>) AccountPermissionResponseV20.class;
    }
    ...
    public URL getDomesticPaymentConsentURL(String consentId) {
        return pisBaseURL
                ...
                .parameter(
                        UkOpenBankingConstants.ApiServices.UrlParameterKeys.CONSENT_ID, consentId);
    }
    ...
    public URL getDomesticPayment(String domesticPaymentId) {
        return pisBaseURL
                ...
                .parameter(
                        UkOpenBankingConstants.ApiServices.UrlParameterKeys.PAYMENT_ID,
                        domesticPaymentId);
    }

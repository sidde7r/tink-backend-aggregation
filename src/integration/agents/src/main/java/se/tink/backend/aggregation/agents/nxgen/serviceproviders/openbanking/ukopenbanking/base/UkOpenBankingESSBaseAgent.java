...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.ukopenbanking.base.configuration.UkOpenBankingESSConfiguration;
...
public abstract class UkOpenBankingESSBaseAgent extends NextGenerationAgent
    ...
    public UkOpenBankingESSConfiguration getClientConfiguration() {
        return getAgentConfigurationController()
                .getAgentConfiguration(UkOpenBankingESSConfiguration.class);
    }
    ...
    public void setConfiguration(AgentsServiceConfiguration configuration) {
        ...
        UkOpenBankingESSConfiguration ukOpenBankingConfiguration = getClientConfiguration();

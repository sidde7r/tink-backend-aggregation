...
public class LaBanquePostaleAuthenticator extends BerlinGroupAuthenticator implements Authenticator {

  private final LaBanquePostaleApiClient apiClient;
  private final SessionStorage sessionStorage;

  public LaBanquePostaleAuthenticator(LaBanquePostaleApiClient apiClient, SessionStorage sessionStorage){
    super(apiClient);

...
public class MonzoConstants {
    ...
    public static final String ORGANISATION_ID = "001580000103U9RAAU";

    public static final String AIS_API_URL = "https://openbanking.monzo.com/open-banking/v3.1/aisp";
    public static final String PIS_API_URL = "https://openbanking.monzo.com/open-banking/v3.1/pisp";

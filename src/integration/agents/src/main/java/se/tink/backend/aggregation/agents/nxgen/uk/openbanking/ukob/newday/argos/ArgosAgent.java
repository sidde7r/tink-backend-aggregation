package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.newday.argos;
...
public class ArgosAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("argos");
    }

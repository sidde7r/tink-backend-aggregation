package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.cashplus;
    ...
    static {
        aisConfig =
                UkOpenBankingAisConfiguration.builder()
                        ...
                        .withApiBaseURL("https://matls.api.ob.cashplus.com/open-banking/v3.1/aisp")
                        .withWellKnownURL(
                                "https://identity.ob.cashplus.com/.well-known/openid-configuration")
                        .withOrganisationId("0015800001ZEZ3gAAH")
                        .build();
    }

...
public class SebLTAgent extends SebBalticsBaseAgent<SebLTApiClient>
        implements RefreshCheckingAccountsExecutor, RefreshSavingsAccountsExecutor {

    private final TransactionalAccountRefreshController transactionalAccountRefreshController;

    @Inject
    protected SebLTAgent(AgentComponentProvider componentProvider) {
        super(componentProvider);
        configureHttpClient(client);
        this.apiClient = new SebLTApiClient(client, persistentStorage, request);
    ...
    @Override
    protected SebLTApiClient getApiClient() {

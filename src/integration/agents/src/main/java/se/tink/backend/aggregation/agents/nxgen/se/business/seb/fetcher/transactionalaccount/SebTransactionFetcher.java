...
import se.tink.backend.aggregation.agents.nxgen.se.business.seb.SebConstants.StorageKeys;
...
import se.tink.backend.aggregation.agents.nxgen.se.business.seb.fetcher.transactionalaccount.entities.TransactionPageKey;
...
public class SebTransactionFetcher
    ...
    public TransactionKeyPaginatorResponse<TransactionPageKey> getTransactionsFor(
        ...
        final TransactionQuery transactionQuery = getTransactionQuery(account, key);
        final Response response = apiClient.fetchTransactions(transactionQuery);

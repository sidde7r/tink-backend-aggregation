package se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.deutschebank.session;
...
public final class DeutscheBankSessionHandler implements SessionHandler {
    ...
    public DeutscheBankSessionHandler(DeutscheBankApiClient apiClient) {

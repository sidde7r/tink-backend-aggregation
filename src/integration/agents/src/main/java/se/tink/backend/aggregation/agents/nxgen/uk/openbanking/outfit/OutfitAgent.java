package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.outfit;
...
public class OutfitAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("outfit");
    }

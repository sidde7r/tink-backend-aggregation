package se.tink.backend.aggregation.agents.nxgen.fr.openbanking.creditagricolelorraine;
...
public class CreditagricoleLorraineAgent extends CreditAgricoleBaseAgent {
    public CreditagricoleLorraineAgent(CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(request, context, signatureKeyPair, BankEnum.LORRAINE);
    }
}

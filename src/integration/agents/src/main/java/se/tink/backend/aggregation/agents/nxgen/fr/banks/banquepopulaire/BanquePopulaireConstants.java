...
public class BanquePopulaireConstants {
    ...
    public static final class Headers {
        ...
        public static final String USER_AGENT =
                "BanquePopulaire/3.21.3 (iPhone; iOS 10.3.1; Scale/2.00)";
    ...
    public static final class Urls {
        ...
        public static final String GENERAL_CONFIG =
                COMMON_HOST_BASE_URL + "/mapi/1.1/general-config";
        ...
        public static final String CONTRACT_DETAILS_PATH =
                "/contrats/{" + Fetcher.ACCOUNT_PARAMETER + "}";
        public static final String TRANSACTIONS_PATH =
                "/comptes/{" + Fetcher.ACCOUNT_PARAMETER + "}/operations";
    ...
    public static final class Account {
        ...
        public static final Map<String, AccountTypes> NON_ACCOUNT_TYPE_MAPPER =
    ...
    public static final class Loan {
        ...
        public static final Map<String, LoanDetails.Type> LOAN_TYPE_MAPPER =
                ImmutableMap.of("01634", LoanDetails.Type.STUDENT);
    ...
    public static final class Currency {
        ...
        public static final Map<String, String> CURRENCY_CODE_MAPPER =
                ImmutableMap.of(
                        "978", "EUR",
                        "826", "GBP",
                        "840", "USD",

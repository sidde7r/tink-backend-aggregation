...
public class AccountEntity {
    ...
    public void setMessageValidCharactersDisplay(String messageValidCharactersDisplay) {
    ...
    public void setMessageValidCharactersExpression(String messageValidCharactersExpression) {
    ...
    public void setUpcomingBillsCurrentMonthAmount(String upcomingBillsCurrentMonthAmount) {
    ...
    public Account toAccount() {
        ...
        if (StringUtils.trimToNull(alias) != null) {
            ...
            account.setName(
                    Optional.ofNullable(StringUtils.trimToNull(accountTypeDescription)).orElse(""));
        }
        ...
        if (StringUtils.trimToNull(disposableAmount) != null) {
            // Preferable.
            account.setBalance(
                    AgentParsingUtils.parseAmount(disposableAmount)
                            - Optional.ofNullable(creditLimit)
                                    .map(AgentParsingUtils::parseAmount)
                                    .orElse(0.0));
        } else {

...
public class ContractOverviewEntity {
    ...
    public boolean isUnhandledLoanType() {
        return BanquePopulaireConstants.Loan.toTinkLoanType(productId.getCode())
                == LoanDetails.Type.OTHER;
    }
    ...
    public TransactionalAccount toTinkTransactionalAccount() {
        return TransactionalAccount.builder(
                        getTinkAccountType(), externalReference, balance.toTinkAmount())
    ...
    public String createTransactionalAccountBankIdentifier() {
        return String.format(
                "%s-%s-%s",
                contractId.getBankCode(), contractType.getCode(), contractId.getIdentifier());
    }

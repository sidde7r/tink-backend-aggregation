package se.tink.backend.aggregation.agents.nxgen.fr.openbanking.creditagricolealpesprovence;
...
public class CreditAgricoleAlpesprovenceAgent extends CreditAgricoleBaseAgent {
    public CreditAgricoleAlpesprovenceAgent(CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {

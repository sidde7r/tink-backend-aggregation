...
public class PreAuthorizationCall extends SimpleExternalApiCall<AuthenticationData, String> {

    private final ConfigurationProvider configurationProvider;

    public PreAuthorizationCall(
    ...
    static class RequestBody {
        ...
        static class ChallengeResponse {
            ...
            static class UserLoginRequest {
                ...
                private String wlVersion = APP_VERSION;
                ...
                private String operatingSystem = OS_NAME;

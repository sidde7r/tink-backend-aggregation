package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.natwest;
...
public class NatWestV31UniversalAgent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                UkOpenBankingAisConfiguration.builder()
                        ...
                        .withWellKnownURL(NatWestConstants.UNIVERSAL_LINKS_WELL_KNOWN_URL)
                        .build();
    }

    @Inject
    public NatWestV31UniversalAgent(

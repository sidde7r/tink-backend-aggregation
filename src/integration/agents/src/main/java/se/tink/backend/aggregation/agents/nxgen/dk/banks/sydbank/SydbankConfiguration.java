...
public class SydbankConfiguration implements BankDataConfiguration {
    @Override
    public String getAuthHost() {
        return "https://auth.sydbank.dk";
    }

    @Override
    public String getHost() {
        return "https://api.sydbank.dk";
    }

    @Override
    public String getUserAgent() {
        return "Sydbank/2021.10.22 (iPhone; iOS 13.3.1; Scale/3.00)";
    }
    ...
    public String getReferer() {
        return "https://auth.sydbank.dk/authentication/nemid_bank_twofactor";
    }

    @Override
    public String getRedirectUri() {
        return "drb://drb.sydbank.dk/dcr-callback.html";
    }
}

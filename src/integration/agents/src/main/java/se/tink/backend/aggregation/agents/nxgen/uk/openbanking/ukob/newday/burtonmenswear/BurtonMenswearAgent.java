package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.newday.burtonmenswear;
...
public class BurtonMenswearAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("burton");
    }

    @Inject
    public BurtonMenswearAgent(

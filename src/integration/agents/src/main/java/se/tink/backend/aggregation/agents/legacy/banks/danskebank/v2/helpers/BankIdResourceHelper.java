...
public class BankIdResourceHelper {
    ...
    private static final String URL_PUBLICSERVICE_BANKID_AUTH =
            BASE_URL_PUBLICSERVICE + "/REI/swbankid/auth";
    private static final String URL_PRIVATESERVICE_BANKID_SIGN =
            BASE_URL_PRIVATESERVICE + "/RES/swbankid/sign";
    ...
    /**
     * Encryption methods used in Android app to generate auth headers and help out with encryption
     * of messages and authorization headers
     */

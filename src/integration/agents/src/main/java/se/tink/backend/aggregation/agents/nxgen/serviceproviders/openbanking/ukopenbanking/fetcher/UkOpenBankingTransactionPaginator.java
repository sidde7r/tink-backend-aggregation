...
public class UkOpenBankingTransactionPaginator<ResponseType, AccountType extends Account>
     ...
     *     se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.ukopenbanking.fetcher.TransactionConverter#toPaginatorResponse(Object,
     *     Account)}
     */
    ...
    public TransactionKeyPaginatorResponse<String> getTransactionsFor(
        ...
        if (key == null) {
            key =
                    UkOpenBankingConstants.ApiServices.getInitialTransactionsPaginationKey(

...
/**
 * Monzo has something called "pots" - some sort of subaccounts. The balance of the pots is not
 * included in "balance", but it is included in "total_balance". Either you use balance and get the
 * pots/subaccounts separately, or you use totalBalance and disregard the pots. Since Tink doesn't
 * have the concept of subaccounts, we use totalBalance.
 */
@JsonObject

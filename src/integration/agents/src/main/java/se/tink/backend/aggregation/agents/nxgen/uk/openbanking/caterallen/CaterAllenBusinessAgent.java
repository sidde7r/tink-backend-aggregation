...
public class CaterAllenBusinessAgent extends UkOpenBankingBaseAgent {
    ...
    @Inject
    public CaterAllenBusinessAgent(AgentComponentProvider componentProvider, JwtSigner jwtSigner) {

...
public class SantanderEsApiClient {
    ...
    public String authenticateCredentials(String username, String password) {
        ...
        return postSoapMessage(
                SantanderEsConstants.Urls.AUTHENTICATION_ENDPOINT,
    ...
    public String fetchTransactions(
        ...
        String requestBody =
                getTransactionsRequestBody(
                        userDataXmlString, contractIdXmlString, balanceXmlString, repositionEntity);
    ...
    public CreditCardDetailsResponse fetchCreditCardDetails(String userDataXml, String cardNumber) {
        String creditCardDetailsRequest =
                SantanderEsCreditCardDetailsRequest.create(
                        tokenCredential, userDataXml, cardNumber);
    ...
    public FundDetailsResponse fetchFundDetails(String userDataXml, FundEntity fundEntity) {
        String fundDetailsRequest =
                FundDetailsRequest.create(tokenCredential, userDataXml, fundEntity);

        String soapResponseString =
                postSoapMessage(
                        SantanderEsConstants.Urls.FUNDS_ENDPOINT,
    ...
    public CreditCardTransactionsResponse fetchCreditCardTransactions(
            ...
            LocalDate fromDate,
            LocalDate toDate,
            CreditCardRepositionEntity pagination) {
        String creditCardTransactionsRequest =
                SantanderEsCreditCardTransactionsRequest.create(
                        tokenCredential, userDataXml, card, fromDate, toDate, pagination);
    ...
    public PortfolioDetailsResponse fetchPortfolioDetails(
            ...
            boolean firstPage,
            PortfolioRepositionEntity paginationData) {

        String portfolioDetailsRequest =
                PortfolioDetailsRequest.create(
                        tokenCredential, userDataXml, portfolio, firstPage, paginationData);

        String soapResponseString =
                postSoapMessage(
                        SantanderEsConstants.Urls.STOCKS_ENDPOINT,
    ...
    public InstrumentDetailsResponse fetchInstrumentDetails(
            String userDataXml, StockEmissionCode emissionCode) {
        String instrumentDetailsRequest =
                InstrumentDetailsRequest.create(tokenCredential, userDataXml, emissionCode);
    ...
    private String getTransactionsRequestBody(
        ...
        return TransactionPaginationRequest.create(
                tokenCredential,
                userDataXmlString,
                contractIdXmlString,
                balanceXmlString,

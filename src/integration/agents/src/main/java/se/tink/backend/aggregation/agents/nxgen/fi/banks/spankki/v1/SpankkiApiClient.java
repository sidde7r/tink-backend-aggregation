...
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.authenticator.rpc.AddDeviceRequest;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.authenticator.rpc.AddDeviceResponse;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.authenticator.rpc.LoginRequest;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.authenticator.rpc.PinLoginResponse;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.authenticator.rpc.RequestChallengeRequest;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.authenticator.rpc.RequestChallengeResponse;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.authenticator.rpc.RespondToChallengeRequest;
...
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.investment.rpc.AllFundsRequest;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.investment.rpc.AllFundsResponse;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.investment.rpc.FundsPortfoliosResponse;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.loan.entities.LoanDetailsIdentity;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.loan.rpc.LoanDetailsRequest;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.loan.rpc.LoanDetailsResponse;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.loan.rpc.LoanOverviewRequest;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.loan.rpc.LoanOverviewResponse;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.transactionalaccount.rpc.GetAccountsResponse;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.transactionalaccount.rpc.GetTransactionsRequest;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.transactionalaccount.rpc.GetTransactionsResponse;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.transactionalaccount.rpc.ReservationsRequest;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.transactionalaccount.rpc.ReservationsResponse;

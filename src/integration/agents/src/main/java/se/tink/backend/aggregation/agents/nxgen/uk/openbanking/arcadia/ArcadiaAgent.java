package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.arcadia;
...
public class ArcadiaAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("arcadia");
    }

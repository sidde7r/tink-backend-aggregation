...
public class ArbuthnotlathamAgent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                UkOpenBankingAisConfiguration.builder()
                        .withOrganisationId(ArbuthnotlathamConstants.ORGANISATION_ID)
                        .withWellKnownURL(ArbuthnotlathamConstants.BUSINESS_WELL_KNOWN_URL)
                        .withApiBaseURL(ArbuthnotlathamConstants.AIS_API_URL)
                        .withPartyEndpoints(PartyEndpoint.PARTY)
                        .build();
    }

    @Inject
    public ArbuthnotlathamAgent(

package se.tink.backend.aggregation.agents.nxgen.fr.openbanking.creditagricolebriepicardie;
...
public class CreditAgricoleBriepicardieAgent extends CreditAgricoleBaseAgent {
    public CreditAgricoleBriepicardieAgent(CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(request, context, signatureKeyPair, BankEnum.BRIE_PICARDIE);
    }
}

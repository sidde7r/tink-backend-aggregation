...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.newday.authenticator.NewDayAisAuthenticator;
...
public class NewDayBaseAgent extends UkOpenBankingBaseAgent {

    public final NewDayConfiguration aisConfig;
    private final AgentComponentProvider componentProvider;

    public NewDayBaseAgent(
    ...
    private UkOpenBankingAisAuthenticationController createUkObAuthController() {
        return new UkOpenBankingAisAuthenticationController(
                ...
                this.apiClient,
                new NewDayAisAuthenticator(this.apiClient),
                this.credentials,

...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.ukopenbanking.base.pis.helper.UkOpenbankingPaymentHelper;
...
public class UKOpenbankingExecutor implements PaymentExecutor, FetchablePaymentExecutor {
    private static Logger log = LoggerFactory.getLogger(UKOpenbankingExecutor.class);
    ...
    public UKOpenbankingExecutor(
        ...
        this.ukOpenbankingPaymentHelper =
                new UkOpenbankingPaymentHelper(this.apiClient, Clock.systemUTC());
    }

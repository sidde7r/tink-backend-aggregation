package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.newday.houseoffraser;
...
public class HouseOfFraserAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("houseoffraser");
    }

    @Inject
    public HouseOfFraserAgent(

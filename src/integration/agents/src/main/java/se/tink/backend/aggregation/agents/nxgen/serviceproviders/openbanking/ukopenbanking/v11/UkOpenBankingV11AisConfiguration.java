...
public class UkOpenBankingV11AisConfiguration implements UkOpenBankingAisConfig {

    private final URL apiBaseURL;
    private final URL authBaseURL;

    public UkOpenBankingV11AisConfiguration(String apiBaseURL, String authBaseURL) {

...
public class AccountEntity {
    @JsonProperty
    public PermissionsEntity permissions;
    ...
    public TransactionalAccount toTinkAccount() {
        ...
        return TransactionalAccount.builder(NordeaFIConstants.ACCOUNT_TYPE_MAPPER.translate(category).get(), iban,
                new Amount(NordeaFIConstants.CURRENCY, availableBalance))
                .setHolderName(roles.stream().filter(AccountOwnerEntity::isOwner).map(AccountOwnerEntity::getHolderName)

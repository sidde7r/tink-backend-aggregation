...
public class NordicChoiceClubNoAgent extends SebBrandedCardsAgent {

    public NordicChoiceClubNoAgent(
            CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(
                request,
                context,
                signatureKeyPair,
                SebBrandedCardsConstants.BrandedCards.Norway.NORDIC_CHOICE_CLUB);
    }
}

...
public final class AuthorizationCsrEntity {
    @JsonProperty
    private WlDeviceAutoProvisioningRealmEntity wl_deviceAutoProvisioningRealm;

    public AuthorizationCsrEntity(final WlDeviceAutoProvisioningRealmEntity wl_deviceAutoProvisioningRealm) {

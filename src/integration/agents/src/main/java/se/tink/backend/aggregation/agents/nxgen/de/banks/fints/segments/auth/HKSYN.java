...
public class HKSYN extends FinTsSegment {
    ...
    private static final int SYNC_MODE_NEW_CUSTOMER_ID = 0;
    private static final int SYNC_MODE_LAST_MSG_NUMBER = 1;
    private static final int SYNC_MODE_SIGNATURE_ID = 2;

...
public class NordeaNoBankIdSigner implements BankIdSigner<PaymentRequest> {

    private NordeaNoPaymentExecutorSelector paymentExecutor;

    public NordeaNoBankIdSigner(NordeaNoPaymentExecutorSelector paymentExecutor) {

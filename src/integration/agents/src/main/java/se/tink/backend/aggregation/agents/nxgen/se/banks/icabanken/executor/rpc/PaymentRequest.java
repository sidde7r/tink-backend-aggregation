...
public class PaymentRequest implements TransferRequest {
    ...
    private PaymentRequest(Transfer transfer, AccountEntity sourceAccount, RecipientEntity destinationAccount) {
    ...
    public static PaymentRequest create(Transfer transfer, AccountEntity sourceAccount,

...
public class TransactionsItem{
	...
	public Transaction toTinkTransaction()  {
			...
			return Transaction.builder()
					.setDate(getDate())
					.setAmount(new Amount(transactionAmount.getCurrency(), transactionAmount.getContent()))
					.setDescription(remittanceInformation)
					.setPending(status.equalsIgnoreCase(HandelsbankenBaseConstants.Transactions.PENDING_TYPE))
					.build();

package se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sebcard.eurocarddk;
...
public class EurocardDKAgent extends SebBrandedCardsAgent {

    public EurocardDKAgent(
            CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(
                request,
                context,
                signatureKeyPair,
                SebBrandedCardsConstants.BrandedCardsDenmark.EUROCARD);
    }
}

...
public enum ProviderMapping {
    ...
    HØNEFOSS("2230", AuthenticationType.PORTAL),
    HØLAND_OG_SETSKOG("1280", AuthenticationType.PORTAL),
    INDRE_SOGN("3730", AuthenticationType.PORTAL),
    JÆREN("3290", AuthenticationType.PORTAL),
    JERNBANEPERSONALETS_BANK_OG_FORSIKRING("1440", AuthenticationType.PORTAL),
    KLÆBU("4358", AuthenticationType.PORTAL),
    KVINESDAL("3080", AuthenticationType.PORTAL),
    LARVIKBANKEN("2510", AuthenticationType.PORTAL),
    LILLESTRØMBANKEN("1286", AuthenticationType.PORTAL),
    ...
    ØRLAND("4290", AuthenticationType.PORTAL),
    ØRSKOG("4060", AuthenticationType.PORTAL),
    RINDAL("4111", AuthenticationType.PORTAL),
    RØROSBANKEN("4280", AuthenticationType.PORTAL),
    ...
    STRØMMEN("1310", AuthenticationType.PORTAL),
    ...
    TRØGSTAD("1140", AuthenticationType.PORTAL),

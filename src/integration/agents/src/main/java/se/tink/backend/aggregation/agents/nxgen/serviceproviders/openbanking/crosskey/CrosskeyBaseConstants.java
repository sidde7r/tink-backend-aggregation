...
public abstract class CrosskeyBaseConstants {
    ...
    public static class Urls {
        ...
        public static final String ACCOUNT_ACCESS_CONSENTS = "/open-banking/v3.1/aisp/account-access-consents";
        public static final String ACCOUNT_ACCESS_CONSENT = "/open-banking/v3.1/aisp/account-access-consents/{consentId}";
        public static final String ACCOUNTS = "/open-banking/v3.1/aisp/accounts";
        public static final String ACCOUNT_BALANCES = "/open-banking/v3.1/aisp/accounts/{accountId}/balances";
        public static final String ACCOUNT_TRANSACTIONS = "/open-banking/v3.1/aisp/accounts/{accountId}/transactions";
    }
    ...
    public static class OIDCValues {
        ...
        public static final String[] CONSENT_PERMISSIONS = {"ReadAccountsDetail", "ReadBalances",

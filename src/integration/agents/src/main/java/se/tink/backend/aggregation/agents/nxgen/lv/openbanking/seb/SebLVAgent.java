...
public class SebLVAgent extends SebBalticsBaseAgent<SebLVApiClient>
        implements RefreshCheckingAccountsExecutor, RefreshSavingsAccountsExecutor {

    private final TransactionalAccountRefreshController transactionalAccountRefreshController;

    @Inject
    protected SebLVAgent(AgentComponentProvider componentProvider) {
        super(componentProvider);
        configureHttpClient(client);
        this.apiClient = new SebLVApiClient(client, persistentStorage, request);
    ...
    @Override
    protected SebLVApiClient getApiClient() {

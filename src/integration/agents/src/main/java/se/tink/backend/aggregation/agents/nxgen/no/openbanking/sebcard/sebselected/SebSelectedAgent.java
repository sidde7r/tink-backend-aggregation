package se.tink.backend.aggregation.agents.nxgen.no.openbanking.sebcard.sebselected;
...
public class SebSelectedAgent extends SebBrandedCardsAgent {

    public SebSelectedAgent(
            CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(
                request,
                context,
                signatureKeyPair,
                SebBrandedCardsConstants.BrandedCardsNorway.SEB_SELECTED);
    }
}

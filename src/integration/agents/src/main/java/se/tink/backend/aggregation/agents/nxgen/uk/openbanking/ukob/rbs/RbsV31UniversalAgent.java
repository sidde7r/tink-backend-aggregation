...
public class RbsV31UniversalAgent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                UkOpenBankingAisConfiguration.builder()
                        ...
                        .withWellKnownURL(RbsConstants.UNIVERSAL_LINKS_WELL_KNOWN_URL)
                        .build();
    }

    @Inject
    public RbsV31UniversalAgent(

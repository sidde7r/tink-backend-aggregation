package se.tink.backend.aggregation.agents.nxgen.fr.openbanking.creditagricolefinistere;
...
public class CreditagricoleFinistereAgent extends CreditAgricoleBaseAgent {
    public CreditagricoleFinistereAgent(CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(request, context, signatureKeyPair, BankEnum.FINISTÈRE);
    }
}

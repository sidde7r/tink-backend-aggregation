...
public class RaiffeisenTransactionFetcher
    ...
    public RaiffeisenTransactionFetcher(
            RaiffeisenWebApiClient apiClient, RaiffeisenSessionStorage sessionStorage) {
    ...
    public PaginatorResponse getTransactionsFor(
        ...
        return apiClient.getTransactionsResponse(
                webLoginResponse, account.getAccountNumber(), fromDate, toDate);
    }
}

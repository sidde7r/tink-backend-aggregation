...
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.SdcConstants.FormValues;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.SdcConstants.HeaderKeys;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.SdcConstants.PathParameters;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.SdcConstants.QueryKeys;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.SdcConstants.QueryValues;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.SdcConstants.StorageKeys;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.SdcConstants.Urls;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.authenticator.rpc.RefreshAccessTokenRequest;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.authenticator.rpc.TokenRequest;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.authenticator.rpc.TokenResponse;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.configuration.SdcConfiguration;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.fetcher.transactionalaccount.rpc.AccountsResponse;
import se.tink.backend.aggregation.agents.nxgen.dk.openbanking.sdc.fetcher.transactionalaccount.rpc.BalancesResponse;
...
public final class SdcApiClient {
    ...
    protected void setConfiguration(
        ...
        this.client.setEidasProxy(eidasProxyConfiguration, null);
    }

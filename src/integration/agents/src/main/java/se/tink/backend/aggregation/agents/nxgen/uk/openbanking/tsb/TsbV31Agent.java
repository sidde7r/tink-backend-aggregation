...
public class TsbV31Agent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                new UKOpenBankingAis.Builder()
                        .withOrganisationId("0015800001ZEZ3yAAH")
    ...
    @Inject
    public TsbV31Agent(AgentComponentProvider componentProvider, JwtSigner jwtSigner) {

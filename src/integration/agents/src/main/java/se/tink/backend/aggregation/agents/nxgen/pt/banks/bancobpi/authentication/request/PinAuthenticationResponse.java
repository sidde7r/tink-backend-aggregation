...
public class PinAuthenticationResponse extends LoginResponse {
    ...
    PinAuthenticationResponse(
            ...
            BancoBpiTransactionalAccountsInfo bancoBpiTransactionalAccountsInfo)
            throws RequestException {
        super(rawJsonResponse, httpClient);
        this.bancoBpiTransactionalAccountsInfo = bancoBpiTransactionalAccountsInfo;
    ...
    private void extractTransactionalAccountBaseInfo() throws RequestException {
        try {
            ...
            bancoBpiTransactionalAccountsInfo.setNip(responseData.getString("NIP"));
            ...
            for (int i = 0; i < responseAccountList.length(); i++) {
                ...
                bancoBpiTransactionalAccountsInfo.getAccountInfo().add(accountInfo);
            }

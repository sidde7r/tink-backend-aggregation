...
import se.tink.backend.aggregation.agents.nxgen.it.openbanking.unicredit.UnicreditConstants.Market;
...
public class UnicreditAgent extends UnicreditBaseAgent {
    ...
    protected UnicreditBaseApiClient getApiClient() {
        return new UnicreditApiClient(client, persistentStorage, credentials);
    }
}

...
public final class TsbV31BusinessAgent extends UkOpenBankingBaseAgent {
    ...
    @Inject
    public TsbV31BusinessAgent(AgentComponentProvider componentProvider, JwtSigner jwtSigner) {

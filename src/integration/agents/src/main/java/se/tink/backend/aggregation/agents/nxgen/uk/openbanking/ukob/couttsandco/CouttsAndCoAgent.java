package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.couttsandco;
...
public final class CouttsAndCoAgent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                UkOpenBankingAisConfiguration.builder()
                        .withOrganisationId(CouttsAndCoConstants.ORGANISATION_ID)
                        .withApiBaseURL(CouttsAndCoConstants.AIS_API_URL)
                        .withWellKnownURL(CouttsAndCoConstants.WELL_KNOWN_URL)
                        .build();
    }

    @Inject
    public CouttsAndCoAgent(

package se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.creditcard.rpc;

import java.util.List;
import se.tink.backend.aggregation.agents.nxgen.fi.banks.spankki.v1.fetcher.creditcard.entities.CardsEntity;

...
public class ChevroletMastercardAgent extends SebKortAgent {
    public ChevroletMastercardAgent(
            CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(request, context, signatureKeyPair, new ChevroletMastercardConfiguration());
    }
}

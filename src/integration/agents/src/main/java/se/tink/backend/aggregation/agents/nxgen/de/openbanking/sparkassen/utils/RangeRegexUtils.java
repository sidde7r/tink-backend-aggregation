package se.tink.backend.aggregation.agents.nxgen.de.openbanking.sparkassen.utils;
...
public class RangeRegexUtils {
    ...
    private static int fillByNines(int integer, int ninesCount) {
    ...
    private static int fillByZeros(int integer, int zerosCount) {
        return integer - integer % ((int) Math.pow(10, zerosCount));
    }

    private static List<Integer> splitToRanges(int min, int max) {
    ...
    private static List<String> splitToPatterns(int min, int max) {

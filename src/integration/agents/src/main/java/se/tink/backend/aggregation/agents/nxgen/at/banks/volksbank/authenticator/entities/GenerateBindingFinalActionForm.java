...
public class GenerateBindingFinalActionForm extends AbstractForm {
    public GenerateBindingFinalActionForm(
            String viewState, String deviceId, String secret, String pushToken) {
        ...
        this.put(
                VolksbankConstants.Form.SECRET_NAME_KEY, VolksbankConstants.Form.SECRET_NAME_VALUE);
        ...
        this.put(
                ...
                VolksbankConstants.Form.GBFORM + ":j_id_6q");

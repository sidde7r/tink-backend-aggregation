package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.firsttrust;
...
public class FirstTrustCorporateAisConfiguration extends UkOpenBankingAisConfiguration {

    protected FirstTrustCorporateAisConfiguration(Builder builder) {
        super(builder);
    }

...
public class DanskeBankNemIdCodeAppAuthenticator extends NemIdCodeAppAuthenticator<CodeAppEntity> {
  ...
  public DanskeBankNemIdCodeAppAuthenticator(DanskeBankApiClient apiClient, TinkHttpClient client,
      DeviceEntity preferredDevice, String username, String bindChallengeResponseBody) {
    super(client);

package se.tink.backend.aggregation.agents.nxgen.fo.banks.sdcfo.parser;
...
public class SdcFoTransactionParser implements SdcTransactionParser {

    // convert sdc transaction to Tink transaction for FO market
    @Override

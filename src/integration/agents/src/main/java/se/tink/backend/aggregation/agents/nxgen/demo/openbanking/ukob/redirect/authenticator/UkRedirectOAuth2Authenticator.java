package se.tink.backend.aggregation.agents.nxgen.demo.openbanking.ukob.redirect.authenticator;
...
public class UkRedirectOAuth2Authenticator implements OAuth2Authenticator {
    ...
    public UkRedirectOAuth2Authenticator(

...
public final class AionAgent extends Xs2aDevelopersTransactionalAgent {

    @Inject
    public AionAgent(AgentComponentProvider componentProvider) {
        super(componentProvider, "https://api.psd2.aion.be");
    }

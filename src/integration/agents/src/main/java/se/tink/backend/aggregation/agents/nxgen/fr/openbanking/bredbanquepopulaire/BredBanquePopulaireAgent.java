...
import se.tink.backend.aggregation.agents.nxgen.fr.openbanking.bredbanquepopulaire.fetcher.creditcard.BredBanquePopulaireCreditCardFetcher;
...
public final class BredBanquePopulaireAgent extends NextGenerationAgent
    ...
    private CreditCardRefreshController getCreditCardRefreshController() {
        final BredBanquePopulaireCreditCardFetcher creditCardFetcher =
                new BredBanquePopulaireCreditCardFetcher(apiClient);

        final BredBanquePopulaireTransactionsFetcher<CreditCardAccount> transactionsFetcher =
                new BredBanquePopulaireTransactionsFetcher<>(apiClient);

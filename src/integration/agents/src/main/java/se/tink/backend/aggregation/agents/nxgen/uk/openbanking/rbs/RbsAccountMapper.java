...
@Slf4j
public class RbsAccountMapper implements AccountMapper<TransactionalAccount> {
    ...
    public boolean supportsAccountType(AccountTypes type) {
        return AccountTypes.CHECKING.equals(type)
                || AccountTypes.SAVINGS.equals(type)
                || AccountTypes.MORTGAGE.equals(type);
    }
    ...
    public Optional<TransactionalAccount> map(
        ...
        if ("Mortgage".equals(account.getRawAccountSubType())) {

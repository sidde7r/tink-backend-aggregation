...
public class IngCreditCardFetcher
    ...
    private Collection<CreditCardAccount> logCreditCards(LoginResponseEntity loginResponse) {
        // The requests list in the login response doesn't contain the credit card requests if the
        // user
        // doesn't have a credit card.
        //
        // Trying to find the urls and if they are present we log them and the login
        // response. Hopefully we can then find the necessary requests and see their parameters, if
        // there are any.
        try {

...
public final class DjurgardskortetMastercardAgent extends SebKortAgent {
    @Inject
    public DjurgardskortetMastercardAgent(AgentComponentProvider componentProvider) {
        super(componentProvider, new DjurgardskortetMastercardConfiguration());
    }
}

package se.tink.backend.aggregation.agents.nxgen.it.openbanking.bancacarige.client;
...
public class BancaCarigeRequestBuilder extends CbiGlobeRequestBuilder {

    public BancaCarigeRequestBuilder(

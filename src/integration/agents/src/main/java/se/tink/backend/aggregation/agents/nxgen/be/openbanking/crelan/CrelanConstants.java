...
public final class CrelanConstants {
    ...
    public static class Urls {
        public static final String BASE_URL = "https://api-sandbox.crelan.be";

        public static final URL POST_CONSENT = new URL(BASE_URL + ApiServices.POST_CONSENT);
        ...
        public static final URL GET_BALANCE = new URL(BASE_URL + ApiServices.GET_BALANCES);

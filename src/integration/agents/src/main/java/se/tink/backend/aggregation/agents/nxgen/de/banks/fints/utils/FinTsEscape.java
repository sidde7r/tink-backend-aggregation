...
// Escape strings
// Ref:
// https://www.hbci-zka.de/dokumente/spezifikation_deutsch/fintsv3/FinTS_3.0_Formals_2017-05-11_final_version.pdf
// Section  H.1.1
public class FinTsEscape {
    ...
    public static String escapeDataGroup(String s) {
        return s.replace(
                        FinTsConstants.SegData.GROUP_DELIMITER,
                        ESCAPE_CHAR + FinTsConstants.SegData.GROUP_DELIMITER)
                .replace(

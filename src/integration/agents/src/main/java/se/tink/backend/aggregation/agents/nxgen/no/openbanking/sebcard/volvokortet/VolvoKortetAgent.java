package se.tink.backend.aggregation.agents.nxgen.no.openbanking.sebcard.volvokortet;
...
public class VolvoKortetAgent extends SebBrandedCardsAgent {

    public VolvoKortetAgent(
            CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(
                request,
                context,
                signatureKeyPair,
                SebBrandedCardsConstants.BrandedCardsNorway.VOLVO_KORTET);
    }
}

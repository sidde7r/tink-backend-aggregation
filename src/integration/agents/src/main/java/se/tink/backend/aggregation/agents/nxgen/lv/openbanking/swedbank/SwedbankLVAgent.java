...
public class SwedbankLVAgent extends SwedbankBalticsBaseAgent {

    @Inject
    protected SwedbankLVAgent(
            AgentComponentProvider agentComponentProvider, QsealcSigner qsealcSigner) {
        super(agentComponentProvider, qsealcSigner, new SwedbankLVConfiguration());
    }
}

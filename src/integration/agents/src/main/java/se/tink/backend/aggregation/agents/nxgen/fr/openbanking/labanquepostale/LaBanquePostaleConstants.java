...
public final class LaBanquePostaleConstants {
    ...
    public static class Urls{
        ...
        public static final String FETCH_ACCOUNTS =BASE_URL +  "/accounts?client_id=%s&client_secret=%s";
        public static final String FETCH_TRANSACTIONS = BASE_URL + "/accounts/%s/transactions";
        public static final String FETCH_BALANCES = BASE_URL + "/accounts/%s/balances?client_id=%s&client_secret=%s";

...
public class PasswordLoginEncryptStep
    ...
    public AgentAuthenticationResult execute(AgentProceedNextStepAuthenticationRequest request) {
        ...
        new AuthenticatorSleepHelper().sleepForMilliseconds(5000);

        String encryptedPassword =
                signer.createSignaturePw(
                        challenge,
                        authenticationData.getDeviceToken(),
                        authenticationData.getPanNumber(),
                        processState.getContractNumber(),
                        authenticationData.getPassword());

        processState.setEncryptedPassword(encryptedPassword);

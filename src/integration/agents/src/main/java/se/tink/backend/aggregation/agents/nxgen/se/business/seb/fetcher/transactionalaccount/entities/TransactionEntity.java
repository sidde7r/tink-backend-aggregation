package se.tink.backend.aggregation.agents.nxgen.se.business.seb.fetcher.transactionalaccount.entities;
...
import se.tink.backend.aggregation.agents.nxgen.se.business.seb.SebConstants;
import se.tink.backend.aggregation.agents.nxgen.se.business.seb.SebConstants.TransactionType;
...
public class TransactionEntity {
    ...
    private static TransactionTypes getTransactionType(String transactionTypeCode) {

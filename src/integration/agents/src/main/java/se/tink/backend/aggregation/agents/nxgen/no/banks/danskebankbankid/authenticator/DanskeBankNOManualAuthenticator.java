package se.tink.backend.aggregation.agents.nxgen.no.banks.danskebankbankid.authenticator;

import static se.tink.backend.aggregation.agents.nxgen.no.banks.danskebankbankid.DanskeBankNOConstants.AUTHENTICATION_FINISH_URL;
...
import se.tink.backend.aggregation.agents.nxgen.no.banks.danskebankbankid.DanskeBankNOApiClient;
import se.tink.backend.aggregation.agents.nxgen.no.banks.danskebankbankid.DanskeBankNOConstants;
...
public class DanskeBankNOManualAuthenticator
    ...
    public ProxySaveResponseMatcher getProxyResponseMatcherToDetectAuthenticationWasFinished() {
        return new ProxyResponseMatchers.ProxyUrlSubstringMatcher(AUTHENTICATION_FINISH_URL);
    }

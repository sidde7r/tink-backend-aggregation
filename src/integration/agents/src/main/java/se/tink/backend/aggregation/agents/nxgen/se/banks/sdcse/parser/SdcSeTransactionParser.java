package se.tink.backend.aggregation.agents.nxgen.se.banks.sdcse.parser;
...
public class SdcSeTransactionParser implements SdcTransactionParser {

    // convert sdc transaction to Tink transaction for SE market
    @Override

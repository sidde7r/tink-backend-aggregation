...
public final class AmericanExpressV62SEAgent extends AmericanExpressV62Agent {

    @Inject
    public AmericanExpressV62SEAgent(AgentComponentProvider componentProvider) {
        super(componentProvider, new AmericanExpressV62SEConfiguration());
    }
}

...
public class BankTransferRequest implements TransferRequest {
    ...
    private BankTransferRequest(Transfer transfer, AccountEntity sourceAccount, RecipientEntity destinationAccount,
        ...
        TransferMessageFormatter.Messages formattedMessages = transferMessageFormatter
                .getMessages(transfer, destinationAccount.isOwnAccount());
    ...
    public static BankTransferRequest create(Transfer transfer, AccountEntity sourceAccount,
            RecipientEntity destinationAccount, TransferMessageFormatter transferMessageFormatter) {

        return new BankTransferRequest(transfer, sourceAccount, destinationAccount, transferMessageFormatter);
    }
}

package se.tink.backend.aggregation.agents.nxgen.demo.banks.demFakeBank.authenticator;

import se.tink.backend.aggregation.agents.exceptions.AuthenticationException;
import se.tink.backend.aggregation.agents.exceptions.AuthorizationException;
import se.tink.backend.aggregation.agents.exceptions.LoginException;
import se.tink.backend.aggregation.agents.nxgen.demo.banks.demFakeBank.DemoFakeBankApiClient;
import se.tink.backend.aggregation.agents.nxgen.demo.banks.demFakeBank.DemoFakeBankConstants;
import se.tink.backend.aggregation.agents.nxgen.demo.banks.demFakeBank.authenticator.rpc.DemoFakeBankAuthenticationBody;

...
public class NordeaDkBankIdSigner implements BankIdSigner<PaymentRequest> {

    private NordeaDkPaymentExecutorSelector paymentExecutor;

    public NordeaDkBankIdSigner(NordeaDkPaymentExecutorSelector paymentExecutor) {

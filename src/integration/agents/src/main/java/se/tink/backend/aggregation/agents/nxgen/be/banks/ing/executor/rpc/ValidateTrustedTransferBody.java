...
public class ValidateTrustedTransferBody extends MultivaluedMapImpl {
    ...
    public ValidateTrustedTransferBody(Transfer transfer, AccountEntity sourceAccount,
            String destinationAccountNumber) {

        add(IngConstants.Transfers.AMOUNT, IngTransferHelper.formatUnsignedTransferAmount(

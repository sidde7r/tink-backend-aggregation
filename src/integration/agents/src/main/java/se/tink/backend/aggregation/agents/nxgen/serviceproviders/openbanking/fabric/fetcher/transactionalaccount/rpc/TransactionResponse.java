...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.fabric.fetcher.transactionalaccount.entities.TransactionsEntity;
...
public class TransactionResponse implements PaginatorResponse {
    ...
    public Optional<Boolean> canFetchMore() {
        return Optional.of(false); // All transactions are returned in one response
    }
}

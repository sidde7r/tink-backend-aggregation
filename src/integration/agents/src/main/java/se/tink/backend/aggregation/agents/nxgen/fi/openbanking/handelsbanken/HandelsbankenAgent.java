...
import se.tink.backend.aggregation.agents.nxgen.fi.openbanking.handelsbanken.authenticator.HandelsbankenAuthenticator;
import se.tink.backend.aggregation.agents.nxgen.fi.openbanking.handelsbanken.fetcher.transactionalaccount.HandelsbankenTransactionalAccountFetcher;
import se.tink.backend.aggregation.agents.nxgen.fi.openbanking.handelsbanken.session.HandelsBankenSessionHandler;

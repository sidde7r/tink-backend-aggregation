package se.tink.backend.aggregation.agents.nxgen.no.openbanking.sebcard.circlek;
...
public class CircleKAgent extends SebBrandedCardsAgent {
    ...
    public CircleKAgent(
        ...
        super(
                ...
                context,
                signatureKeyPair,
                SebBrandedCardsConstants.BrandedCardsNorway.CIRCLE_K);
    }
}

...
public class UkOpenBankingV11PisConfiguration implements UkOpenBankingPisConfig {

    private final URL pisBaseURL;
    private final URL pisConsentURL;

    public UkOpenBankingV11PisConfiguration(String pisBaseURL, String pisConsentURL) {

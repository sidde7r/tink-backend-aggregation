...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.ukopenbanking.pis.helper.UkOpenbankingV31PaymentHelper;
...
public class UkOpenbankingV31Executor implements PaymentExecutor, FetchablePaymentExecutor {
    private static final Logger log = LoggerFactory.getLogger(UkOpenbankingV31Executor.class);

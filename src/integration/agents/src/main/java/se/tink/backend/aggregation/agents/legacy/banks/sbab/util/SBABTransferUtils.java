...
public class SBABTransferUtils {
    ...
    /**
     * This method makes sure that we always send transfer values to SBAB in the Swedish format,
     * with a comma as separator. Also, SBAB seem to use two decimal places, so this method also
     * forces that formatting of the amount.
     */

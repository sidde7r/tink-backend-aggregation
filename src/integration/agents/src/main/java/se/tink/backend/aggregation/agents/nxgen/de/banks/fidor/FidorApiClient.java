...
public class FidorApiClient {
    ...
    private RequestBuilder getRequest(
            String baseUrl, String resource, String authorization, String contentType) {
    ...
    public OpenTokenEntity getTokenFromStorage() {
        ...
        OpenTokenEntity token =
                storage.get(FidorConstants.STORAGE.OAUTH_TOKEN, OpenTokenEntity.class)
    ...
    public OpenTokenEntity getOpenApiToken(
            String base64Basic, String code, String redirectUri, String clientId) {
        ...
        OpenTokenEntity token =
                getRequest(
                        ...
                        .queryParam(
                                FidorConstants.BODY.OPENAPI.GRANT_TYPE,
                                FidorConstants.BODY.OPENAPI.GRANT_TYPE_AUTHORIZATION_CODE)
                        .queryParam(FidorConstants.BODY.OPENAPI.CODE, code)
                        .queryParam(
                                FidorConstants.BODY.OPENAPI.REDIRECT_URI,
    ...
    public OpenTokenEntity refreshOpenApiToken(OpenTokenEntity tokenEntity) {
        ...
        return getRequest(
                ...
                .queryParam(
                        FidorConstants.BODY.OPENAPI.GRANT_TYPE,
                        FidorConstants.BODY.OPENAPI.GRANT_TYPE_REFRESH_TOKEN)
                .queryParam(
                        FidorConstants.BODY.OPENAPI.REFRESH_TOKEN, tokenEntity.getRefreshToken())
                .post(OpenTokenEntity.class);
    }
    ...
    public TransactionResponse fetchOpenApiTransactions(OpenTokenEntity tokenEntity, int page) {
        ...
        return getRequest(
                        FidorConstants.URL.OPENAPI.SANDBOX_BASE,
                        FidorConstants.URL.OPENAPI.TRANSACTIONS,
                        bearer,
                        MediaType.APPLICATION_JSON,
                        FidorConstants.HEADERS.OPENAPI.APPLICATION_JSON_FIDOR_V1)
                .queryParam(FidorConstants.BODY.OPENAPI.PAGE, Integer.toString(page))
                .queryParam(
                        FidorConstants.BODY.OPENAPI.PER_PAGE,
                        FidorConstants.BODY.OPENAPI.PER_PAGE_MAXVALUE)
    ...
    public UpcomingTransactionsResponse fetchUpcomingTransactions(OpenTokenEntity tokenEntity) {
        ...
        return getRequest(
                        FidorConstants.URL.OPENAPI.SANDBOX_BASE,
                        FidorConstants.URL.OPENAPI.UPCOMING_TRANSACTIONS,
                        bearer,
                        MediaType.APPLICATION_JSON,
                        FidorConstants.HEADERS.OPENAPI.APPLICATION_JSON_FIDOR_V1)

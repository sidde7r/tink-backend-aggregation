...
public class KbcPaymentAuthenticationController extends PaymentController {
    ...
    public KbcPaymentAuthenticationController(
            KbcPaymentExecutor paymentExecutor,
    ...
    private static String generateRandomState() {
        return encoder.encodeToString(RandomUtils.secureRandom(32));
    }

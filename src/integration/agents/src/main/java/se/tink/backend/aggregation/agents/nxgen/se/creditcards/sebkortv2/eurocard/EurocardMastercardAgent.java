...
public class EurocardMastercardAgent extends SebKortAgent {
    public EurocardMastercardAgent(
            CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(request, context, signatureKeyPair, new EurocardMastercardConfiguration());
    }
}

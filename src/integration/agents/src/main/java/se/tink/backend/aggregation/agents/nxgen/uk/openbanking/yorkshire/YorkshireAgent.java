...
public class YorkshireAgent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                UKOpenBankingAis.builder()
                        ...
                        .withWellKnownURL(YorkshireConstants.V31.WELL_KNOWN_URL)
                        .withApiBaseURL(YorkshireConstants.V31.AIS_API_URL)
                        .withPartyEndpoints(
    ...
    @Inject
    public YorkshireAgent(AgentComponentProvider componentProvider, JwtSigner jwtSigner) {

...
public class UkOpenBankingAuthenticatedHttpFilter extends Filter {
    ...
    private boolean isInteractionIdValidInResponse(
        ...
        Optional<String> receivedInteractionId =
                headers.keySet().stream()
                        .filter(key -> key.equalsIgnoreCase(X_FAPI_INTERACTION_ID))
    ...
    public HttpResponse handle(HttpRequest httpRequest)
        ...
        headers.add(
                UkOpenBankingConstants.HttpHeaders.AUTHORIZATION, accessToken.toAuthorizeHeader());
        ...
        headers.add(X_FAPI_INTERACTION_ID, interactionId);

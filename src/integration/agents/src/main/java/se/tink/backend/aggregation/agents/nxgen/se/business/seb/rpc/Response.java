...
import se.tink.backend.aggregation.agents.nxgen.se.business.seb.entities.ResultInfoMessage;
...
public class Response {
    ...
    @JsonIgnore
    private List<ResultInfoMessage> getErrors() {
        if (hasErrors()) {
    ...
    @JsonIgnore
    private Optional<ResultInfoMessage> getFirstErrorWithErrorText() {
    ...
    public boolean isValid() {
        ...
        return !Objects.isNull(payload) && payload.isValid();
    }

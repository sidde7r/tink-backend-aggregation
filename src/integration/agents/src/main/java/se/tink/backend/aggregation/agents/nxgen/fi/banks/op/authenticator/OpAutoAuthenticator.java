...
public class OpAutoAuthenticator implements PasswordAuthenticator, AutoAuthenticator {
    ...
    public OpAutoAuthenticator(OpBankApiClient client, OpBankPersistentStorage persistentStorage, Credentials credentials){
    ...
    public void authenticate(String username, String password) throws AuthenticationException, AuthorizationException {
        ...
        OpBankLoginRequestEntity request = new OpBankLoginRequestEntity()

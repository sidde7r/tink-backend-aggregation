...
public class LoginRequest extends AbstractForm {
    ...
    private LoginRequest(String username, String gridId, String passwordIndices,
                         BnpParibasPersistentStorage bnpParibasPersistentStorage) {
        this.put(BnpParibasConstants.Auth.AUTH,
                buildAuthFormValue(username, gridId, passwordIndices, bnpParibasPersistentStorage));
    }

    public static LoginRequest create(String username, String gridId, String passwordIndices,
                                      BnpParibasPersistentStorage bnpParibasPersistentStorage) {
        return new LoginRequest(username, gridId, passwordIndices, bnpParibasPersistentStorage);
    }

    private String buildAuthFormValue(String username, String gridId, String passwordIndices,
            BnpParibasPersistentStorage bnpParibasPersistentStorage) {

        String challengeResponseString = buildChallengeResponseString(username, gridId, passwordIndices);
    ...
    private String buildChallengeResponseString(String username, String gridId, String passwordIndices) {
        ...
        return String.format(
                ...
                BnpParibasConstants.AuthFormValues.MEAN_ID,
                b64EncodedUsername, b64EncodedUsername,
                gridId, BnpParibasConstants.AuthFormValues.ID_GRILLE, gridId,
                BnpParibasConstants.Auth.GRID_TYPE_V4iOS,
                BnpParibasConstants.Auth.GRID_TYPE,
                BnpParibasConstants.Auth.GRID_TYPE_V4iOS,
                passwordIndices, BnpParibasConstants.AuthFormValues.POS_SELECT, passwordIndices,
    ...
    private String buildUserAgentString() {
        return String.format(
                ...
                + "</USER_AGENT>",
                BnpParibasConstants.Auth.USER_AGENT,
                BnpParibasConstants.AuthFormValues.IP_ADDRESS
        );
    }

...
import se.tink.backend.aggregation.agents.nxgen.gb.openbanking.handelsbanken.authenticator.HandelsbankenAuthenticator;
import se.tink.backend.aggregation.agents.nxgen.gb.openbanking.handelsbanken.fetcher.transactionalaccount.HandelsbankenTransactionalAccountFetcher;
import se.tink.backend.aggregation.agents.nxgen.gb.openbanking.handelsbanken.session.HandelsbankenSessionHandler;

package se.tink.backend.aggregation.agents.nxgen.fi.openbanking.sebcard.finnair;
...
public class FinnairAgent extends SebBrandedCardsAgent {
    ...
    public FinnairAgent(
        ...
        super(
                ...
                context,
                signatureKeyPair,
                SebBrandedCardsConstants.BrandedCardsFinland.FINNAIR);
    }
}

...
public class SamlinkKeyCardAuthenticator extends SamlinkAuthenticatorBase implements KeyCardAuthenticator {
    ...
    public SamlinkKeyCardAuthenticator(SamlinkApiClient apiClient, SamlinkPersistentStorage persistentStorage,
    ...
    public void authenticate(String code) throws AuthenticationException, AuthorizationException {
        ...
        try {
            RegisterDeviceResponse registerDeviceResponse = apiClient.registerDevice(loginResponse.getLinks(), code,
                    deviceId);

package se.tink.backend.aggregation.agents.nxgen.se.openbanking.sebkort.eurocard;
...
public final class EurocardSeAgent extends SebBrandedCardsAgent {

    @Inject
    public EurocardSeAgent(AgentComponentProvider componentProvider) {
        super(componentProvider, SebBrandedCardsConstants.BrandedCards.Sweden.EUROCARD);
    }
}

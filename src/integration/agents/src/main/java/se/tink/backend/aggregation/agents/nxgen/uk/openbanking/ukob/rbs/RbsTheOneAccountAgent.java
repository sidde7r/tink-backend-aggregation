...
public class RbsTheOneAccountAgent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                UkOpenBankingAisConfiguration.builder()
                        ...
                        .withWellKnownURL(RbsConstants.THE_ONE_ACCOUNT_WELL_KNOWN_URL)
                        .build();
    }

    @Inject
    public RbsTheOneAccountAgent(

package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.newday.dorothyperkins;
...
public class DorothyPerkinsAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("dorothyperkins");
    }

    @Inject
    public DorothyPerkinsAgent(

...
public class TransactionMapper {
    ...
    public static Transaction toTransaction(TransactionContainerEntity input) {
        ...
        transaction.setDescription(
                Strings.nullToEmpty(input.getCreditCardTransaction().getDescription()).trim());
        ...
        if (!Strings.isNullOrEmpty(merchantDescription)) {
            transaction.setInternalPayload(
                    AbnAmroUtils.InternalPayloadKeys.MERCHANT_DESCRIPTION,

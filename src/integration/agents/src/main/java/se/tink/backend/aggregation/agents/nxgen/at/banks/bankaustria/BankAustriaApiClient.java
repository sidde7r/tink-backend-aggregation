...
public class BankAustriaApiClient {
    ...
    public OtmlResponse login(String userId, String password) {
        OtmlResponse response =
                getRequestWithHeaders(BankAustriaConstants.Urls.LOGIN)
    ...
    private Form rtaForm(String messageId) {
        ...
        form.putSingle(
                BankAustriaConstants.GenericForm.SOURCE,
                BankAustriaConstants.GenericForm.SOURCE_OTML);
        return form;
    }
    ...
    private Form loginForm(String userId, String password) {
        ...
        form.putSingle(
                BankAustriaConstants.LoginForm.OTML_SECURE_ENCLAVE_PARAMS,
                BankAustriaConstants.LoginForm.OTML_SECURE_ENCLAVE_TOKEN);
        form.putSingle(BankAustriaConstants.LoginForm.USE_LOGIN_VIA_FINGERPRINT, "");
        form.putSingle(
                BankAustriaConstants.LoginForm.ACTIVATE_FINGERPRINT_MESSAGE,
                BankAustriaConstants.LoginForm.ACTIVATE_FINGERPRINT_LOGIN_VALUE);
        form.putSingle(
                BankAustriaConstants.LoginForm.LANGUAGE,
                BankAustriaConstants.LoginForm.LANGUAGE_EN_US);
        form.putSingle(
                BankAustriaConstants.LoginForm.SUPPORT_FACE_ID,
                BankAustriaConstants.LoginForm.SUPPORT_FACE_ID_FALSE);
    ...
    public OtmlResponse getAccountsFromSettings() {
        OtmlResponse response =
                getRequestWithHeaders(BankAustriaConstants.Urls.SETTINGS)
    ...
    private Form settingsForm() {
        Form form = new Form();
        form.putSingle(
                BankAustriaConstants.SettingsForm.SETTINGS_TARGET,
                BankAustriaConstants.SettingsForm.SETTINGS_TARGET_VALUE);
        return form;
    }
    ...
    public String getMD5OfUpdatePage() {
        String response =
                getRequestWithHeaders(BankAustriaConstants.Urls.UPDATE_PAGE)
    ...
    private RequestBuilder getRequestWithHeaders(URL url) {
        return client.request(url)
                ...
                .header(
                        BankAustriaConstants.Header.X_OTML_MANIFEST,
                        sessionStorage.getXOtmlManifest())
                .header(
                        BankAustriaConstants.Header.X_OTML_PLATFORM,
                        BankAustriaConstants.Application.PLATFORM)
                .header(
                        BankAustriaConstants.Header.X_OTMLID,
                        BankAustriaConstants.Application.OTMLID)
                .header(
                        BankAustriaConstants.Header.X_APPID,
                        BankAustriaConstants.Application.PLATFORM_VERSION);
    }

    private Form getFormForGenericAccount(String bankIdentifier) {
        Form form = new Form();
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.SEARCH_TYPE,
                BankAustriaConstants.MovementsSearchForm.SEARCH_TYPE_VALUE_LAST_30_DAYS);
        ...
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.TYPE,
                BankAustriaConstants.MovementsSearchForm.TYPE_ALL);
        form.putSingle(
                BankAustriaConstants.GenericForm.SOURCE,
                BankAustriaConstants.GenericForm.SOURCE_OTML);
        ...
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.FINISH,
                BankAustriaConstants.MovementsSearchForm.FINISH_VALUE);
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.OTML_FIRST_SEARCH,
                BankAustriaConstants.MovementsSearchForm.OTML_FIRST_SEARCH_VALUE_FALSE);
    ...
    private Form getFormForDatePagination(String bankIdentifier, Date fromDate, Date toDate) {
        ...
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.SEARCH_TYPE,
                BankAustriaConstants.MovementsSearchForm.SEARCH_TYPE_VALUE_CUSTOM);
        form.putSingle(BankAustriaConstants.MovementsSearchForm.ACCOUNT_ID, bankIdentifier);
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.START_YEAR,
                Integer.toString(localfromDate.getYear()));
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.START_MONTH,
                Integer.toString(localfromDate.getMonthValue()));
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.START_DAY,
                Integer.toString(localfromDate.getDayOfMonth()));
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.END_YEAR,
                Integer.toString(localtoDate.getYear()));
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.END_MONTH,
                Integer.toString(localtoDate.getMonthValue()));
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.END_DAY,
                Integer.toString(localtoDate.getDayOfMonth()));
        form.putSingle(
                BankAustriaConstants.MovementsSearchForm.TYPE,
                BankAustriaConstants.MovementsSearchForm.TYPE_ALL);
        form.putSingle(

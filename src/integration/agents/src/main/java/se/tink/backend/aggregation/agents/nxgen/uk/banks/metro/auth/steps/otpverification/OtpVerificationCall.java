...
public class OtpVerificationCall
        extends AgentSimpleExternalApiCall<
                OtpVerificationParameters,
                OtpVerificationResponse,
                ConfirmChallengeRequest,
                String> {
    private final ObjectMapper objectMapper;

    public OtpVerificationCall(AgentHttpClient httpClient, ObjectMapper objectMapper) {
    ...
    protected RequestEntity<ConfirmChallengeRequest> prepareRequest(
            OtpVerificationParameters arg, AgentExtendedClientInfo clientInfo) {
        URI url =
    ...
    @SneakyThrows
    @Override
    protected ExternalApiCallResult<OtpVerificationResponse> parseResponse(
        ...
        return !option.isEmpty()
                ...
                : new ExternalApiCallResult<>(
                        objectMapper.readValue(
                                httpResponse.getBody(), OtpVerificationResponse.class));
    }
}

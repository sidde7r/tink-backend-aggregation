...
public final class CicBankAgent extends EuroInformationAgent {
    @Inject
    public CicBankAgent(AgentComponentProvider componentProvider) {
        super(componentProvider, new CicBankConfiguration());
    }
}

package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.newday.aqua;
...
public class AquaAgent extends NewDayBaseAgent {

    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("aqua");
    }

    @Inject
    public AquaAgent(AgentComponentProvider componentProvider, UkOpenBankingFlowFacade flowFacade) {

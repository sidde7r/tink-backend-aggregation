package se.tink.backend.aggregation.agents.nxgen.no.banks.dnbbankid.fetchers.investmentfetcher;
...
import se.tink.backend.aggregation.agents.nxgen.no.banks.dnbbankid.DnbConstants.Storage;
import se.tink.backend.aggregation.agents.nxgen.no.banks.dnbbankid.DnbExceptionsHelper;
import se.tink.backend.aggregation.agents.nxgen.no.banks.dnbbankid.fetchers.investmentfetcher.entities.MyFundEntity;
import se.tink.backend.aggregation.agents.nxgen.no.banks.dnbbankid.fetchers.investmentfetcher.entities.PensionDataEntity;
...
import se.tink.backend.aggregation.agents.nxgen.no.banks.dnbbankid.fetchers.oauth.rpc.InitMyWealthResponse;

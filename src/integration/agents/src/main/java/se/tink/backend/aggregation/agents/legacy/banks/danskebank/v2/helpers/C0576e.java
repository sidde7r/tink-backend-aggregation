...
public class C0576e extends C0575g {
    ...
    public byte[] m2106a() {
        ...
        String codeKey =
                "";
        String iconKey =
        ...
        byte[] firstKey = BASE64_CODEC.decode(codeKey);
        byte[] secondKey =
                MobileBankingEncryptionHelper.reverse(iconKey.substring(0, firstKey.length))
    ...
    public String[] m2113h() {
        ...
        return new String[] {"User-Agent", str};
    }

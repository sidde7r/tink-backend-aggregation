...
public class NordeaNoApiClient extends NordeaV17ApiClient {
    ...
    public BankIdInitResponse initiateBankId(String dob, String mobileNumber) throws AuthenticationException,
            AuthorizationException {
        return authRequest(new BankIdInitRequest(dob, mobileNumber), BankIdInitResponse.class);
    }

    public BankIdCollectResponse pollBankId(String sessionId) throws AuthenticationException, AuthorizationException {

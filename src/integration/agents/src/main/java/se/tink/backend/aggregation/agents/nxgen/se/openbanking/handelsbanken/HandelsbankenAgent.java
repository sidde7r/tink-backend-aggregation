...
import se.tink.backend.aggregation.agents.nxgen.se.openbanking.handelsbanken.authenticator.HandelsbankenAuthenticator;
import se.tink.backend.aggregation.agents.nxgen.se.openbanking.handelsbanken.fetcher.transactionalaccount.HandelsbankenTransactionalAccountFetcher;
import se.tink.backend.aggregation.agents.nxgen.se.openbanking.handelsbanken.session.HandelsbankenSessionHandler;

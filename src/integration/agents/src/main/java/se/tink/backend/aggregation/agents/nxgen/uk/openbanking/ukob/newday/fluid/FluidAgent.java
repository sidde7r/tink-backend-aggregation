package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.newday.fluid;
...
public class FluidAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("fluid");
    }

...
public class SandboxAuthenticator implements Authenticator {
    ...
    public SandboxAuthenticator(PersistentStorage persistentStorage, CreditAgricoleBaseConfiguration configuration) {
    ...
    public void authenticate(Credentials credentials) {
        persistentStorage.put(CreditAgricoleBaseConstants.StorageKeys.OAUTH_TOKEN, configuration.getToken());
    }
}

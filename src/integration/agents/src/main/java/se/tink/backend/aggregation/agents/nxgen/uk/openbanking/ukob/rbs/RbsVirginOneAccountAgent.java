...
public class RbsVirginOneAccountAgent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                UkOpenBankingAisConfiguration.builder()
                        ...
                        .withWellKnownURL(RbsConstants.VIRGIN_ONE_ACCOUNT_WELL_KNOWN_URL)
                        .build();
    }

    @Inject
    public RbsVirginOneAccountAgent(

...
public class AppCredentialsBody extends MultivaluedMapImpl {
    ...
    public AppCredentialsBody(byte[] encryptedQueryData) {
        add(
                IngConstants.Session.ValuePairs.METHOD.getKey(),
                IngConstants.Session.ValuePairs.METHOD.getValue());
        add(
                IngConstants.Session.ValuePairs.PROTOCOL_VERSION.getKey(),
                IngConstants.Session.ValuePairs.PROTOCOL_VERSION.getValue());
        add(
                IngConstants.Session.ValuePairs.PUBLIC_KEY_ID.getKey(),

...
public class BnpParibasFortisBaseSigningFilter extends Filter {
    ...
    public HttpResponse handle(HttpRequest httpRequest)
        ...
        httpRequest
                .getHeaders()
                .add(BnpParibasFortisBaseConstants.HeaderKeys.REQUEST_ID, requestId);
        httpRequest.getHeaders().add(BnpParibasFortisBaseConstants.HeaderKeys.DIGEST, digest);
        httpRequest.getHeaders().add(BnpParibasFortisBaseConstants.HeaderKeys.SIGNATURE, signature);

...
public class EuroInformationNoPfmCreditCardFetcher implements AccountFetcher<CreditCardAccount> {
    private static final Logger LOGGER =
            LoggerFactory.getLogger(EuroInformationNoPfmCreditCardFetcher.class);
    private static final AggregationLogger AGGREGATION_LOGGER =
            new AggregationLogger(EuroInformationNoPfmCreditCardFetcher.class);
    ...
    public Collection<CreditCardAccount> fetchAccounts() {
        ...
        return details.getAccountDetailsList().stream()
                .filter(a -> AccountTypes.CREDIT_CARD == a.getTinkTypeByTypeNumber().getTinkType())
                .flatMap(
                        a -> {
                            ...
                            // TODO: We do not have account with credit card data containing
                            // available credit

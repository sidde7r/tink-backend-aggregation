package se.tink.backend.aggregation.agents.nxgen.serviceproviders.banks.nordea.v30.fetcher.creditcard.rpc;
...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.banks.nordea.v30.fetcher.creditcard.entities.CardTransactionEntity;
...
public class FetchCardTransactionsResponse implements PaginatorResponse {
    ...
    public Optional<Boolean> canFetchMore() {
        return Optional.of(getTransactions().size() == NordeaBaseConstants.Fetcher.CAN_FETCH_MORE);
    }
}

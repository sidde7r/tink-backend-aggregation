...
import se.tink.backend.aggregation.agents.nxgen.fr.openbanking.bpcegroup.fetcher.transactionalaccount.converter.BpceGroupTransactionalAccountConverter;
...
public class BpceGroupTransactionalAccountFetcher
    ...
    protected Optional<TransactionalAccount> map(AccountEntity accountEntity) {
        return BpceGroupTransactionalAccountConverter.toTransactionalAccount(accountEntity);
    }
}

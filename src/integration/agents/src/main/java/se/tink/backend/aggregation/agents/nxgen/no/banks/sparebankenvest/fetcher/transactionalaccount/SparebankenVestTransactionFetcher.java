...
public class SparebankenVestTransactionFetcher
    ...
    public PaginatorResponse getTransactionsFor(TransactionalAccount account, int page) {
        ...
        TransactionsListResponse transactionsList =
                apiClient.fetchTransactions(account.getBankIdentifier(), rangeString);
        ...
        return PaginatorResponseImpl.create(
                ...
                transactionsList.size()
                        >= SparebankenVestConstants.PagePagination.MAX_TRANSACTIONS_IN_BATCH);
    }
    ...
    private String getRangeString(int page) {
        ...
        int endIndex =
                (page + 1) * SparebankenVestConstants.PagePagination.MAX_TRANSACTIONS_IN_BATCH - 1;

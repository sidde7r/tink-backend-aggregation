...
public final class InvokeResponse {
    ...
    public boolean isPasswordIncorrect() {
        ...
        // Ihre Eingaben waren ungültig ! Bitte geben Sie neu ein oder beenden Sie den Dialog
        // (Z1110)
    ...
    private boolean isAccountTemporarilyLocked() {
        ...
        // Bitte geben Sie Ihr Kennwort und eine gültige Transaktionsnummer ein, um den Zugang zu
        // entsperren. (Z9909)
        return Optional.ofNullable(securityServiceLoginError)
                .orElse("")
                .replace("\n", " ")
    ...
    /**
     * @return true iff the account is locked "permanently", i.e. in a way that necessitates
     *     contacting the bank
     */
    private boolean isAccountPermanentlyLocked() {
        // Observed error message:
        // Der Zugang zu Ihren Online-Konten ist gesperrt. Bitte wenden Sie sich an Ihre Filiale.
        // (Z1159)
        return Optional.ofNullable(securityServiceLoginError)
                .orElse("")
                .replace("\n", " ")

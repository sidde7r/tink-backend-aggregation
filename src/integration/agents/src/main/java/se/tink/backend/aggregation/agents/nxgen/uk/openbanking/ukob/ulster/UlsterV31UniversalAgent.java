...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.ukopenbanking.ais.base.calculator.NatwestGroupBalancePreCalculator;
...
public final class UlsterV31UniversalAgent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                UkOpenBankingAisConfiguration.builder()
                        ...
                        .withWellKnownURL(UlsterConstants.UNIVERSAL_LINKS_WELL_KNOWN_URL)
                        .build();
    }

    @Inject
    public UlsterV31UniversalAgent(

package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.newday.wallis;
...
public class WallisAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("wallis");
    }

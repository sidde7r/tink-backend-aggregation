...
public class SwedbankSEBusinessConfiguration implements SwedbankMarketConfiguration {
    ...
    public boolean isOrgNumberProvided(String orgNumber) {
        return orgNumber != null;
    }
}

package se.tink.backend.aggregation.agents.nxgen.fr.openbanking.creditagricolebanquechalus;
...
public class CreditAgricoleBanquechalusAgent extends CreditAgricoleBaseAgent {
    public CreditAgricoleBanquechalusAgent(CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {

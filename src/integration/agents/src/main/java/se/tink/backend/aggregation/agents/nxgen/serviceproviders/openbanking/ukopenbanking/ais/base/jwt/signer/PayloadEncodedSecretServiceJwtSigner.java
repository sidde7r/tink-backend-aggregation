...
public class PayloadEncodedSecretServiceJwtSigner implements JwtSigner {
    private final UkOpenBankingConfiguration configuration;

    @Override
    public String sign(
            JwtSigner.Algorithm algorithm,
        ...
        return TinkJwtPaymentSigner.builder(configuration::getSigningKeyId, signer)

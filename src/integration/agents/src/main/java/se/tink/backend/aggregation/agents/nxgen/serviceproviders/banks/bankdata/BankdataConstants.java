...
public class BankdataConstants {
    ...
    public static class Url {
        ...
        public static final URL PFM_TRANSACTIONS_FUTURE = new URL(BASE_URL + "pfm/transactions/future");

        public static final URL CARDS = new URL(BASE_URL + "cards");
        public static final URL INVESTMENT_POOL_ACCOUNTS = new URL(BASE_URL + "investment/poolaccounts");
    ...
    public static class Authentication {
        public static final String LOGIN_SECRET = "3847384569284762987649827642897035873085620650398475097345093753";
    ...
    public static class Log {
        public static final LogTag INVESTMENT_UNKNOWN_DEPOSITS_LOG_TAG = LogTag.from("#investment_unknown_deposits_bankdata");
        public static final LogTag INVESTMENT_UNKNOWN_POOLACCOUNT_LOG_TAG = LogTag.from("#investment_unknown_poolaccount_bankdata");
    }

...
public abstract class NordeaV20Filter extends Filter {
    ...
    public HttpResponse handle(HttpRequest httpRequest) throws HttpClientException, HttpResponseException {
        ...
        URL url = httpRequest.getUrl().parameter(NordeaV20Constants.UrlParameter.MARKET_CODE, marketCode)
                .parameter(NordeaV20Constants.UrlParameter.LOWER_CASE_MARKET_CODE, marketCode.toLowerCase());

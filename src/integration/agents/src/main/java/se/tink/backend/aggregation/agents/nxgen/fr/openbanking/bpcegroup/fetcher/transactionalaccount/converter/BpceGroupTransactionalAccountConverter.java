package se.tink.backend.aggregation.agents.nxgen.fr.openbanking.bpcegroup.fetcher.transactionalaccount.converter;
...
public class BpceGroupTransactionalAccountConverter {
    ...
    public static Optional<TransactionalAccount> toTransactionalAccount(
        ...
        return toTransactionalAccount(accountEntity, accountEntity.getBalances());
    }

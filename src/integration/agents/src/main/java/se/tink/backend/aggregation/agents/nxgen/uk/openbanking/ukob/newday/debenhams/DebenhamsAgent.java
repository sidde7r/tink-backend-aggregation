package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.newday.debenhams;
...
public class DebenhamsAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("debenhams");
    }

    @Inject
    public DebenhamsAgent(

...
@JsonObject
public class AccountsV11Response extends BaseResponse<List<AccountEntity>> implements AccountStream {
    ...
    public static Optional<TransactionalAccount> toTransactionalAccount(AccountsV11Response accounts,
            AccountBalanceV11Response balance) {
    ...
    public static Optional<CreditCardAccount> toCreditCardAccount(AccountsV11Response accounts,

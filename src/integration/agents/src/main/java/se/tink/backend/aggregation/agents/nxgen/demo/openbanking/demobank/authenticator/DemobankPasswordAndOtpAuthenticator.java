...
import se.tink.backend.aggregation.log.Tag;
import se.tink.backend.aggregation.log.TagMdcLogger;
...
public class DemobankPasswordAndOtpAuthenticator implements MultiFactorAuthenticator {
    ...
    public static final String OTPINPUT = "otpinput";
    ...
    public void authenticate(Credentials credentials)
        ...
        TagMdcLogger.info(Collections.singletonList(Tag.CREDENTIALS), log, "Testing tags");
        String message =
                this.apiClient
                        .initEmbeddedOtp(

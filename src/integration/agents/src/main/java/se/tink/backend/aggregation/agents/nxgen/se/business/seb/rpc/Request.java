package se.tink.backend.aggregation.agents.nxgen.se.business.seb.rpc;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.fasterxml.jackson.annotation.JsonProperty;
import com.google.common.collect.Lists;
import java.util.List;
import se.tink.backend.aggregation.agents.nxgen.se.business.seb.entities.Payload;
import se.tink.backend.aggregation.agents.nxgen.se.business.seb.entities.RequestComponent;
import se.tink.backend.aggregation.agents.nxgen.se.business.seb.entities.ServiceInput;
import se.tink.backend.aggregation.agents.nxgen.se.business.seb.entities.UserCredentials;

package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.newday.amazon;
...
public class AmazonAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("amazon");
    }

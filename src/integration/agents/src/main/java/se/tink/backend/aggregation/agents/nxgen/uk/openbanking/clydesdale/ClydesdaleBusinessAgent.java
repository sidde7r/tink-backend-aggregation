...
public class ClydesdaleBusinessAgent extends UkOpenBankingBaseAgent {

    public static final UkOpenBankingAisConfig aisConfig;
    ...
    @Inject
    public ClydesdaleBusinessAgent(AgentComponentProvider componentProvider, JwtSigner jwtSigner) {
    ...
    protected Class<? extends UkOpenBankingClientConfigurationAdapter>
        ...
        return ClydesdaleClientConfiguration.class;
    }
}

...
public class DanskeBankUrl {
    ...
    public static final String SERVICE_ACCOUNTS_ID_TRANSACTION =
            BASE_URL_MB + "/Service/Accounts/%s/Transactions";
    public static final String ACCOUNTS_BILLS_DETAILS = BASE_URL_MB + "/Accounts/Bills/Details";
    public static final String ACCOUNTS_TRANSFER_DETAILS =
            BASE_URL_MB + "/Accounts/Transfer/Details";
    ...
    public static final String CUSTOMER_SETTINGS =
            BASE_URL_PRIVATESERVICE + "/RES/Customer/customerSettings/loginInfo";
    ...
    public static String serviceAccountsIdTransaction(
            String accountId, DanskeBankV2Agent.TransactionType transactionType) {

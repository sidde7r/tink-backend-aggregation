package se.tink.backend.aggregation.agents.nxgen.no.openbanking.danskebank.fetcher;
...
public class DanskeBankNOTransferDestinationFetcher implements TransferDestinationFetcher {
    ...
    private static List<TransferDestinationPattern> getDomesticTransferDestinations() {
        return Arrays.asList(
                ...
                TransferDestinationPattern.createForMultiMatchAll(AccountIdentifierType.BBAN),
                TransferDestinationPattern.createForMultiMatchAll(AccountIdentifierType.NO));
    }
}

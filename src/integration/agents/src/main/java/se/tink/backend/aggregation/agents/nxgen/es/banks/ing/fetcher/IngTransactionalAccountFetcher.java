...
public class IngTransactionalAccountFetcher
        extends ProductMovementsFetcher<TransactionalAccount, Transaction> {

    private static boolean isTransactionalAccount(Product product) {
        return mapToKnownType(product)
    ...
    private static TransactionalAccount toTransactionalAccount(Product product) {
        ...
        TransactionalAccount.Builder<? extends Account, ?> builder =
                TransactionalAccount.builder(
                        mapToKnownType(product).get(), product.getUniqueIdentifier());

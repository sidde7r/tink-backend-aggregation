...
@WebServiceClient(
        ...
        wsdlLocation = "http://testwebservice.creditsafe.se/GetData/getdata.asmx")
public class GetDataTest extends Service {

    private static final URL GETDATA_WSDL_LOCATION;
    private static final WebServiceException GETDATA_EXCEPTION;
    private static final QName GETDATA_QNAME =
            new QName("https://webservice.creditsafe.se/getdata/", "GetData");
    ...
    /** @return returns GetDataSoap */
    @WebEndpoint(name = "GetDataSoap")
    public GetDataSoap getGetDataSoap() {
        return super.getPort(
                new QName("https://webservice.creditsafe.se/getdata/", "GetDataSoap"),
                GetDataSoap.class);
    }

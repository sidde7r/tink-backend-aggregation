...
import se.tink.backend.aggregation.agents.nxgen.gb.openbanking.handelsbanken.HandelsbankenConstants.Account;
...
public class AccountEntity extends BaseAccountEntity {
    ...
    public TransactionalAccount toTinkAccount(BalanceEntity balance) {
        ...
        } else if (Account.TYPES.get(AccountTypes.SAVINGS).equalsIgnoreCase(accountType)) {

package se.tink.backend.aggregation.agents.nxgen.fr.openbanking.creditagricolefranchecomte;
...
public class CreditagricoleFranchecomteAgent extends CreditAgricoleBaseAgent {
    public CreditagricoleFranchecomteAgent(CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(request, context, signatureKeyPair, BankEnum.FRANCHE_COMTE);
    }
}

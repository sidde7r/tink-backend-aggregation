...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.ukopenbanking.base.pis.UkOpenbankingPaymentHelper;
...
public class UkOpenbankingV31PaymentHelper implements UkOpenbankingPaymentHelper {
    ...
    public UkOpenbankingV31PaymentHelper(UkOpenBankingApiClient apiClient, Clock clock) {

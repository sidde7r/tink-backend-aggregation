package se.tink.backend.aggregation.agents.nxgen.no.openbanking.sebcard.finnair;
...
public class FinnairMastercardNOAgent extends SebBrandedCardsAgent {

    public FinnairMastercardNOAgent(
            CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(
                request,
                context,
                signatureKeyPair,
                SebBrandedCardsConstants.BrandedCardsNorway.FINNAIR);
    }
}

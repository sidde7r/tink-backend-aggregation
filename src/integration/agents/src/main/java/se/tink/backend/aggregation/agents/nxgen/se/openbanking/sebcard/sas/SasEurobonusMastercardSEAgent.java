package se.tink.backend.aggregation.agents.nxgen.se.openbanking.sebcard.sas;
...
public class SasEurobonusMastercardSEAgent extends SebBrandedCardsAgent {

    public SasEurobonusMastercardSEAgent(
            CredentialsRequest request, AgentContext context, SignatureKeyPair signatureKeyPair) {
        super(request, context, signatureKeyPair, SebBrandedCardsConstants.BrandedCardsSweden.SAS);
    }
}

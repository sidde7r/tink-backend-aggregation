...
public class UlsterRepublicOfIrelandAgent extends UkOpenBankingBaseAgent {
    ...
    static {
        aisConfig =
                UkOpenBankingAisConfiguration.builder()
                        ...
                        .withWellKnownURL(Constants.PERSONAL_WELL_KNOWN_URL)
                        .build();
    }

    @Inject
    public UlsterRepublicOfIrelandAgent(

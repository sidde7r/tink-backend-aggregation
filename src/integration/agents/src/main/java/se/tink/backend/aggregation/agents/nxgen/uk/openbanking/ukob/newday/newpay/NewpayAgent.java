package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.newday.newpay;
...
public class NewpayAgent extends NewDayBaseAgent {
    public static final NewDayConfiguration aisConfig;

    static {
        aisConfig = NewDayConfiguration.getAisConfigWithUrlsByBrand("newpay");
    }

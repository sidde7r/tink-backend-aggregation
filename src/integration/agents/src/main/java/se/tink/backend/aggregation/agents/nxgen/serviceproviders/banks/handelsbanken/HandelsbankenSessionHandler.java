...
public class HandelsbankenSessionHandler implements SessionHandler {
    ...
    private static final AggregationLogger LOGGER = new AggregationLogger(HandelsbankenSessionHandler.class);
    ...
    public HandelsbankenSessionHandler(HandelsbankenApiClient client,
    ...
    public void keepAlive() throws SessionException {
        ...
        KeepAliveResponse keepAlive = sessionStorage.applicationEntryPoint()
        ...
        if (!keepAlive.isAlive()) {
            ...
            persistentStorage.removeAuthorizeResponse();
            LOGGER.info(String.format("Session with Handelsbanken cannot be kept alive due to: %s",
    ...
    private void validateUserIsLoggedIn() throws SessionException {
        persistentStorage.getAuthorizeResponse().orElseThrow(HandelsbankenSessionHandler::sessionException);
    }

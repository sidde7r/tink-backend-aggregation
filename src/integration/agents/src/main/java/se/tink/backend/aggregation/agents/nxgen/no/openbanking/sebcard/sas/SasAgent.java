package se.tink.backend.aggregation.agents.nxgen.no.openbanking.sebcard.sas;
...
public class SasAgent extends SebBrandedCardsAgent {
    ...
    public SasAgent(
        ...
        super(request, context, signatureKeyPair, SebBrandedCardsConstants.BrandedCardsNorway.SAS);
    }
}

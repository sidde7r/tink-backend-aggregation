...
public class SabadellApiClient {
    ...
    public void initiateSession(String username, String password) {
        InitiateSessionRequestEntity requestEntity = InitiateSessionRequestEntity.build(username, password);
    ...
    public AccountsResponse fetchAccounts() {
        return createRequest(SabadellConstants.Urls.FETCH_ACCOUNTS)
                ...
                .queryParam(SabadellConstants.QueryParamPairs.CTA_VISTA.getKey(),
    ...
    public FetchCreditCardsResponse fetchCreditCards() {
        return createRequest(SabadellConstants.Urls.FETCH_CREDIT_CARDS)
                .queryParam(SabadellConstants.QueryParamPairs.CTA_CARD_ALL.getKey(),
    ...
    public AccountTransactionsResponse fetchTransactions(AccountEntity accountEntity, boolean key) {
        AccountTransactionsRequest requestEntity = AccountTransactionsRequest.build(accountEntity, key);
    ...
    public CreditCardTransactionsResponse fetchCreditCardTransactions(CreditCardEntity creditCardEntity,
    ...
    public String fetchLoans() {
        return createRequest(SabadellConstants.Urls.FETCH_LOANS)
                .queryParam(SabadellConstants.QueryParamPairs.PAGE.getKey(),
                        SabadellConstants.QueryParamPairs.PAGE.getValue())
                .queryParam(SabadellConstants.FetcherRequest.ITEMS_PER_PAGE,
    ...
    public DepositsResponse fetchDeposits() {
        return createRequest(SabadellConstants.Urls.FETCH_DEPOSITS)
                .get(DepositsResponse.class);
    }
    ...
    public SavingsResponse fetchSavings() {
        return createRequest(SabadellConstants.Urls.FETCH_SAVINGS)

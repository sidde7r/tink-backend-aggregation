    ...
    private TransactionsResponse getCheckingAccountsTransactionResponse() {
        return SerializationUtils.deserializeFromString(
                "{\n"
                        ...
                        + "      \"status\": \"BOOK\",\n"
                        + "      \"bookingDate\": \"2021-10-14T00:00:00+01:00\",\n"
                        + "      \"valueDate\": \"2021-10-14T00:00:00+01:00\",\n"
                        ...
                        + "      \"status\": \"BOOK\",\n"
                        + "      \"bookingDate\": \"2021-09-02T00:00:00+01:00\",\n"
                        + "      \"remittanceInformation\": {\n"
                        + "        \"unstructured\": [\n"
                        + "          \"some description 2\"\n"
                        + "        ]\n"
                        ...
                        + "      \"creditDebitIndicator\": \"DBIT\",\n"
                        + "      \"status\": \"PDNG\",\n"
                        + "      \"bookingDate\": \"2021-11-02T00:00:00+01:00\",\n"
                        + "      \"valueDate\": \"2021-11-02T00:00:00+01:00\",\n"
                        + "      \"remittanceInformation\": {\n"
                        + "        \"unstructured\": [\n"
                        + "          \"some description 3\"\n"
                        + "        ]\n"
    ...
    private TransactionsResponse getCreditCardTransactionResponse() {
        return SerializationUtils.deserializeFromString(
                "{\n"
                        ...
                        + "      \"creditDebitIndicator\": \"DBIT\",\n"
                        + "      \"status\": \"OTHR\",\n"
                        + "      \"expectedBookingDate\": \"2021-11-04T00:00:00+01:00\",\n"
                        + "      \"valueDate\": \"2021-10-14T00:00:00+01:00\",\n"
                        + "      \"remittanceInformation\": {\n"
                        + "        \"unstructured\": [\n"
                        + "          \"some description 1\"\n"
                        ...
                        + "      \"creditDebitIndicator\": \"DBIT\",\n"
                        + "      \"status\": \"BOOK\",\n"
                        + "      \"expectedBookingDate\": \"2021-09-02T00:00:00+01:00\",\n"
                        + "      \"remittanceInformation\": {\n"
                        + "        \"unstructured\": [\n"
                        + "          \"some description 2\"\n"
                        + "        ]\n"

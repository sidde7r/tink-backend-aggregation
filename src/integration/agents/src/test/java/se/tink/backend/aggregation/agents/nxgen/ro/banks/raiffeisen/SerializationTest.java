...
public class SerializationTest {
    ...
    public void testSerializeAccounts() {
        ...
        AccountsResponse response = SerializationUtils.deserializeForLogging(json, AccountsResponse.class).orElseThrow(() -> new IllegalStateException("Serialization error"));
    ...
    public void testSerializeTransactions() {
        ...
        TransactionsResponse response = SerializationUtils.deserializeForLogging(json, TransactionsResponse.class).orElseThrow(() -> new IllegalStateException("Serialization error"));

...
public class CaisseEpargneIleDeFranceAgentPaymentTest {
    ...
    private final ArgumentManager<CaisseEpargneIleDeFranceAgentPaymentTest.Arg>
            creditorDebtorManager =
                    new ArgumentManager<>(CaisseEpargneIleDeFranceAgentPaymentTest.Arg.values());
        ...
        AccountIdentifier creditorAccountIdentifier =
                new IbanIdentifier(
                        creditorDebtorManager.get(
                                CaisseEpargneIleDeFranceAgentPaymentTest.Arg.CREDITOR_ACCOUNT));

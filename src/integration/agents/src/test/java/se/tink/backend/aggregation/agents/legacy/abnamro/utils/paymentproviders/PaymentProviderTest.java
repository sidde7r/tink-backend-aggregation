...
public class PaymentProviderTest {
    ...
    public void testUrlDescriptionPatterns() throws Exception {
        ...
        // Check that we always pick the longest domain name if we have several matches. This is
        // done since
        // we have cases where we have both "google.com" and "goog le.com"
        assertThat(
                        provider.getDescription(
                                "ORD02267 005000228 5876370 Canvasscherm.nl Canvassc herm.nl"))
                .isEqualTo("Canvasscherm.nl");

        assertThat(provider.getDescription("ORD02267 short.nl Canvassc looooooong.nl"))
                .isEqualTo("looooooong.nl");

        assertThat(provider.getDescription("ORD0226 looooooong.nl Canvassc short.nl"))
                .isEqualTo("looooooong.nl");

        assertThat(provider.getDescription("OR67 www.short.nl Canva www.looooooong.nl"))
                .isEqualTo("www.looooooong.nl");

        assertThat(provider.getDescription("ORD www.looooooong.nl Cansc www.short.nl"))
                .isEqualTo("www.looooooong.nl");
        ...
        assertThat(provider.getDescription("94405542 Automatten4you.nl 12121"))
                .isEqualTo("Automatten4you.nl");

        // Do not support dot inside the domain name since it is most likly missing a space before
        // start
        assertThat(provider.getDescription("12122 Starthosting.nl000381Starthosting.nl"))
                .isEqualTo("Starthosting.nl");

        // Should not match numbers in the beginning since it is most likely a sequence or order
        // number
        assertThat(provider.getDescription("Foo bar 000043Weekendjeweg.nl")).isNull();

        // Remove any http:// or https:// in the beginning
        assertThat(provider.getDescription("http://www.eu-test.com, Foo "))
                .isEqualTo("www.eu-test.com");
        assertThat(provider.getDescription("https://www.eu-test.com, Bar "))
                .isEqualTo("www.eu-test.com");
        assertThat(provider.getDescription("https://www.eu-test.com, Bar "))
                .isEqualTo("www.eu-test.com");
    }
    ...
    public void testDescriptionPatterns() throws Exception {
        ...
        assertThat(provider.getDescription("Bestelling #100011111 @ GoToBags"))
                .isEqualTo("GoToBags");
        ...
        assertThat(provider.getDescription("Webshop Order : Deass pspdokt"))
                .isEqualTo("Deass pspdokt");
        assertThat(
                        provider.getDescription(
                                "61014907 8308036 Bestelling #100078669 @ all4runn all4running"))

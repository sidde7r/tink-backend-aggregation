...
public class CbiGlobeAgentSupportingAllPsd2AllAccountsWiremockTest {

    private static final String AAP_PATH =
            "src/integration/agents/src/test/java/se/tink/backend/aggregation/agents/nxgen/serviceproviders/openbanking/cbiglobe/integration/resources/test-refresh-supporting-all-psd2-all-accounts.aap";

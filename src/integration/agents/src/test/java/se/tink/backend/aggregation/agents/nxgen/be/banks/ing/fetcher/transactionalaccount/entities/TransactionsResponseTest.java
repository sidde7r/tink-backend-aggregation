...
public class TransactionsResponseTest {
    ...
    public void testParseTransactionDescription() {
        TransactionsResponse response = SerializationUtils.deserializeFromString(TEST_DATA, TransactionsResponse.class);
        Collection<Transaction> transactions = response.getTinkTransactions();
        assertEquals(7, transactions.size());
        for (Transaction tx : transactions) {
            System.out.println(String.format("TX description: %s\nrawDetails: %s", tx.getDescription(), tx.getRawDetails()));

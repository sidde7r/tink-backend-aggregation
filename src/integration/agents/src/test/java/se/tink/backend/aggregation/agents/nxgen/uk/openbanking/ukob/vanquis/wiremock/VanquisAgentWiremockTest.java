package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.vanquis.wiremock;
...
public class VanquisAgentWiremockTest {
    ...
    private static final String RESOURCES_PATH =
            "src/integration/agents/src/test/java/se/tink/backend/aggregation/agents/nxgen/uk/openbanking/ukob/vanquis/wiremock/resources/";

...
public class AccountUtilsTest {
    ...
    public void ensureCorrectBankId_whenGettingBankIdBySubAccount() {
        ...
        assertThat(
                        AccountUtils.getBankIdBySubAccount(
                                Collections.singletonList(account), "subAccount-1"))
                .isEqualTo("bankId-1");
    }
    ...
    public void ensureCorrectBankId_whenGettingBankIdBySubAccount_forMultipleAccounts() {
        ...
        assertThat(
                        AccountUtils.getBankIdBySubAccount(
                                ImmutableList.of(account1, account2), "subAccount-1"))
                .isEqualTo("bankId-1");
        assertThat(
                        AccountUtils.getBankIdBySubAccount(
                                ImmutableList.of(account1, account2), "subAccount-2"))
                .isEqualTo("bankId-2");
    }

    @Test
    public void
            ensureCorrectBankId_whenGettingBankIdBySubAccount_forSingleAccount_withMultipleSubAccounts() {
        Account account = createAccount("bankId-1", false, false);
        ...
        assertThat(
                        AccountUtils.getBankIdBySubAccount(
                                Collections.singletonList(account), "subAccount-2"))
                .isEqualTo("bankId-1");
    }

    @Test
    public void
            ensureCorrectBankId_whenGettingBankIdBySubAccount_forMultipleAccounts_withMultipleSubAccounts() {
        Account account1 = createAccount("bankId-1", false, false);
        Account account2 = createAccount("bankId-2", false, false);
        ...
        assertThat(
                        AccountUtils.getBankIdBySubAccount(
                                Collections.singletonList(account1), "subAccount-1"))
                .isEqualTo("bankId-1");
        assertThat(
                        AccountUtils.getBankIdBySubAccount(
                                Collections.singletonList(account1), "subAccount-2"))
                .isEqualTo("bankId-1");
        assertThat(
                        AccountUtils.getBankIdBySubAccount(
                                Collections.singletonList(account2), "subAccount-3"))
                .isEqualTo("bankId-2");
        assertThat(
                        AccountUtils.getBankIdBySubAccount(
                                Collections.singletonList(account2), "subAccount-4"))
                .isEqualTo("bankId-2");
    }

    @Test
    public void
            ensureCorrectBankId_whenGettingBankIdBySubAccount_forMultipleAccounts_withSameSubAccount() {
        Account account1 = createAccount("bankId-1", false, false);

...
public class BancoBpiTransactionalAccountFetcherTest {
    ...
    public void fetchAccountsShouldFetchAccounts() {
        // given
        BancoBpiTransactionalAccountsInfo accountsInfo = new BancoBpiTransactionalAccountsInfo();
        ...
        Mockito.when(entityManager.getTransactionalAccounts()).thenReturn(accountsInfo);

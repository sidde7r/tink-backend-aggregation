package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.bankofireland.wiremock;
...
public class BankOfIrelandAgentWireMockTest {
    ...
    private static final String RESOURCES_PATH =
            "src/integration/agents/src/test/java/se/tink/backend/aggregation/agents/nxgen/uk/openbanking/bankofireland/wiremock/resources/";

...
public class SpardaAgentPaymentTest {
    ...
    private final ArgumentManager<SpardaAgentPaymentTest.Arg> creditorDebtorManager =
            new ArgumentManager<>(SpardaAgentPaymentTest.Arg.values());
    ...
    public void setup() {
        ...
        builder =
                new AgentIntegrationTest.Builder("de", "de-sparda-nurnberg-ob")
                        ...
                        .setFinancialInstitutionId("9ab0b30b9d4447ac9c43cc8a3f0c5674")
                        .setAppId("tink")
    ...
    private Payment.Builder createRealDomesticPayment() {
        ...
        AccountIdentifier creditorAccountIdentifier =
                new IbanIdentifier(
                        creditorDebtorManager.get(SpardaAgentPaymentTest.Arg.CREDITOR_ACCOUNT));
        Creditor creditor = new Creditor(creditorAccountIdentifier, "Tink Creditor");

        AccountIdentifier debtorAccountIdentifier =
                new IbanIdentifier(
                        creditorDebtorManager.get(SpardaAgentPaymentTest.Arg.DEBTOR_ACCOUNT));

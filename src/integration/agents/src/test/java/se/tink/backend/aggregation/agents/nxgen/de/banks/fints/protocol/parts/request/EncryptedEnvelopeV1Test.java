...
public class EncryptedEnvelopeV1Test {

    @Test
    public void shouldSerializeProperlyWithoutAnySubSegments() {
        // given
        BaseRequestPart segment = new EncryptedEnvelopeV1();
    ...
    public void shouldSerializeProperlyWithSomeSegments() {
        // given
        EncryptedEnvelopeV1 segment = new EncryptedEnvelopeV1();
        segment.addSegment(new EncryptedEnvelopeV1());
        segment.addSegment(
    ...
    public void shouldSerializeProperlyWithLotsOfSegments() {
        ...
        segment.addSegment(
                SignatureHeaderV4.builder()
                        ...
                        .build());
        segment.addSegment(
                AuthorizeV2.builder().systemId(systemId).blz(blz).username(username).build());
        segment.addSegment(
                SystemInformationV3.builder()
                        .productId("PRODUCTID_1248278")
                        .productVersion("0.1")
                        .build());
        segment.addSegment(
                TanContextV6.builder()

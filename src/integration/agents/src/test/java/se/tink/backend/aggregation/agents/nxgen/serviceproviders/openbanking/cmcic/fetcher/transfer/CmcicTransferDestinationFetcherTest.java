...
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.cmcic.CmcicTestFixtures.createAccount1;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.cmcic.CmcicTestFixtures.createAccount2;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.cmcic.CmcicTestFixtures.createBeneficiary1Account;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.cmcic.CmcicTestFixtures.createBeneficiary2Account;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.cmcic.CmcicTestFixtures.createTrustedBeneficiariesPage1Response;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.cmcic.CmcicTestFixtures.createTrustedBeneficiariesPage2Response;
...
public class CmcicTransferDestinationFetcherTest {
    ...
    public void shouldFetchTransferDestinations() {
        ...
        final TrustedBeneficiariesResponseDto trustedBeneficiariesResponse1 =
        ...
        final TrustedBeneficiariesResponseDto trustedBeneficiariesResponse2 =

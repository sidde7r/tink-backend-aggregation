...
public class BancoPostaCheckingTransactionalAccountFetcherTest {
    ...
    private static final String ACCOUNTS_RESPONSE_FILE_PATH =
            "src/integration/agents/src/test/java/se/tink/backend/aggregation/agents/nxgen/it/banks/bancoposta/resources/accountResponse.json";

    private static final String ACCOUNTS_DETAILS_FILE_PATH =
            "src/integration/agents/src/test/java/se/tink/backend/aggregation/agents/nxgen/it/banks/bancoposta/resources/accountDetails.json";

    private static final String TRANSACTIONS_FILE_PATH =
            "src/integration/agents/src/test/java/se/tink/backend/aggregation/agents/nxgen/it/banks/bancoposta/resources/accountTransactionResponse.json";

    private static final String EMPTY_TRANSACTIONS_FILE_PATH =
            "src/integration/agents/src/test/java/se/tink/backend/aggregation/agents/nxgen/it/banks/bancoposta/resources/emptyTransactionResponse.json";

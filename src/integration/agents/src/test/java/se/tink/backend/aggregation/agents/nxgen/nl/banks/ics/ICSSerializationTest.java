...
public class ICSSerializationTest {
    ...
    public void serializeAccountSetupResponse() {
        AccountSetupResponse res =
                SerializationUtils.deserializeFromString(
                        this.accountSetupResponse, AccountSetupResponse.class);
        Assert.assertNotNull(res);
    }

    @Test
    public void serializeAccountsResponse() {
        CreditAccountsResponse res =
                SerializationUtils.deserializeFromString(
                        this.accountsResponse, CreditAccountsResponse.class);
        Assert.assertNotNull(res);
    }

    @Test
    public void serializeBalanceResponse() {
        CreditBalanceResponse res =
                SerializationUtils.deserializeFromString(
                        this.balanceResponse, CreditBalanceResponse.class);
        Assert.assertNotNull(res);
    }

    @Test
    public void serializeTransactionsResponse() {
        CreditTransactionsResponse res =
                SerializationUtils.deserializeFromString(
                        this.transactionsResponse, CreditTransactionsResponse.class);
        Assert.assertNotNull(res);
    }
}

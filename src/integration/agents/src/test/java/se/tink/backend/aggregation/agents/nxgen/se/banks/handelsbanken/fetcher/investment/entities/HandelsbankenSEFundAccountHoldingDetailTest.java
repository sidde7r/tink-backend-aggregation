...
public class HandelsbankenSEFundAccountHoldingDetailTest {
    private static final String holdingResponse =
            "{\n"
                    + "  \"_links\": {\n"
                    + "    \"purchase-context\": {\n"
                    + "      \"href\": \"https://m2.handelsbanken.se/app/priv/fund/orderContext?contextType=PURCHASE&fundOrFundAccountId=NzM1NDc0Mjcz&iskAccountNumber=1573817171&authToken=***MASKED***\",\n"
                    + "      \"gaScreenName\": \"Savings / Fund holdings / Buy\"\n"
                    + "    },\n"
                    + "    \"swap-context\": {\n"
                    + "      \"href\": \"https://m2.handelsbanken.se/app/priv/fund/orderContext?contextType=SWAP&fundOrFundAccountId=NzM1NDc0Mjcz&iskAccountNumber=1573817171&iskCustodyAccountNumberSwap=525409769&authToken=***MASKED***\",\n"
                    + "      \"gaScreenName\": \"Savings / Fund holdings / Swap\"\n"
                    + "    },\n"
                    + "    \"sell-context\": {\n"
                    + "      \"href\": \"https://m2.handelsbanken.se/app/priv/fund/orderContext?contextType=SELL&fundOrFundAccountId=NzM1NDc0Mjcz&iskAccountNumber=1573817171&authToken=***MASKED***\",\n"
                    + "      \"gaScreenName\": \"Savings / Fund holdings / Sell\"\n"
                    + "    },\n"
                    + "    \"change-amount-recurring-saving-context\": {\n"
                    + "      \"href\": \"https://m2.handelsbanken.se/app/priv/fund/orderContext?contextType=CHANGE_AMOUNT_RECURRING_SAVING&fundOrFundAccountId=NzM1NDc0Mjcz&iskAccountNumber=1573817171&authToken=***MASKED***\",\n"
    ...
    public void testFundDetails() {
        ...
        assertEquals(new Double(24610.35 / 135.04), instrument.get().getQuantity());
    }
}

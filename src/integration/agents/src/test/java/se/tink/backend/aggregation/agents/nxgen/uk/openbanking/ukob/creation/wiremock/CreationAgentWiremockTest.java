package se.tink.backend.aggregation.agents.nxgen.uk.openbanking.ukob.creation.wiremock;
...
public class CreationAgentWiremockTest {
    ...
    private static final String RESOURCES_PATH =
            "src/integration/agents/src/test/java/se/tink/backend/aggregation/agents/nxgen/uk/openbanking/ukob/creation/wiremock/resources/";

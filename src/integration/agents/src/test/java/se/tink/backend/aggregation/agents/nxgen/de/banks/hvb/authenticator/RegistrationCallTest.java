...
import se.tink.backend.aggregation.agents.nxgen.de.banks.hvb.authenticator.RegistrationCall.RequestBody;
...
public class RegistrationCallTest {
    ...
    private RegistrationCall tested =
            new RegistrationCall(httpClient, configurationProvider, dataEncoder);

...
public class DefaultCamtTransactionMapperTest {
    ...
    static {
        EXPECTED_DATA.put("UNSTRUCTUREDDESCRIPTION001", ExactCurrencyAmount.of(2112.4, "EUR"));
        EXPECTED_DATA.put("UNSTRUCTUREDDESCRIPTION002", ExactCurrencyAmount.of(-123.0, "EUR"));
        EXPECTED_DATA.put("UNSTRUCTUREDDESCRIPTION003", ExactCurrencyAmount.of(-223.14, "EUR"));
    }

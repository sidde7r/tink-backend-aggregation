...
public class BelfiusAgentTransferTest {
    ...
    private static final int AMOUNT_LARGE_REQUIRES_SIGN_OF_AMOUNT_OR_BENEFICIARY =
            2001; // Check if rules changed
    ...
    @Ignore // Please check that sourceCheckingAccount and ownSavingsAccountNotAllowedToTransferTo
    // set up
    ...
    public void testTransferToSavingsAccountThatIsNotAllowed() throws Exception {
        ...
        SepaEurIdentifier destionationSparrekingPlus =
                new SepaEurIdentifier(ownSavingsAccountNotAllowedToTransferTo);

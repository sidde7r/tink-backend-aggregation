...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.apiclient.dto.data.ErrorCode;
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.apiclient.dto.response.AccountsSummaryResponseDto;
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.apiclient.dto.response.ErrorResponseDto;
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.apiclient.dto.response.LoginDetailsResponseDto;
...
public final class AktiaTestFixtures {
    ...
    public static final String AUTH_SERVER_URL = "https://auth-server-url";
    public static final String API_SERVER_URL = "https://api-server-url";

package se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.authenticator.steps.helpers;
...
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.AktiaTestFixtures.createLoginDetailsResponseForLockedAccount;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.AktiaTestFixtures.createLoginDetailsResponseForMustAcceptTerms;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.AktiaTestFixtures.createLoginDetailsResponseForPasswordChange;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.AktiaTestFixtures.createNotSuccessfulLoginDetailsResponse;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.AktiaTestFixtures.createOtpInfoDto;
...
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.AktiaTestFixtures.createSuccessfulLoginDetailsResponseWithoutOtpRequired;

import org.junit.Before;
import org.junit.Test;
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.apiclient.AktiaApiClient;
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.apiclient.dto.response.OtpInfoDto;
...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.authenticator.steps.data.GetLoginDetailsStatus;

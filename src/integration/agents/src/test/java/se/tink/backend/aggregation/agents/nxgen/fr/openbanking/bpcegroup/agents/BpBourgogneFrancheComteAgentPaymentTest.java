...
public class BpBourgogneFrancheComteAgentPaymentTest {
    ...
    private final ArgumentManager<BpBourgogneFrancheComteAgentPaymentTest.Arg>
            creditorDebtorManager =
                    new ArgumentManager<>(BpBourgogneFrancheComteAgentPaymentTest.Arg.values());
        ...
        AccountIdentifier creditorAccountIdentifier =
                new IbanIdentifier(
                        creditorDebtorManager.get(
                                BpBourgogneFrancheComteAgentPaymentTest.Arg.CREDITOR_ACCOUNT));

        AccountIdentifier debtorAccountIdentifier =
                new IbanIdentifier(
                        creditorDebtorManager.get(
                                BpBourgogneFrancheComteAgentPaymentTest.Arg.DEBTOR_ACCOUNT));

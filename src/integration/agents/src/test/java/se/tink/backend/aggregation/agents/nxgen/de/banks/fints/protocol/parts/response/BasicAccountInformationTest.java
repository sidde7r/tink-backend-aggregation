...
public class BasicAccountInformationTest {
    @Test
    public void shouldParseSegmentCorrectly() {
        ...
        // when
        BasicAccountInformation segment = new BasicAccountInformation(rawSegment);
        ...
        assertThat(segment.getAccountLimit())
                .isEqualTo(
                        new BasicAccountInformation.Limit(
                                "LIMIT_TYPE", "LIMIT_VALUE", "LIMIT_CURRENCY_EUR", 100));

        assertThat(segment.getAllowedBusinessOperations())
                .containsExactly(
                        new BasicAccountInformation.AllowedBusinessOperation("HKSAK", 1),
                        new BasicAccountInformation.AllowedBusinessOperation("HKISA", 1),
                        new BasicAccountInformation.AllowedBusinessOperation("HKSSP", 1),
                        new BasicAccountInformation.AllowedBusinessOperation("HKCAZ", 1),
                        new BasicAccountInformation.AllowedBusinessOperation("HKEKA", 1),
                        new BasicAccountInformation.AllowedBusinessOperation("HKIPZ", 1),
                        new BasicAccountInformation.AllowedBusinessOperation("HKIPS", 1));

...
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.AktiaTestFixtures.createOtpAuthenticationResponseForOtherError;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.AktiaTestFixtures.createOtpAuthenticationResponseWhenAccountIsLocked;
import static se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.AktiaTestFixtures.createOtpAuthenticationResponseWhenOtpCodeNotAccepted;
...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.aktia.authenticator.steps.data.ExchangeOtpCodeStatus;

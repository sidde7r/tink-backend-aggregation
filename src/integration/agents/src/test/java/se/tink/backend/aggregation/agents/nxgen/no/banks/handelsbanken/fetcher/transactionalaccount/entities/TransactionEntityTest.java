...
public class TransactionEntityTest {
    ...
    private static final String rawDescr4 =
            "*1234 01.01 NOK 123.00 Vipps MERCHANT NAME Kurs: 1.0000";
    ...
    public void testParseTransactionDescription() {
        assertThat(TransactionEntity.getTinkFormattedDescription(rawDescr1))
                .isEqualTo(formattedDescr1);
        assertThat(TransactionEntity.getTinkFormattedDescription(rawDescr2))
                .isEqualTo(formattedDescr2);
        assertThat(TransactionEntity.getTinkFormattedDescription(rawDescr3))
                .isEqualTo(formattedDescr3);
        assertThat(TransactionEntity.getTinkFormattedDescription(rawDescr4))
                .isEqualTo(formattedDescr4);
        assertThat(TransactionEntity.getTinkFormattedDescription(rawDescr5))
                .isEqualTo(formattedDescr5);
    }
}

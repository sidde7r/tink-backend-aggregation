...
public class IngCryptoTest {
    ...
    public void testOtpForTransferToSavedBenificiary() {
        ...
        int calculatedOtp3 = IngCryptoUtils.calcOtpForSigningTransfer(otpKey, 69, "150000", "179796299");
    ...
    */
    ...
    public void testDataToSignFormatting() {
        ...
        Assertions.assertThat(EncodingUtils.encodeHexAsString(dataToSign8)).isEqualTo("100000f0179796298000000000000000");
    }
}

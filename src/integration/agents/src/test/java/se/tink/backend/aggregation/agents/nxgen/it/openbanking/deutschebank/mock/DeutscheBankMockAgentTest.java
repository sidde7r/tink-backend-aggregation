package se.tink.backend.aggregation.agents.nxgen.it.openbanking.deutschebank.mock;
...
public class DeutscheBankMockAgentTest {
    private static final String BASE_PATH =
            "src/integration/agents/src/test/java/se/tink/backend/aggregation/agents/nxgen/it/openbanking/deutschebank/mock/resources/";
    ...
    @Test
    public void testAisOfAccountAndTransactions() throws Exception {
        // given
        final String wireMockFilePath = BASE_PATH + "aisOfBalanceAndTransactions.aap";
        ...
        final AgentWireMockRefreshTest agentWireMockRefreshTest =
                AgentWireMockRefreshTest.nxBuilder()
                        .withMarketCode(IT)
                        .withProviderName("it-deutschebank-ob")

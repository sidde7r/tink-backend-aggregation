...
public class KbcOtpUtilsTest {
    private static final String ACTIVATION_MESSAGE = "00415FDE868B554C5EE80E16E636C37BD5AABE0A45FFC25EA1F8AE9D58293D0195C924B38817F36667E0DC302E74E9D60AC61079E4594D03910B408E82E7";
    private static final String FINGERPRINT = "AGNr8IaCzyb7ZDBwGdpY0FUqV1PF2neVVWB3v0a4ZEsn0uHRrH";
    private static final String DECRYPTED_STATIC_VECTOR = "";
    private static final String EXPECTED_STATICVECTOR_FIELD2 = "ccc82a9ffacc98897b7988ca382c3468";
    private static final String DECRYPTED_DYNAMIC_VECTOR = "00005FDE868B55715755911267572800AF9D4AB4F5C48B719338F548BB5F4AFA30995577656196C23D74DEF43128A337A80AF89813A2";
    ...
    public void testDiversifier() {
        ...
        device.setFingerprint(FINGERPRINT)
                .setStaticVector(DECRYPTED_STATIC_VECTOR);

        byte[] diversifier = device.calculateDiversifier();
        Assertions.assertThat(expectedDiversifier).isEqualTo(EncodingUtils.encodeHexAsString(diversifier));
    }
    ...
    public void testWbAes() {
        ...
        Assertions.assertThat(expectedKey).isEqualTo(EncodingUtils.encodeHexAsString(calculatedKey));
    }

    @Test
    public void testStaticVectorParse() {
        Optional<byte[]> staticVectorField2 = KbcOtpUtils.extractTlvField(
    ...
    public void testAesCtr() {
        final String expectedEncryptedData = "00000877831a60c21bc5b0340c288633e9da52fce1c300680db30ec4409f5098c7d73c0ca8c766";
        ...
        byte[] data = EncodingUtils.decodeHexString("22dcd9f366b24ecb5f290514a66b320aea10c64cc9932690753db74c610ba0704ac2f50c651bc7");

        byte[] encryptedData = AES.encryptCtr(key, ctr, data);

        Assertions.assertThat(expectedEncryptedData).isEqualTo(EncodingUtils.encodeHexAsString(encryptedData));
    }
    ...
    public void testCalculateOtpKey() {
        ...
        Assertions.assertThat(EXPECTED_OTP_KEY).isEqualTo(EncodingUtils.encodeHexAsString(device.getOtpKey()));
    }
    ...
    public void testSerialization() {
        ...
        KbcDevice device2 = SerializationUtils.deserializeFromString(serializedDevice, KbcDevice.class);
        Assertions.assertThat(EXPECTED_OTP_KEY).isEqualTo(EncodingUtils.encodeHexAsString(device2.getOtpKey()));
    }
}

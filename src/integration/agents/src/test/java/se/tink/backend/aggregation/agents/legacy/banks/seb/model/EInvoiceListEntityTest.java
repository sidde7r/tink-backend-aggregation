    ...
    public static class ValidEntity {
        ...
        public void hasDueDate() throws ParseException {
            Date expectedDate = new DateTime()
                    ...
                    .withMonthOfYear(3)
                    .withDayOfMonth(31)
                    .withHourOfDay(12).withMinuteOfHour(0).withSecondOfMinute(0).withMillisOfSecond(0).toDate();
        ...
        public void hasProviderUniqueId() {
            assertThat(deserialized.getProviderUniqueId()).isEqualTo("20160314111458-0004370|2016-03-14-15.38.30.124657");
        }

...
public class ErrorMessageTest {
    ...
    private static final String INCORRECT_USER_ID_PASSWORD = "X-SDC-ERROR-MESSAGE: Incorrect user ID or password.";
    ...
    public void incorrectUserPasswordLoginError() throws Exception {
        assertFalse(SdcConstants.ErrorMessage.LOGIN_DENIED.isLoginError(INCORRECT_USER_ID_PASSWORD));
        assertTrue(SdcConstants.ErrorMessage.INCORRECT_USER_PASSWORD.isLoginError(INCORRECT_USER_ID_PASSWORD));
        assertFalse(SdcConstants.ErrorMessage.PASSWORD_BLOCKED.isLoginError(INCORRECT_USER_ID_PASSWORD));
    }
    ...
    public void incorrectUserPasswordBlocked() throws Exception {
        ...
        assertFalse(SdcConstants.ErrorMessage.INCORRECT_USER_PASSWORD.isBlocked(INCORRECT_USER_ID_PASSWORD));
        assertFalse(SdcConstants.ErrorMessage.PASSWORD_BLOCKED.isBlocked(INCORRECT_USER_ID_PASSWORD));
    }
}

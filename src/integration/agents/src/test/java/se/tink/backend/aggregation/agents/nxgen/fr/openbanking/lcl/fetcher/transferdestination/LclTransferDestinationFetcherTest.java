package se.tink.backend.aggregation.agents.nxgen.fr.openbanking.lcl.fetcher.transferdestination;
...
public class LclTransferDestinationFetcherTest extends FrTransferDestinationFetcherTestBase {

    private LclTransferDestinationFetcher lclTransferDestinationFetcher;
    ...
    public void setUp() {
        ...
        lclTransferDestinationFetcher = new LclTransferDestinationFetcher(apiClientMock);
    }
    ...
    public void shouldFetchTransferDestinations() {
        ...
        final TransferDestinationsResponse returnedResponse =
                lclTransferDestinationFetcher.fetchTransferDestinationsFor(accounts);

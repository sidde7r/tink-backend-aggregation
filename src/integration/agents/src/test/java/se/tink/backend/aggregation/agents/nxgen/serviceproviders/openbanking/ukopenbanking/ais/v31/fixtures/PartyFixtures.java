...
public class PartyFixtures {
    ...
    public static IdentityDataV31Entity party() {
        return SerializationUtils.deserializeFromString(PARTY, IdentityDataV31Entity.class);
    }

    public static List<IdentityDataV31Entity> parties() {
        return SerializationUtils.deserializeFromString(
                PARTIES, new TypeReference<List<IdentityDataV31Entity>>() {});
    }
}

...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.ukopenbanking.base.entities.TrustedBeneficiaryDetailsEntity;
...
public class UkOpenBankingTransferDestinationFetcherTest {
    ...
    public void setUp() {
        ...
        transferDestinationFetcher =
                new UkOpenBankingTransferDestinationFetcher(
                        apiClient, AccountIdentifier.Type.IBAN, IbanIdentifier.class);
    }

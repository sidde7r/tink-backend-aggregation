...
public class AuthenticationService
    ...
    @Autowired
    @Qualifier("authorizationBuildUrlCommand")
    private AbstractCommand<AuthenticationRequest, AuthenticationResponse>
            authorizationBuildUrlCommand;
    ...
    public void login(
        ...
        AuthenticationResponse response = authorizationBuildUrlCommand.execute(request);

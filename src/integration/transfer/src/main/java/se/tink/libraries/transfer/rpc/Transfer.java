...
public class Transfer implements UuidIdentifiable, Serializable, Cloneable {
    ...
    public String toString() {
        ...
        return MoreObjects.toStringHelper(this.getClass())
                ...
                .add("sourceAccount", sourceAccount == null ? null : "***")
                .add("sourceMessage", sourceMessage == null ? null : "***")
                .add("destinationAccount", destinationAccount == null ? null : "***")
                .add("destinationMessage", destinationMessage == null ? null : "***")
                .add("dueDate", dueDate)
                .add("type", type)
                .add("hash", getHash())

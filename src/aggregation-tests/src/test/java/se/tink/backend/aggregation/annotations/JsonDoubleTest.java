...
public class JsonDoubleTest {
    ...
    private class Entity {
        ...
        @JsonDouble
        private double defaultAnnotation;
        ...
        @JsonDouble(decimalSeparator = ',', groupingSeparator = ' ', prefix = "$", suffix = " (some note)")
        ...
        @JsonDouble(
                ...
                decimals = 0, trailingZeros = false,
                decimalSeparator = ',', groupingSeparator = ' ',
                prefix = "400 000 euro motsvarar ungefär i svenska kronor ", suffix = " kronor."
        )
    ...
    private void compareValues(String jsonExpected, String jsonActual) {
        ...
        Assert.assertEquals((bExpected ? mExpected.group(1) : ""), (bActual ? mActual.group(1) : ""));
    }
}

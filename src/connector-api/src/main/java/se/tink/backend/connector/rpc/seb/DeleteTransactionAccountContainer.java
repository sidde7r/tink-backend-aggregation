...
public class DeleteTransactionAccountContainer {

    private static final LogUtils log = new LogUtils(DeleteTransactionAccountContainer.class);
    ...
    public boolean isValid(String externalUserId) {
        ...
        for (DeleteTransactionAccountEntity transactionAccount : transactionAccounts) {

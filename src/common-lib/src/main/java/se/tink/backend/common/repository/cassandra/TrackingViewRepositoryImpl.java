...
public class TrackingViewRepositoryImpl implements TrackingViewRepositoryCustom {

    private static final String TABLE_NAME = "tracking_views";
    ...
    public void createTableIfNotExist() {
        ...
        final CreateTableSpecification tableSpecification = CreateTableSpecification.createTable(TABLE_NAME)
                ...
                .clusteredKeyColumn("id", DataType.timeuuid()).column("name", DataType.text())

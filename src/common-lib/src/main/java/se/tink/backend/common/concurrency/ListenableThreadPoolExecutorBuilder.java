...
public final class ListenableThreadPoolExecutorBuilder<T extends Runnable> {
    ...
    private RejectedExecutionHandler<WrappedRunnableListenableFutureTask<T, ?>> rejectedHandler = new AbortPolicy<>();
    ...
    public ListenableThreadPoolExecutorBuilder<T> withMetric(MetricRegistry metricRegistry, String metricName) {
    ...
    public ListenableThreadPoolExecutorBuilder<T> withErrorLoggingCallback(FutureCallback<Object> errorLoggingCallback) {
    ...
    public ListenableThreadPoolExecutor<T> build() {
        ...
        ListenableThreadPoolExecutor<T> listenableThreadPoolExecutor = new ListenableThreadPoolExecutor<>(
                rejectedHandler,
                queue,
                threadPoolBuilder,

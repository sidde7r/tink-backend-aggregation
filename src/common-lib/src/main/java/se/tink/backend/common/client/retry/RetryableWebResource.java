...
import se.tink.backend.common.client.ExponentialBackoffPolicy;
...
public class RetryableWebResource {
    ...
    /**
     * Same as {@link #decorate(WebResource, Iterable, String)}, but supports injecting fake time. Generally, this
     * method only exists for testing purposes.
     * 
     * @param serviceName
     *            See {@link #decorate(String, Iterable, WebResource, Sleeper, Ticker)}.
     * @param candidates
     *            See {@link #decorate(String, Iterable, WebResource, Sleeper, Ticker)}.
     * @param resource
     *            See {@link #decorate(String, Iterable, WebResource, Sleeper, Ticker)}.
     * @param sleeper
     *            a class for sleeping a thread. Useful for mocking sleeps to run faster or more stable tests.
     * @param ticker
     *            an injectable clock.
     * @see #decorate(String, Iterable, WebResource).
     */

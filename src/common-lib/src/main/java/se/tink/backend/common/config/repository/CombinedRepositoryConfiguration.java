...
/**
 * JPA repository configurator for combined instances (development and staging).
 * <p>
...
class CombinedRepositoryConfiguration implements RepositoryConfigurator {
    private SingletonRepositoryConfiguration realConfigurator;

    public CombinedRepositoryConfiguration() {

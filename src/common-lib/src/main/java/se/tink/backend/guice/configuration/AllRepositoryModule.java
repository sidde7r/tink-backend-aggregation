...
public class AllRepositoryModule extends RepositoryModule {

    public AllRepositoryModule(DatabaseConfiguration databaseConfiguration,
    ...
    protected void bindDistributedDaos() {
        bind(AuthenticationTokenDao.class).in(Scopes.SINGLETON);
        bind(BankIdAuthenticationDao.class).in(Scopes.SINGLETON);
    ...
    protected void bindRepositories() {
        ...
        bindSpringBean(ActivityRepository.class);
        bindSpringBean(ProducedEventQueueActivityRepository.class);
        bindSpringBean(ApplicationArchiveRepository.class);
        ...
        bindSpringBean(AuthenticationTokenRepository.class);
        bindSpringBean(BankIdAuthenticationRepository.class);
        ...
        bindSpringBean(se.tink.backend.common.repository.mysql.main.GiroRepository.class);
        ...
        bindSpringBean(NotificationEventRepository.class);
        bindSpringBean(NotificationRepository.class);
        ...
        bindSpringBean(TransactionCheckpointRepository.class);
        ...
        bindSpringBean(UserAuthenticationChallengeRepository.class);
        ...
        bindSpringBean(UserOAuth2ClientRoleRepository.class);
        bindSpringBean(UserOriginRepository.class);
        bindSpringBean(UserProfileDataRepository.class);
        bindSpringBean(UserPublicKeyRepository.class);

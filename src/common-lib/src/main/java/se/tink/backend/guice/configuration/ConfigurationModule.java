...
public class ConfigurationModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(UserSessionConfiguration.class).toInstance(configuration.getAuthentication().getSessions());
        bind(CategorizationConfiguration.class).toInstance(configuration.getCategorization());
        bind(FlagsConfiguration.class).toInstance(configuration.getFlags());
        bind(SmsConfiguration.class).toInstance(configuration.getSms());
        bind(CmTelecomConfig.class).toInstance(configuration.getSms().getCmTelecom());
        bind(SmsOtpConfig.class).toInstance(configuration.getSms().getOtp());
        bind(SmsOtpRateLimitConfig.class).toInstance(configuration.getSms().getOtp().getRateLimit());

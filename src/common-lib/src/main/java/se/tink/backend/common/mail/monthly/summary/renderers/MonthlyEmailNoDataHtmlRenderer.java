...
public class MonthlyEmailNoDataHtmlRenderer {
    ...
    public String renderEmail(PooledRythmProxy pooledRythmProxy, EmptyEmailContent input) {
        ...
        return pooledRythmProxy.render(Template.MONTHLY_SUMMARY_TEMPLATE_NO_DATA_INLINED_HTML, context);
    }

    private void addMisc(Map<String, Object> context, EmptyEmailContent input, Catalog catalog) {
        context.put("userId", input.getUserId());
        context.put("backgroundImage", input.isAndroidUser() ? "phone_android-v2.png" : "phone_iphone-v2.png");

...
public class AppsFlyerEventAttributeKey {
    ...
    public static final String CONTENT_LIST = "ad_content_list";
    ...
    public static final String DESTINATION_LIST = "af_destination_list"; // Array of strings
    ...
    public static final String SUGGESTED_DESTINATIONS = "af_suggested_destinations"; // Array of strings
    public static final String TRAVEL_START = "af_travel_start";
    public static final String TRAVEL_END = "af_travel_end";
    public static final String NUM_ADULT = "af_num_adults";
    public static final String NUM_CHILDREN = "af_num_children";
    public static final String NUM_INFANTS = "af_num_infants";
    public static final String SUGGESTED_HOTELS = "af_suggested_hotels"; // Array of strings
    ...
    public static final String PREFERRED_STAR_RATINGS = "af_preferred_star_ratings"; // Array of integers (min,max)
    public static final String PREFERRED_PRICE_RANGE = "af_preferred_price_range"; // Array of integers (min,max)
    public static final String PREFERRED_NEIGHBORHOODS = "af_preferred_neighborhoods"; // Array of strings

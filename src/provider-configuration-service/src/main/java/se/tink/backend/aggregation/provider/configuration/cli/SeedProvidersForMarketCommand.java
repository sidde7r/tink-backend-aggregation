...
// FIXME: implementation unclear for Provider Service
/**
 * Try this locally.
 * bazel build :all
 * java -Dmarket=se -jar bazel-bin/provider-configuration_deploy.jar seed-providers-for-market etc/development-provider-configuration-server.yml
 */
//public class SeedProvidersForMarketCommand extends ProviderConfigurationCommand<ServiceConfiguration> {
//    private static final Logger log = LoggerFactory.getLogger(SeedProvidersForMarketCommand.class);

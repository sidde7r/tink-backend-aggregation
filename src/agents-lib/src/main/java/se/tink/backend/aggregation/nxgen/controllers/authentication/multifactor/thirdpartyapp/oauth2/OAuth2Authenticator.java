...
public interface OAuth2Authenticator {
    ...
    /**
     * If refreshing doesn't work you must throw a {@link SessionException} or {@link BankServiceException}
     */
    OAuth2Token refreshAccessToken(String refreshToken) throws SessionException, BankServiceException;

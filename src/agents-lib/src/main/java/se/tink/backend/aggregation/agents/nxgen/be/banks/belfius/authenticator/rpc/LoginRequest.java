...
public class LoginRequest extends BelfiusRequest {
    ...
    public static Builder create(String deviceTokenHashed, String deviceTokenHashedIosComparison, String signature) {
        return BelfiusRequest.builder()
                .setRequests(WidgetEventsRequest.create(
                        newInputEvent(BelfiusConstants.Widget.VERSION_KIND_APP, BelfiusConstants.Request.VERSION_KIND_APP),
                        newInputEvent(BelfiusConstants.Widget.DEVICE_TOKEN_HASHED, deviceTokenHashed),
                        newInputEvent(BelfiusConstants.Widget.DEVICE_TOKEN_HASHED_IOS_COMPARISON, deviceTokenHashedIosComparison),
                        ...
                        newInputEvent(BelfiusConstants.Widget.SYS_VER, BelfiusConstants.Request.SYS_VER),
                        newInputEvent(BelfiusConstants.Widget.APP_VER, BelfiusConstants.Request.APP_VER),
                        WidgetEventInformation.newButtonClickedWidgetEvent(BelfiusConstants.Widget.AUTHENTICATE)));
    }

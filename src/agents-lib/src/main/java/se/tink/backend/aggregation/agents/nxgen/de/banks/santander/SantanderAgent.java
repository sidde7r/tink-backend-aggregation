...
import se.tink.backend.aggregation.agents.nxgen.de.banks.santander.fetcher.SantanderAccountFetcher;
import se.tink.backend.aggregation.agents.nxgen.de.banks.santander.fetcher.SantanderTransactionFetcher;
...
public class SantanderAgent extends NextGenerationAgent {
    ...
    public SantanderAgent(CredentialsRequest request, AgentContext context, String signatureKeyPath) {

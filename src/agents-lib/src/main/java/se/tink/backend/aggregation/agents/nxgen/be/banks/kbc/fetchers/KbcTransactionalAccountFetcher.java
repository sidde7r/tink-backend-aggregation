...
public class KbcTransactionalAccountFetcher  implements AccountFetcher<TransactionalAccount>,
    ...
    public KbcTransactionalAccountFetcher(KbcApiClient apiClient) {
        this.apiClient = apiClient;
    }

    @Override
    public Collection<TransactionalAccount> fetchAccounts() {
        return apiClient.fetchAccounts().getAgreements().stream()
                .filter(agreement -> {
    ...
    public TransactionKeyPaginatorResponse<String> getTransactionsFor(TransactionalAccount account, String key) {
        try {
            return apiClient.fetchTransactions(account.getBankIdentifier(), key);

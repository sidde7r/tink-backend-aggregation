...
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.authenticator.rpc.ConfirmSignInRequest;
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.authenticator.rpc.ConfirmSignInResponse;
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.authenticator.rpc.ResendCodeRequest;
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.authenticator.rpc.SignInRequest;
...
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.fetcher.transactionalaccount.rpc.TransactionsResponse;

...
public class NordeaErrorUtils {
    ...
    private static final Map<String, SignableOperationStatuses> TRANSFER_ERROR_STATUSES =
            Maps.newHashMap();
    ...
    static {
        ...
        addTransferErrorMessage(
                "MBS0502", "Täckning saknas på kontot.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0503",
                "Betalningsdag får vara högst fem år framåt i tiden.",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0504", "Kontrollera meddelande.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0505",
                "Betalningsdag får inte vara tidigare än dagens datum",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0506", "Överföring finns redan.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0507",
                "Du har angett ett framtida betalningsdatum.",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0508",
                "Du har angett ett ogiltigt betalningsdatum.",
        ...
        addTransferErrorMessage(
                "MBS0510",
                "Du har inte behörighet att göra betalningar och överföringar från valt konto.",
                SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0511",
                "Betalningsdatumet är inte en bankdag eller efter stängning.",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0512",
                "Beloppet översteg den dagliga maxgränsen.",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage("MBS0513", "Kontot är spärrat.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0514",
                "Valuta på från-konto är inte samma som på till-konto.",
                SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0515",
                "Från-konto kan inte vara samma om till-konto.",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0521",
                "Ett fel uppstod. Vänligen kontrollera Obekräftade betalningar.",
                SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0522",
                "Ett fel uppstod. Kontrollera statusen för dina betalningar under Obekräftade betalningar, Betalningar som förfaller, och Kontotransaktioner.",
                SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0523",
                "Otillåtet belopp vad avser MIN/MAX-gränser",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage("MBS0524", "Ange mottagarkonto.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0525",
                "Kontrollera mottagarens kontonummer.",
                SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0526", "Kontrollera mottagarens namn.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0527", "Ange referensnummer.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0528", "Kontrollera OCR-numret.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0529", "A reference number is not allowed.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0530", "Skriv meddelande.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0531", "Kontrollera meddelandet.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0532", "Meddelande inte tillåtet.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0533", "Ange betalningens förfallodag.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0534", "Kontrollera betalningsdagen.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0535",
                "Ändra betalningsdagen till morgondagens datum eller senare.",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage("MBS0536", "Ange belopp.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0537",
                "Kontrollera beloppet. Ange beloppet i följande format 1234,00.",
                SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0538", "Kontrollera antalet betalningar.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0539", "Kontrollera betalningsfrekvensen.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0540",
                "Kontrollera betalningsdagen för den sista betalningen.",
                SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0541", "Betalningen behandlas just nu.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0542", "Betalningen är avslutad.", SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0543", "Betalningen kan inte ändras.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0544",
                "Uppgifterna om betalningen kan inte ändras.",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0545",
                "Betalningen har ändrats. Hämta betalningen på nytt.",
                SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0546",
                "Beloppet överstiger den dagliga maxgränsen.",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0547", "Kontrollera mottagarens namn.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0549", "Ange OCR eller meddelande.", SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0550",
                "Du kan inte spara samma mottagare två gånger.",
                SignableOperationStatuses.CANCELLED);
        addTransferErrorMessage(
                "MBS0551",
                "Betalningar med OCR-nummer kan enbart göras i SEK.",
                SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0552",
                "Du kan inte spara eller signera två exakt likadana betalningar eller överföringar.",
                SignableOperationStatuses.FAILED);
        addTransferErrorMessage(
                "MBS0553",
                "För att använda denna tjänst behöver du ha minst två giltiga konton att flytta pengar emellan.",
                SignableOperationStatuses.FAILED);
    }

    private static void addErrorType(
            String type, String message, CredentialsStatus status, Exception exception) {
    ...
    private static void addTransferErrorMessage(
            String type, String message, SignableOperationStatuses status) {
        ERROR_MESSAGES.put(type, message);

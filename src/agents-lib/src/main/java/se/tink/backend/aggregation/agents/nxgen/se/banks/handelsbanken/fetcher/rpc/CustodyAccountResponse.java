...
import se.tink.backend.aggregation.agents.nxgen.se.banks.handelsbanken.fetcher.entities.HandelsbankenPerformance;
import se.tink.backend.aggregation.agents.nxgen.se.banks.handelsbanken.fetcher.entities.SecurityHoldingList;
...
public class CustodyAccountResponse extends BaseResponse {
    ...
    public InvestmentAccount toInvestmentAccount(HandelsbankenSEApiClient client) {
        return InvestmentAccount.builder(constructUniqueIdentifier(), Amount.inSEK(toMarketValue()))

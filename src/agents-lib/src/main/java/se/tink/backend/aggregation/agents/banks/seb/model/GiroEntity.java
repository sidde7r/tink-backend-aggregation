...
public class GiroEntity {
    ...
    private OcrValidationConfiguration getPgMessageValidatorConfiguration() {
        ...
        throw new IllegalStateException(
                "Not possible to parse PG_KONTO_OCR_FL into OcrValidationLevel (" + PG_KONTO_OCR_FL + ")");
    }
    ...
    private OcrValidationConfiguration getBgMessageValidatorConfiguration() {
        ...
        case "4":
            ...
            if (fixedLength != null && fixedLengthAlt != null) {
                ...
                throw new IllegalStateException("No valid ocr lengths for fixed type (both lengths null)");
            }
        default:
            throw new IllegalStateException(
                    "Not possible to parse BG_KONTO_OCR_FL into OcrValidationLevel (" + BG_KONTO_OCR_FL + ")");
        }
    }

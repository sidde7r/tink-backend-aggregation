package se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.ukopenbanking.fetcher.v30.rpc.transaction;
...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.ukopenbanking.fetcher.v30.entities.transaction.TransactionEntity;
...
public class AccountTransactionsV30Response extends BaseResponse<List<TransactionEntity>> {
    ...
    private String nextKey() {
        return searchLink(UkOpenBankingV30Constants.Links.NEXT)
                .orElse(null);
    }

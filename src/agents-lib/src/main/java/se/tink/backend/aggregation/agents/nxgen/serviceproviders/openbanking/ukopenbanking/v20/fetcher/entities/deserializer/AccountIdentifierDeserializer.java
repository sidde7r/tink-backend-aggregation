...
public class AccountIdentifierDeserializer extends IdentifierMapDeserializer<UkOpenBankingV20Constants.AccountIdentifier, AccountIdentifierEntity> {
    public AccountIdentifierDeserializer() {
        super(UkOpenBankingV20Constants.ModelAttributes.SCHEME_NAME, UkOpenBankingV20Constants.AccountIdentifier.class, AccountIdentifierEntity.class);
    }
}

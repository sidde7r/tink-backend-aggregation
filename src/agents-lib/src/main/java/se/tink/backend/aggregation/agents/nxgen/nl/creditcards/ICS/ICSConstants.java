...
public class ICSConstants {
  ...
  public static final class Headers {
    ...
    // The unique id of the ASPSP to which the request is issued. The unique id will be issued by
    // OB.
    ...
    // The PSU's IP address if the PSU is currently logged in with the TPP. This would be blank in

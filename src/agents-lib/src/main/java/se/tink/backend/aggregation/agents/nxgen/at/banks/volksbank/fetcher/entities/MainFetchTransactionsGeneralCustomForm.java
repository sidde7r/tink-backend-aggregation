...
public class MainFetchTransactionsGeneralCustomForm extends AbstractForm {
    ...
    public MainFetchTransactionsGeneralCustomForm(String viewState) {
        ...
        this.put(VolksbankConstants.Form.KONTO_UMSATZ_SORTBOX, VolksbankConstants.Form.KONTO_UMSATZ_DESC);
        this.put(VolksbankConstants.Form.KONTO_UMSATZ_SORTBOXXS, VolksbankConstants.Form.KONTO_UMSATZ_DESC);
        this.put(VolksbankConstants.Form.KONTO_UMSATZ_TABLE_SELECTION, VolksbankConstants.BRACKET);
        this.put(VolksbankConstants.Form.KONTO_UMSATZ_TABLE_SUBSELECTION, VolksbankConstants.BRACKET);
        ...
        this.put(VolksbankConstants.Form.JSF_SOURCE_KEY, VolksbankConstants.Form.KONTO_UMSATZ_INLINE);
        this.put(VolksbankConstants.Form.JSF_PARTIAL_AJAX_KEY, VolksbankConstants.TRUE);
        this.put(VolksbankConstants.Form.JSF_PARTIAL_EXECUTE_KEY, VolksbankConstants.Form.KONTO_UMSATZ_INLINE);

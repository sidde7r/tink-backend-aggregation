...
public enum AlandsBankenMessage implements LocalizableEnum {
    ...
    APPROVAL_NEEDED("You have unconfirmed agreements, please login to Ålandsbankens online bank using a browser."),
    PINCODE_LIST_EXCEPTION("All disposable codes have been used, please contact Ålandsbanken at: 0771-415 415."),
    NEW_PIN_CODE_TABLE_FAULT("All disposable codes have been used, please contact Ålandsbanken at: 0771-415 415.");

...
public class MainForm extends AbstractForm {
    public MainForm(String viewState) {
        ...
        this.put(VolksbankConstants.Form.JSF_SOURCE_KEY, VolksbankConstants.Form.START_SITE + VolksbankConstants.COLOMN + VolksbankConstants.Form.REFRESH);
        this.put(VolksbankConstants.Form.JSF_PARTIAL_AJAX_KEY, VolksbankConstants.TRUE);
        this.put(VolksbankConstants.Form.JSF_PARTIAL_EXECUTE_KEY, VolksbankConstants.Form.START_SITE+ VolksbankConstants.COLOMN + VolksbankConstants.Form.REFRESH);

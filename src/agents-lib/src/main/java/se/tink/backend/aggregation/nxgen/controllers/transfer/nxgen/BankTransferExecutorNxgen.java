...
public interface BankTransferExecutorNxgen {
    ...
    /**
     * Initialize and prepare the agent for doing transfers. This could for example include doing one request to fetch
     * source accounts, destinations and beneficiaries.
     */
    void initialize();

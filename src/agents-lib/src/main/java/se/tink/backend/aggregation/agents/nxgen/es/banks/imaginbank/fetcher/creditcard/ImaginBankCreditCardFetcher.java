...
public class ImaginBankCreditCardFetcher
        ...
        try {
            ...
            if (cardsResponse != null && cardsResponse.getCardList() != null) {
                for (CardEntity cardEntity : Optional.ofNullable(cardsResponse.getCardList().getCards())
                    ...
                    fetchAndLogTransactions(cardEntity.getCardKey(), 0);
                }
            }
        } catch (Exception e) {
    ...
    private PaginatorResponse fetchAndLogTransactions(String cardId, int page) {
        ...
        try {
            String cardTransactionsResponse = apiClient.fetchCardTransactions(cardId, fromDate,
                    toDate, page > 0);

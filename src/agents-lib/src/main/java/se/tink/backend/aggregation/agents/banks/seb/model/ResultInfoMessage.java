...
public class ResultInfoMessage {
    private static final ImmutableMap<String, String> CANCELLED_DESCRIPTIONS_BY_CODE = ImmutableMap.<String, String>builder()
    ...
    public String getDescription() {
        ...
        if (description.isPresent()) {
            ...
            return String.format("Unknown error: %s", MoreObjects.toStringHelper(this)

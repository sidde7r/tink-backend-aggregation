...
public final class VolksbankCryptoHelper {
    ...
    private static final String js = "var Totp = function hash(secret) {\n"
    ...
    static String encryptPin(String pin) {
        return EncodingUtils.encodeHexAsString(
                RSA.encryptNonePkcs1(generateRSAPublicKey(), (VolksbankConstants.Crypto.RSA_SALT + pin).getBytes()));
    }
    ...
    private static RSAPublicKey generateRSAPublicKey() {
        ...
        byte[] exponentBytes = EncodingUtils.decodeHexString(VolksbankConstants.Crypto.RSA_EXPONENT);

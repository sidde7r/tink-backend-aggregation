        ...
        return Optional.of(new TransactionalAccountRefreshController(this.metricRefreshController,
                ...
                new TransactionFetcherController<>(this.transactionPaginationHelper,
                        new TransactionDatePaginationController<>(
                                new CrossKeyTransactionFetcher(this.apiClient, agentConfiguration)))
        ));
    }

    @Override
    protected Optional<CreditCardRefreshController> constructCreditCardRefreshController() {
        CrossKeyCreditCardFetcher creditCardFetcher = new CrossKeyCreditCardFetcher(this.apiClient,
                agentPersistentStorage);

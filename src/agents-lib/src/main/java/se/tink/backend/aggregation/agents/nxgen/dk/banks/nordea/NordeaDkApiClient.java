...
public class NordeaDkApiClient extends NordeaV20ApiClient {
    ...
    public NordeaDkApiClient(NordeaDkSessionStorage sessionStorage, TinkHttpClient client, Credentials credentials, String marketCode) {
    ...
    public InitialParametersResponse fetchInitialParameters() {
        InitialParametersRequestBody requestBody = new InitialParametersRequestBody()
                .setInitialParametersRequest(new InitialParametersRequestEntity()
                        .setAuthLevel(NordeaDkConstants.Authentication.DEFAULT_AUTH_LEVEL)
                        .setRemeberUserId("")
                );
    ...
    public NemidAuthenticateUserResponse nemIdAuthenticateUser(NemIdAuthenticateUserRequestBody requestBody) throws
    ...
    public AuthorizeAgreementResponse authorizeAgreement(AuthorizeAgreementRequestBody requestBody) throws
            AuthorizationException, AuthenticationException {

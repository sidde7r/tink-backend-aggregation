...
public class FundDetailsRequest {
    ...
    public static String create(String tokenCredential, String userDataXml, FundEntity fundEntity) {
        ...
        return String.format("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:v1=\"http://www.isban.es/webservices/BAMOBI/Fondos/F_bamobi_fondos_lip/internet/ACBAMOBIFON/v1\">"
                + "<soapenv:Header>"

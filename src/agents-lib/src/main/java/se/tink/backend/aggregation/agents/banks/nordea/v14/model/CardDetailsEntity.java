...
public class CardDetailsEntity {
    ...
    protected Map<String, Object> creditLimit = new HashMap<String, Object>();
    protected Map<String, Object> creditUsed = new HashMap<String, Object>();
    protected Map<String, Object> fundsAvailable = new HashMap<String, Object>();
    protected Map<String, Object> mainCardHolderName = new HashMap<String, Object>();
    protected Map<String, Object> mainCardId = new HashMap<String, Object>();
    protected Map<String, Object> minimumInstalmentTextCode = new HashMap<String, Object>();
    protected Map<String, Object> outstandingCreditAmount = new HashMap<String, Object>();
    protected Map<String, Object> ownerName = new HashMap<String, Object>();
    // protected Map<String, Object> sideCards = new HashMap<String, Object>();
    protected Map<String, Object> statusCode = new HashMap<String, Object>();

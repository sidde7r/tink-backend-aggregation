...
public class MainSelectAccountForm extends AbstractForm {
    ...
    public MainSelectAccountForm(String viewState, String productId) {
        ...
        this.put(VolksbankConstants.Form.START_PAGE_2680441_ROW_EXPANSION, VolksbankConstants.BRACKET);
        ...
        this.put(VolksbankConstants.Form.JSF_SOURCE_KEY, VolksbankConstants.Form.START_PAGE_2680441_CLICKED_ELEMENTID);
        ...
        this.put(VolksbankConstants.Form.JSF_PARTIAL_RENDER_KEY,
                VolksbankConstants.Form.START_PAGE_2680441_CLICKED_ELEMENT);
        this.put(VolksbankConstants.Form.START_PAGE_2680441, VolksbankConstants.Form.START_PAGE_2680441);
    }

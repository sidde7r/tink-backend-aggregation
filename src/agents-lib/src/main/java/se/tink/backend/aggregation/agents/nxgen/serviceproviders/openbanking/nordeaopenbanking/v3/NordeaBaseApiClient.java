...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.nordeaopenbanking.v3.authenticator.rpc.OauthTokenResponse;
...
import se.tink.backend.aggregation.agents.nxgen.serviceproviders.openbanking.nordeaopenbanking.v3.transactionalaccount.rpc.AccountsResponse;
...
public class NordeaBaseApiClient {
    ...
    public OauthTokenResponse exchangeCodeForAccessToken(String code) {

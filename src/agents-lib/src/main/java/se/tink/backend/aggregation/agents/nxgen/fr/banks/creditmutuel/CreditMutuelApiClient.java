...
public class CreditMutuelApiClient extends EuroInformationApiClient {
    private static final AggregationLogger AGGREGATION_LOGGER = new AggregationLogger(CreditMutuelApiClient.class);
    protected final Logger LOGGER = LoggerFactory.getLogger(CreditMutuelApiClient.class);

    public CreditMutuelApiClient(TinkHttpClient client,

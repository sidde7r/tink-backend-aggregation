...
public class PaymentDetailsResponse {
    ...
    public Optional<String> getSourceAccountId(AccountIdentifier accountIdentifier) {
        ...
        Optional<TransferDestinationAccountEntity> accountEntity = Optional.ofNullable(editTransactionOption)
    ...
    public Optional<String> getPaymentDestinationAccountId(AccountIdentifier accountIdentifier) {
        ...
        Optional<PayeeEntity> payeeEntity = Optional.ofNullable(editTransactionOption)
                .map(TransactionOptionEntity::getPayment)

...
public class MapValueMaskerImpl implements MapValueMasker {
    ...
    private final Maps.EntryTransformer<String, Collection<String>, Collection<String>> multiValueMapTransformer;

    /**
     * @param whiteListedKeys Set of keys of which values will NOT be masked, if absent all values are masked
     */
    ...
    private Maps.EntryTransformer<String, Collection<String>, Collection<String>> createMultivaluedEntryTransformer(
            final Optional<Set<String>> whiteListedKeys) {
        return new Maps.EntryTransformer<String, Collection<String>, Collection<String>>() {
            @Override
            public Collection<String> transformEntry(@Nullable String key, @Nullable Collection<String> values) {
    ...
    @Override
    public Map<String, Collection<String>> copyAndMaskMultiValues(Map<String, ? extends Collection<String>> map) {

...
public class SantanderApiClient {
  ...
  private RequestBuilder getRequest(String baseUrl, String resource) {
    return client
        .request(new URL(baseUrl + resource))
  ...
  public AccountsResponse fetchAccounts() {
    ...
    AccountsResponse response =
        getRequest(
                SantanderConstants.URL.BASEURL, SantanderConstants.URL.ACCOUNT, token, requestData)
  ...
  public CardDetailsResponse fetchCardInfo(String pan) {
    ...
    return getRequest(
            SantanderConstants.URL.BASEURL, SantanderConstants.URL.CARDINFO, token, requestData)

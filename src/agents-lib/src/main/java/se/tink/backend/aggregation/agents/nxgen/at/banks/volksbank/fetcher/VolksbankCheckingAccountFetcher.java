...
public class VolksbankCheckingAccountFetcher implements AccountFetcher<TransactionalAccount> {
    ...
    private static final Pattern ACCOUNT_INFO = Pattern.compile(
    ...
    public Collection<TransactionalAccount> fetchAccounts() {
        ...
        // TODO We don't have credentials that contain other account types, don't know yet how to parse that
        ...
        while (matcher.find()) {
            ...
            TransactionalAccount account = TransactionalAccount
                    .builder(AccountTypes.CHECKING, iban,
                            new Amount(matcher.group(VolksbankConstants.REGEX_GROUP.CURRENCY), StringUtils

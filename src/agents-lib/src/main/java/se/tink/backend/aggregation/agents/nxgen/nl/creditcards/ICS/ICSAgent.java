...
public class ICSAgent extends NextGenerationAgent {
    ...
    public void setConfiguration(AgentsServiceConfiguration configuration) {
        ...
        client.setSslClientCertificate(EncodingUtils.decodeBase64String(icsConfiguration.getClientSSLCertificate()), "");
        client.trustRootCaCertificate(EncodingUtils.decodeBase64String(icsConfiguration.getRootCACertificate()), icsConfiguration.getRootCAPassword());
    ...
    protected Optional<CreditCardRefreshController> constructCreditCardRefreshController() {
        return Optional.of(new CreditCardRefreshController(metricRefreshController, updateController,
                ...
                new TransactionFetcherController<>(transactionPaginationHelper,
                        new TransactionPagePaginationController<>(new ICSCreditCardFetcher(icsApiClient), 0), null)));
    }

...
public class GenerateBindingSkipActionForm extends AbstractForm {
    public GenerateBindingSkipActionForm(String viewState) {
        this.put(
                VolksbankConstants.Form.GBFORM + VolksbankConstants.COLOMN + VolksbankConstants.Form.GBFORM_SETUPID_KEY,
        ...
        this.put(VolksbankConstants.Form.JSF_SOURCE_KEY,
                VolksbankConstants.Form.GBFORM + VolksbankConstants.COLOMN + VolksbankConstants.Form.SKIP);

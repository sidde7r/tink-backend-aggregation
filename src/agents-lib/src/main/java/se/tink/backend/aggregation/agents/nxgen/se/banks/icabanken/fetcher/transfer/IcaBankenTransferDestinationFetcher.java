...
public class IcaBankenTransferDestinationFetcher implements TransferDestinationFetcher {
    ...
    private List<GeneralAccountEntity> getAllDestinationAccountsFor(IcaDestinationType destinationType) {
        List<GeneralAccountEntity> destinationAccounts = findDestinationAccountsFor(destinationType);

        Collection<GeneralAccountEntity> additionalDestinationAccounts = accountEntities.stream()
    ...
    private List<GeneralAccountEntity> findDestinationAccountsFor(IcaDestinationType destinationType) {

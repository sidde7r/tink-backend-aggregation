...
import se.tink.backend.aggregation.agents.nxgen.fi.banks.handelsbanken.fetcher.entities.HandelsbankenFILoan;
...
public class LoansFIResponse extends HandelsbankenLoansResponse {
    ...
    private Object totalLoanAmountList; //List<com.handelsbanken.android.resources.domain.AmountDTO> In app v2208
    private Object specialTextList; //List<java.lang.String> In app v2208
    private Object totalLoanPaymentsAmountList; //List<com.handelsbanken.android.resources.domain.AmountDTO> In app 2208
    ...
    public Collection<LoanAccount> toTinkLoans(Credentials credentials) {
        ...
        if (this.loans != null) {
            loanAccounts = this.loans.stream()

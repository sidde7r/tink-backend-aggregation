...
public class WebLoginResponse {
    ...
    public WebLoginResponse(final String username, final String accountHolder, final String basePage, final List<AccountReferenceEntity> accountReferenceEntities) {

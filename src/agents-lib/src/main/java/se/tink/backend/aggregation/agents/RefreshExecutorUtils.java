...
public class RefreshExecutorUtils {
    ...
    private final static Map<RefreshableItem, Class> REFRESHABLEITEM_EXECUTOR_MAP = ImmutableMap.<RefreshableItem, Class>builder()
            ...
            .put(RefreshableItem.INVESTMENT_ACCOUNTS, RefreshInvestmentAccountsExecutor.class)
            .put(RefreshableItem.INVESTMENT_TRANSACTIONS, RefreshInvestmentAccountsExecutor.class).build();

    public static Class getRefreshExecutor(RefreshableItem item) {
        return REFRESHABLEITEM_EXECUTOR_MAP.get(item);
    }

    public static void executeSegregatedRefresher(Agent agent, RefreshableItem item, AgentContext context) {

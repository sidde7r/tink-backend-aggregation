...
public class LoginRequest extends AbstractForm {
    public LoginRequest(String username, String password, String appVersion, String target) {
        ...
        this.put(EuroInformationConstants.RequestBodyValues.APP_VERSION, appVersion);
        ...
        this.put(EuroInformationConstants.RequestBodyValues.MEDIA, EuroInformationConstants.RequestBodyValues.MEDIA_VALUE);
    }
}
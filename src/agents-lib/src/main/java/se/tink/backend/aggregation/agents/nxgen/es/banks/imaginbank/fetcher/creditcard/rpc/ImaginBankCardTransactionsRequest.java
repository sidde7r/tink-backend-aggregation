...
@JsonObject
public class ImaginBankCardTransactionsRequest {
    @JsonProperty("filtros")
    private TransactionFilterEntity filter;
    @JsonProperty("masDatos")
    private String moreData;

    public static final ImaginBankCardTransactionsRequest createCardTransactionsRequest(boolean moreData,
            String filterCards,
            LocalDate startDate,
            LocalDate endDate) {
        ImaginBankCardTransactionsRequest request = new ImaginBankCardTransactionsRequest();
        request.moreData = String.valueOf(moreData);
        request.filter = TransactionFilterEntity.createTransactionFilter(filterCards, startDate, endDate);

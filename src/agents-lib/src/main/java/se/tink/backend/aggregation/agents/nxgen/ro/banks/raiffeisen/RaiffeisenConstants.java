...
public class RaiffeisenConstants {
    ...
    public static final String REDIRECT_URL_VALUE = "https://main.staging.oxford.tink.se/api/v1/credentials/third-party/callback";
    // for localhost: https://127.0.0.1:9100/api/v1/credentials/third-party/callback

...
public class TransactionEntityTest {
    private static final String transaction = "{\"Amount\":-159,\"Date\":\"/Date(1480806000000+0100)/\",\"Text\":\"DELIBRUKET FLATBREAD PARA\"}";
    ...
    public void deserialize() throws IOException {
        TransactionEntity transactionEntity = new ObjectMapper()
                .readValue(transaction, TransactionEntity.class);
    ...
    public void testToTransaction() {
        ...
        assertThat(transaction.getDate())
                .hasYear(2016).hasMonth(12).hasDayOfMonth(4)
                .hasHourOfDay(12).hasMinute(0).hasSecond(0).hasMillisecond(0);
    ...
    public void testToTransactionShorterTimestamp() {
        ...
        assertThat(transaction.getDate())
                .hasYear(2001).hasMonth(2).hasDayOfMonth(21)
                .hasHourOfDay(12).hasMinute(0).hasSecond(0).hasMillisecond(0);
    }
}

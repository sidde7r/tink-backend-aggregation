...
public class TransactionEntityTest {
    ...
    public void toTinkTransactionsTest() throws ParseException {
        TransactionEntity transactionEntity = createTransaction(PENDING_TRANSACTION_NAME, "Mastercard");
        ...
        assertThat(transaction.getOriginalAmount()).isEqualTo(-IkanoParser.stringToDouble(ORIGINAL_AMOUNT));
        assertThat(transaction.getDate()).isEqualTo(DateUtils.flattenTime(IkanoParser.stringToDate(DATE)));
        assertThat(transaction.getDescription()).isEqualTo(PENDING_TRANSACTION_NAME);
        Assert.assertTrue(transaction.isPending());
    }

    @Test
    public void transactionIsPending_When_TransactionName_Equals_SkyddatBelopp() throws ParseException {
    ...
    @Test
    public void descriptionIsEqualTo_TransactionName_When_CompanyName_Is_Null() throws ParseException {
    ...
    @Test
    public void descriptionIsEqualTo_CompanyName_When_NotPending_And_CompanyNameNotNull() throws ParseException {
    ...
    private TransactionEntity createTransaction(String transactionName, String companyName) throws ParseException {

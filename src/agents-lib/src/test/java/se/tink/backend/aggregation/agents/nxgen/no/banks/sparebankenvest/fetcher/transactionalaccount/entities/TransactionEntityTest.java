...
public class TransactionEntityTest {
    ...
    public void testTransactionParsing() throws IOException {
        ...
        TransactionEntity transactionEntity = mapper.readValue(TRANSACTION_TEST_DATA, TransactionEntity.class);
        ...
        assertEquals(DateUtils.flattenTime(DateUtils.parseDate("2018-01-26")), transaction.getDate());
    }
}

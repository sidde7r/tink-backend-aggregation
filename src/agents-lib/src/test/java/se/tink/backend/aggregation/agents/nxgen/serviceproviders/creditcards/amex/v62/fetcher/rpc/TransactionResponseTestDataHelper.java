...
public class TransactionResponseTestDataHelper {
    ...
    public static String PROPER_MESSAGE_CONSTANTS = " {\n"
            ...
            + "      }\n"
            + "    },";
    private static String NO_TRANSACTIONS_FOR_PERIOD_STRING = "    \"activityList\": [\n"
            + "      {\n"
            + "        \"billingIndex\": \"0\",\n"
            ...
            + "      }\n"
            + "    ]";
    private static String PROPER_TRANSACTION_LIST_STRING = "\"activityList\": [{\n"
            + "\"transactionList\": [{\n"
    ...
    public enum ResponseType {
        NO_TRANSACTIONS_FOR_PERIOD(PROPER_MESSAGE_CONSTANTS + NO_TRANSACTIONS_FOR_PERIOD_STRING + END_OF_MESSAGE),
        PROPER_TRANSACTION_LIST(PROPER_MESSAGE_CONSTANTS + PROPER_TRANSACTION_LIST_STRING + END_OF_MESSAGE),

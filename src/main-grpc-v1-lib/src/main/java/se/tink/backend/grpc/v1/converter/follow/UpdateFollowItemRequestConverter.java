...
public class UpdateFollowItemRequestConverter implements Converter<UpdateFollowItemRequest, FollowItem> {
    ...
    public UpdateFollowItemRequestConverter(Map<String, String> categoryIdByCode) {
        expensesFollowCriteriaConverter = new GrpcExpensesFollowCriteriaToCoreExpensesFollowCriteriaConverter(
                categoryIdByCode);
    }

    @Override
    public FollowItem convertFrom(UpdateFollowItemRequest input) {
        FollowItem followItem = new FollowItem();
        ConverterUtils.setIfPresent(input::getName, followItem::setName);
        ConverterUtils.setIfPresent(input::getFollowItemId, followItem::setId);

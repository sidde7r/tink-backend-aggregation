...
public class OxfordReprocessingChainFactory implements ChainFactory {
    ...
    public OxfordReprocessingChainFactory(
            Cluster cluster,
    ...
    public ImmutableList<TransactionProcessorCommand> build(TransactionProcessorContext context) {
        ...
        builder.add(
                ...
                //new RandomCategoryResetCommand(categories, categoryConfiguration, metricRegistry, categoryChangeRecordDao)
        );
    ...
    @Deprecated
    @VisibleForTesting
    public static OxfordReprocessingChainFactory fromServiceContext(
        ...
        if (context.isProvidersOnAggregation()) {
            citiesByMarket = CitiesByMarket
                    .build(context.getAggregationControllerCommonClient().listProviders());
        } else {
        ...
        return new OxfordReprocessingChainFactory(
                cluster,

...
public class SeedProvidersForMarketCommand extends ServiceContextCommand<ServiceConfiguration> {
    private static final LogUtils log = new LogUtils(SeedProvidersForMarketCommand.class);
    ...
    private void seedAllProvidersInConfigFile(String marketInProvidersConfig, String currencyInProvidersConfig,
            List<Provider> providers, String providersFileName) {
    ...
    private void seedProviderByProviderName(String providerName, String marketInProvidersConfig,
            String currencyInProvidersConfig, List<Provider> providers, String providersFileName) {
        Optional<Provider> providerInConfig = providers.stream()
    ...
    private void seedProvider(Provider providerToSeed, String market, String currency) {
        ...
        Provider checkedProviderToSeed = checkPotentiallyModifiedValuesInDatabase(providerToSeed);
        providerRepository.save(checkedProviderToSeed);
    }

    private Provider checkPotentiallyModifiedValuesInDatabase(Provider providerToSeed) {
        Provider providerInDatabase = providerRepository.findByName(providerToSeed.getName());
    ...
    protected void run(Bootstrap<ServiceConfiguration> bootstrap, Namespace namespace,
        ...
        String providerName = System.getProperty("providerName");
        String market = System.getProperty("market");

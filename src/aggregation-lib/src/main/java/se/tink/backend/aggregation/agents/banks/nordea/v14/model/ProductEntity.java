...
public class ProductEntity {
    protected Map<String, Object> accountType = new HashMap<String, Object>();
    protected Map<String, Object> balance = new HashMap<String, Object>();
    protected Map<String, Object> branchId = new HashMap<String, Object>();
    protected Map<String, Object> cardGroup = new HashMap<String, Object>();
    protected Map<String, Object> currency = new HashMap<String, Object>();
    protected Map<String, Object> fundsAvailable = new HashMap<String, Object>();
    protected Map<String, Object> isMainCard = new HashMap<String, Object>();
    protected Map<String, Object> nickName = new HashMap<String, Object>();
    protected Map<String, Object> productCode = new HashMap<String, Object>();
    protected Map<String, Object> productId = new HashMap<String, Object>();
    protected Map<String, Object> productNumber = new HashMap<String, Object>();
    protected Map<String, Object> productType = new HashMap<String, Object>();
    protected Map<String, Object> productTypeExtension = new HashMap<String, Object>();
    protected Map<String, Object> warningCode = new HashMap<String, Object>();

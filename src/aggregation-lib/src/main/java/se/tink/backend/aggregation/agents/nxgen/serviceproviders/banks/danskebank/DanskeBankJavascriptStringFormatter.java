...
public final class DanskeBankJavascriptStringFormatter {
    ...
    public static String createLoginJavascript(String dynamicLogonJavascript, String username, String password) {
        String javascriptString = "var e = %s;\n" +
    ...
    public static String createChallengeJavascript(String challengeDynamicJavascript, String username,
                                                  String otpChallenge) {
        String challengeJavascript = "var e = %s;\n" + COMMON_FUNCTION +
        ...
        return String.format(challengeJavascript, challengeDynamicJavascript, username, otpChallenge);
    }

    public static String createChallengeAnswerJavascript(String challengeDynamicJavascript, String challengeAnswer) {
        String challengeAnswerJavascript = "var e = %s;\n" + COMMON_FUNCTION +
        ...
        return String.format(challengeAnswerJavascript, challengeDynamicJavascript, challengeAnswer);
    }

    public static String createCollectDeviceSecretJavascript(String challengeDynamicJavascript, String sharedSecret) {
        String collectDeviceSecretJavascript = "var e = %s;\n" + COMMON_FUNCTION +
        ...
        return String.format(collectDeviceSecretJavascript, challengeDynamicJavascript, sharedSecret);
    }

    public static String createInitStepUpTrustedDeviceJavascript(String challengeDynamicJavascript, String username,
                                                          String otpChallenge) {
        String initStepUpTrustedDeviceJavascript = "var e = %s;\n" + COMMON_FUNCTION +
                        "function setChallengeInfo(challengeInfoEntity) {\n" +
        ...
        return String.format(initStepUpTrustedDeviceJavascript, challengeDynamicJavascript, username, otpChallenge);
    }

    public static String createGenerateResponseJavascript(String challengeDynamicJavascript, String username,
                                                         String otpChallenge,
                                                         String generateResponseInputAsBase64) {
        String generateResponseJavascript = "var e = %s;\n" + COMMON_FUNCTION +
                        "function setChallengeInfo(challengeInfoEntity) {\n" +
                        "    document.body.setAttribute(\"trustedChallengeInfo\", JSON.stringify(challengeInfoEntity));\n" +
                        "}\n" +
        ...
        return String.format(generateResponseJavascript, challengeDynamicJavascript, username, otpChallenge,
                generateResponseInputAsBase64);
    }

    public static String createValidateStepUpTrustedDeviceJavascript(String challengeDynamicJavascript,
                                                                     String username, String otpChallenge,
                                                                     String generateResponseInputAsBase64,
                                                                    String validateStepUpTrustedDeviceAsBase64) {
        String validateStepUpTrustedDeviceJavascript = "var e = %s;\n" + COMMON_FUNCTION +
                        "function setChallengeInfo(challengeInfoEntity) {\n" +
                        "    document.body.setAttribute(\"trustedChallengeInfo\", JSON.stringify(challengeInfoEntity));\n" +
                        "}\n" +
                        "function setChallengeResponse(challengeResponse) {\n" +
        ...
        return String.format(validateStepUpTrustedDeviceJavascript, challengeDynamicJavascript, username, otpChallenge,
                generateResponseInputAsBase64, validateStepUpTrustedDeviceAsBase64);
    }
}

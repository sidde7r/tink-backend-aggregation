...
public class NordeaHashMapDeserializer extends JsonDeserializer<String> {
    @Override
    public java.lang.String deserialize(JsonParser jsonParser, DeserializationContext context) throws IOException {
    ...
    public static class Double extends JsonDeserializer<java.lang.Double> {
        @Override
        public java.lang.Double deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
                throws IOException {
            JsonNode jsonNode = contentNode(jsonParser);
    ...
    public static class Boolean extends JsonDeserializer<java.lang.Boolean> {
        @Override
        public java.lang.Boolean deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
                throws IOException {
            JsonNode jsonNode = contentNode(jsonParser);
    ...
    public static class Integer extends JsonDeserializer<java.lang.Integer> {
        @Override
        public java.lang.Integer deserialize(JsonParser jsonParser, DeserializationContext deserializationContext)
                throws IOException {
            JsonNode jsonNode = contentNode(jsonParser);

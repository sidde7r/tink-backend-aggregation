...
public class PrepareDeviceRegistrationRequest extends BelfiusRequest {
    ...
    public static PrepareDeviceRegistrationRequest.Builder create(String deviceToken, String deviceBrand, String deviceName) {
        return BelfiusRequest.builder()
                .setRequests(
                        ...
                        WidgetEventsRequest.create(
                                WidgetEventInformation.newButtonClickedWidgetEvent(
                                        BelfiusConstants.Widget.DEVICE_REGISTRATION_PREPARE_REGISTRATION),
                                WidgetEventInformation.newInputValueChangedWidgetEvent(
                                        BelfiusConstants.Widget.DEVICE_REGISTRATION_DEV_TOKEN, deviceToken),
                                WidgetEventInformation.newInputValueChangedWidgetEvent(
                                        BelfiusConstants.Widget.DEVICE_REGISTRATION_BRAND, deviceBrand),
                                WidgetEventInformation.newInputValueChangedWidgetEvent(
                                        BelfiusConstants.Widget.DEVICE_REGISTRATION_MODEL, deviceName)));
    }
}

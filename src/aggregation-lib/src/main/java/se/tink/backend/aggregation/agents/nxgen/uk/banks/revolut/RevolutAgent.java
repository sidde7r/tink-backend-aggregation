...
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.authenticator.RevolutAutoAuthenticator;
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.authenticator.RevolutMultifactorAuthenticator;
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.fetcher.transactionalaccount.RevolutTransactionFetcher;
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.fetcher.transactionalaccount.RevolutTransactionalAccountFetcher;
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.filter.RevolutFilter;
import se.tink.backend.aggregation.agents.nxgen.uk.banks.revolut.session.RevolutSessionHandler;

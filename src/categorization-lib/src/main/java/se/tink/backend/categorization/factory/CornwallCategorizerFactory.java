...
public class CornwallCategorizerFactory implements CategorizerFactory {
    ...
    @Inject
    public CornwallCategorizerFactory(CategoryConfiguration categoryConfiguration,
    ...
    private Collection<Classifier> buildClassifiers(Provider provider,
            User user, Collection<Transaction> inStoreTransactions, LabelIndexCache labelIndexCache,

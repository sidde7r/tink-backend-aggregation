package se.tink.backend.aggregation.credit.safe.agent;
...
import se.tink.backend.aggregation.credit.safe.agent.creditsafe.ConsumerMonitoringWrapper;
import se.tink.backend.aggregation.credit.safe.agent.creditsafe.soap.Account;
import se.tink.backend.aggregation.credit.safe.agent.creditsafe.soap.Error;
import se.tink.backend.aggregation.credit.safe.agent.creditsafe.soap.GetData;
import se.tink.backend.aggregation.credit.safe.agent.creditsafe.soap.GetDataRequest;
import se.tink.backend.aggregation.credit.safe.agent.creditsafe.soap.GetDataResponse;
import se.tink.backend.aggregation.credit.safe.agent.creditsafe.soap.GetDataSoap;
import se.tink.backend.aggregation.credit.safe.agent.creditsafe.soap.GetDataTest;
import se.tink.backend.aggregation.credit.safe.agent.creditsafe.soap.Language;

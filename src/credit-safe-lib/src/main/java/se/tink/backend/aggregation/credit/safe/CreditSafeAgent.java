...
import se.tink.backend.aggregation.credit.safe.creditsafe.ConsumerMonitoringWrapper;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.Account;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.Error;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.GetData;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.GetDataRequest;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.GetDataResponse;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.GetDataSoap;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.GetDataTest;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.Language;

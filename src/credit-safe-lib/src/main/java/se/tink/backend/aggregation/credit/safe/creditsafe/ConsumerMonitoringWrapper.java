...
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.consumermonitoring.Account;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.consumermonitoring.LANGUAGE;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.consumermonitoring.MonitoredObject;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.consumermonitoring.Monitoring;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.consumermonitoring.MonitoringRequest;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.consumermonitoring.MonitoringResponse;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.consumermonitoring.MonitoringSoap;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.consumermonitoring.PortfolioObject;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.consumermonitoring.ResultCountersReqObject;
import se.tink.backend.aggregation.credit.safe.creditsafe.soap.consumermonitoring.STATUS;

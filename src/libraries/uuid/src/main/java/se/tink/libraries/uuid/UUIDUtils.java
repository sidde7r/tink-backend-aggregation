...
public class UUIDUtils {
    public final static Function<UUID, String> TO_TINK_UUID_TRANSFORMER = UUIDUtils::toTinkUUID;
    private final static Pattern UUID_V4_PATTERN = Pattern.compile(
    ...
    public final static Function<String, UUID> FROM_TINK_UUID_TRANSFORMER = UUIDUtils::fromTinkUUID;
    ...
    /**
     * Convert a Tink UUID {@code String} object (07da44eeae8d448b8b67bdf5e0488832) to a Java {@code UUID} object.
     *
    ...
    public static UUID fromTinkUUID(final String uuid) {
        ...
        Preconditions.checkArgument(HEXADECIMAL_PATTERN.matcher(uuid).matches(), "Incorrect UUID: " + uuid);
    ...
    /**
     * Convert a Java {@code UUID} object to a Tink UUID {@code String} object (07da44eeae8d448b8b67bdf5e0488832).
     */

...
public class RetryableInstanceMetadataCredentialsEndpointRetryPolicy
        implements CredentialsEndpointRetryPolicy {

    /** Max number of times a request is retried before failing. */
    private static final int MAX_RETRIES = 5;

    private static RetryableInstanceMetadataCredentialsEndpointRetryPolicy instance;

    private RetryableInstanceMetadataCredentialsEndpointRetryPolicy() {}

    public static RetryableInstanceMetadataCredentialsEndpointRetryPolicy getInstance() {
        if (instance == null) {
            instance = new RetryableInstanceMetadataCredentialsEndpointRetryPolicy();
        }
        return instance;
    }

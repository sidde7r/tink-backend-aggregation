...
public class InstanceToURLFunction implements
        Function<ServiceInstance<InstanceDetails>, Iterable<RetryableWebResource.Candidate>> {

    @Override
    public Iterable<RetryableWebResource.Candidate> apply(ServiceInstance<InstanceDetails> instance) {

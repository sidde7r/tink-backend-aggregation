...
public class ExposedIpFinderTest {
    ...
    public void testIpRanking() throws UnknownHostException {
        Collection<InetAddress> availableAddresses = new HashSet<>(Arrays.asList(
    ...
    public void testIpRankingIPv6() throws UnknownHostException {
        ...
        assertEquals("2001:1111:0:0:0:ff00:42:8329",
                ExposedIpFinder.getIpForRoute(availableAddresses, "2001:1111:0000:0000:0000:ff00:1111:8329"));
    }
}

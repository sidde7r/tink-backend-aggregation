...
public class TransactionInMemoryReadWriteLockTest {
    ...
    public void testRecreatingRaceCondition() throws Exception {
        ...
        final InterProcessReadWriteLock rwLock = new InterProcessReadWriteLock(client,
                "/jens/super/lock");
        ...
        Thread firstReadLockThread = new Thread(() -> {
            ...
            try {
                ...
                try {
                    Uninterruptibles.awaitUninterruptibly(readyToShutDown, 2, TimeUnit.MINUTES);
                } finally {

...
public class PeriodTest {
    ...
    public void isDateWithinInclusive(String startDate, String endDate, String date, boolean isWithin) {
    ...
    public void isPeriodWithinInclusive(String startDate, String endDate, String newPeriodStartDate,
            String newPeriodEndDate, boolean isWithin) {

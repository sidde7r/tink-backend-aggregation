...
/**
 * How the ocr validator should require giro message according to Swedish banking standards for OCR types.
 *  <li>{@link #NO_OCR}</li>
 *  <li>{@link #OCR_1_SOFT}</li>
 *  <li>{@link #OCR_2_HARD}</li>
 *  <li>{@link #OCR_3_HARD}</li>
 *  <li>{@link #OCR_4_HARD}</li>
 */
public enum OcrValidationLevel {
    ...
    OCR_2_HARD,
    /**
     * Allows only OCR, variable length with length check (digit before last) and Luhn check (last digit)
     */
    OCR_3_HARD,
    /**

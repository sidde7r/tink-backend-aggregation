...
public class OcrValidatorTest {
    public static class Common {
        ...
        public void numericIsPotentiallyIntendedOcr() {
            ...
            boolean nonNumericIsNotIntendedToBeOcr = ocrValidator.isNumericPotentiallyIntentedOcr("1234");
        ...
        public void nonNumericIsNotPotentiallyIntendedOcr() {
            ...
            boolean nonNumericIsNotIntendedToBeOcr = ocrValidator.isNumericPotentiallyIntentedOcr("_");
    ...
    /**
     * The Luhn digit is correct for the OCR, but the digit before the last digit should be calculated as:
     * ocr.length() % 10
     */
    public static class HardOcrVariableLengthWithLengthDigitValidationTest {
        ...
        public void ocrMessageWithCorrectLengthDigitIsValid() {
            ...
            boolean valid = ocrValidator.isValid("41512178467811674"); // Valid Luhn ("4"), valid length digit ("7")
        ...
        public void ocrMessageWithIncorrectLengthDigitIsInvalid() {
            ...
            boolean valid = ocrValidator.isValid("1212121212"); // Valid Luhn, but length digit is wrong
    ...
    public static class HardOcrFixedLengthValidationTest {
        ...
        public void ocrMessageWithAlternativeFixedLengthIsValid() {
            OcrValidationConfiguration configuration = OcrValidationConfiguration.hardOcrFixedLength(10, 15);
            OcrValidator ocrValidator = new OcrValidator(configuration);

            boolean valid = ocrValidator.isValid("377601137311074"); // Has alternative ocr length 15

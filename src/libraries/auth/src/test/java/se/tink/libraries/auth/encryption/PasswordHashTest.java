...
public class PasswordHashTest {
    ...
    public void testCheckPassword_shortFormat() {
        ...
        assertThat(PasswordHash.check(secureHashed, secureHashed, HashingAlgorithm.BCRYPT)).isFalse();
    ...
    public void testCheckPassword_authenticateScryptPassword() {
        List<HashingAlgorithm> allowedHashsWithScrypt = Lists.newArrayList(HashingAlgorithm.SCRYPT,
                HashingAlgorithm.BCRYPT);
        List<HashingAlgorithm> allowedHashsNoScrypt = Lists.newArrayList(HashingAlgorithm.BCRYPT);

        String tinkHashed = "$s0$e0801$QZCpKu9IyySUgjvEU2FLwQ==$HUb1iHi6eDsDAMN0LPaLifAzpbwbhp4LdXz/IFUkTBI=";

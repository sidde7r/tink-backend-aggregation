...
/**
 * Used for localizing static strings. This is sometimes needed when not having the catalog instance and you want
 ...
 * <p>
 * How to use:
 * private static final String MY_TRANSLATED = new LocalizableKey(…)
 * <p>
 * …
 * catalog.getString(MY_TRANSLATED); (additionally with parameters if parametrized)
 */

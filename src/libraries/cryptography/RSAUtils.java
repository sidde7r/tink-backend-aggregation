...
public class RSAUtils {
    ...
    private static String defaultSignatureAlgorithm = "SHA512withRSA";
    ...
    public static RSAPrivateKey getPrivateKey(String keyPath) {
        try (PEMParser pemReader =
            ...
            throw new IllegalArgumentException(
                    "Could not convert key path into valid private key.", e);
        }
    }
    ...
    public static RSAPublicKey getPublicKey(String keyPath) {
        try (PEMParser pemReader =
            ...
            throw new IllegalArgumentException(
                    "Could not convert key path into valid public key.", e);
        }
    }
    ...
    public static Signature getSignature(PrivateKey key)
        ...
        Signature signature = Signature.getInstance(defaultSignatureAlgorithm);

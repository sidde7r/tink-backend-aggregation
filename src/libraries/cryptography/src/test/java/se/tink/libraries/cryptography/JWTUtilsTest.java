...
public class JWTUtilsTest {
    ...
    private static final String PUBLIC_KEY =
            "-----BEGIN PUBLIC KEY-----\n"
                    ...
                    + "l1Aa/3c2ncA7lZNxkFk=\n"
                    + "-----END PUBLIC KEY-----\n";
    private static final String WRONG_PUBLIC_KEY =
            "-----BEGIN PUBLIC KEY-----\n"
    ...
    public void testSignAndVerify() throws Exception {
        ...
        VerificationStatus status =
                JWTUtils.verify(CHALLENGE, jwtToken, ECDSAUtils.getPublicKey(PUBLIC_KEY));
    ...
    public void testWrongKeySignAndVerify() throws Exception {
        String jwtToken = JWTUtils.create(CHALLENGE, ECDSAUtils.getPrivateKey(PRIVATE_KEY));
        VerificationStatus status =
                JWTUtils.verify(CHALLENGE, jwtToken, ECDSAUtils.getPublicKey(WRONG_PUBLIC_KEY));

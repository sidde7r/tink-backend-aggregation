...
public class SortCodeIdentifierTest {
    ...
    private static final SortCodeIdentifier VALID_IDENTIFIER_7_DIGIT_ACCOUNT_NUMBER = new SortCodeIdentifier("12-34-56 1234567");
    private static final SortCodeIdentifier VALID_IDENTIFIER_8_DIGIT_ACCOUNT_NUMBER = new SortCodeIdentifier("12-3456    12345678");

    @Rule
    public ExpectedException expectedException = ExpectedException.none();

    @Test
    public void getIdentifier_shouldReturnIdentifier_ifValidIdentifierWithSevenDigitAccountNumber() {
    ...
    public void getType_returnsCorrectType_ifValidSortCodeIdentifier() {
        assertThat(VALID_IDENTIFIER_7_DIGIT_ACCOUNT_NUMBER.getType(), is(AccountIdentifier.Type.SORT_CODE));
    }

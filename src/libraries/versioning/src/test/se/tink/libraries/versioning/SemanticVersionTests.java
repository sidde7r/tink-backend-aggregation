package se.tink.libraries.versioning;
...
public class SemanticVersionTests {
    ...
    public void testIsValid() {
        assertTrue(SemanticVersion.isValid("1.0.1"));
        assertTrue(SemanticVersion.isValid("2.0.0"));
        assertTrue(!SemanticVersion.isValid("foo.bar"));
    }

...
import se.tink.libraries.abnamro.client.rpc.enrollment.InitiateEnrollmentRequest;
import se.tink.libraries.abnamro.client.rpc.enrollment.InitiateEnrollmentResponse;
import se.tink.libraries.abnamro.config.AbnAmroEnrollmentConfiguration;

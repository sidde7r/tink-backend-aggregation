...
public class User {
    ...
    public se.tink.backend.aggregation.rpc.User toAggregationUser() {
        se.tink.backend.aggregation.rpc.User user = new se.tink.backend.aggregation.rpc.User();

        user.setBlocked(this.blocked);
        user.setConfirmed(this.confirmed);
        user.setCreated(this.created);
        user.setDebugUntil(this.debugUntil);
        user.setEndpoint(this.endpoint);
        user.setFlagsSerialized(this.flagsSerialized);
        user.setHash(this.hash);
        user.setId(this.id);
        user.setNationalId(this.nationalId);
        user.setPassword(this.password);
        user.setProfile(this.profile != null ? this.profile.toAggregationUserProfile() : null);
        user.setServices(this.services);

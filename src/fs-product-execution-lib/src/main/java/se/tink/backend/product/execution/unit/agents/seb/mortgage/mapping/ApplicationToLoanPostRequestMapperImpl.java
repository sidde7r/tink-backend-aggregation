...
import se.tink.backend.product.execution.unit.agents.seb.mortgage.model.EmploymentType;
import se.tink.backend.product.execution.unit.agents.seb.mortgage.model.KycEmploymentType;
import se.tink.backend.product.execution.unit.agents.seb.mortgage.model.LoanPostRequest;
import se.tink.backend.product.execution.unit.agents.seb.mortgage.model.OtherProperties;
...
public class ApplicationToLoanPostRequestMapperImpl implements ApplicationToLoanPostRequestMapper {
    private static final ProductExecutionLogger log = new ProductExecutionLogger(ApplicationToLoanPostRequestMapperImpl.class);

    @Inject
    public ApplicationToLoanPostRequestMapperImpl() {
    }
    ...
    private void populateProduct(LoanPostRequest request, ListMultimap<String, GenericApplicationFieldGroup> fieldGroupByName) {
        ...
        if (!product.isPresent()) {
            log.warn(ProductExecutionLogger
                    .newBuilder()
                    .withMessage("Product information is not supplied."));
            return;
        }
    ...
    private void populateApplicant(LoanPostRequest request, ListMultimap<String, GenericApplicationFieldGroup> fieldGroupByName) {
        ...
        if (!applicant.isPresent()) {
            log.warn(ProductExecutionLogger
                    .newBuilder()
                    .withMessage("Applicant information is not supplied."));
            return;
        }
    ...
    private void populateCoApplicant(LoanPostRequest request, ListMultimap<String, GenericApplicationFieldGroup> fieldGroupByName) {
        ...
        if (!coApplicant.isPresent()) {
            ...
            log.debug(ProductExecutionLogger
                    .newBuilder()
                    .withMessage("No co-applicant information supplied"));
            return;
        }
    ...
    private void populateHousehold(LoanPostRequest request, ListMultimap<String, GenericApplicationFieldGroup> fieldGroupByName) {
        ...
        if (!household.isPresent()) {
            log.warn(ProductExecutionLogger
                    .newBuilder()
                    .withMessage("Household information is not supplied."));
            return;
        }
    ...
    private void populateMortgage(LoanPostRequest request, ListMultimap<String, GenericApplicationFieldGroup> fieldGroupByName) {
        ...
        if (!mortgage.isPresent()) {
            ...
            log.warn(ProductExecutionLogger
                    .newBuilder()
                    .withMessage("Current mortgage information is not supplied."));
            return;
        }

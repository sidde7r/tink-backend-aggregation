...
public class GetSummaryCommandTest {
    ...
    public void testPropertyMapping() {
        ...
        GetSummaryCommand command = new GetSummaryCommand(applicationId.toString(), user, Optional.of(userAgent));
    ...
    public void testNoUser() {
        new GetSummaryCommand(UUID.randomUUID().toString(), null, Optional.of(userAgent));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testNoApplicationId() {
        new GetSummaryCommand(null, new User(), Optional.of(userAgent));
    }
}

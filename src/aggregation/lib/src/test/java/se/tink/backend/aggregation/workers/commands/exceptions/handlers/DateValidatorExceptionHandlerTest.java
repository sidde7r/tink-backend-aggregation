...
public class DateValidatorExceptionHandlerTest extends ExceptionHandlerBaseTest {

    @Before
    public void setUp() {
        handler = new DateValidationExceptionHandler();
        super.setUp();
    ...
    public void shouldMarkMetricCancelledAndCancelOperation() {
        // given
        DateValidationException exception =
                new DateValidationException(
                        "Message",
                        "Path",
                        InternalStatus.INTERNAL_TRANSFER_NOT_SUPPORTED,

...
public class PaymentAuthenticationExceptionHandlerTest extends ExceptionHandlerBaseTest {

    @Before
    public void setUp() {
        handler = new PaymentAuthenticationExceptionHandler();
        super.setUp();
    ...
    public void shouldMarkMetricCancelledAndCancelOperation() {
        ...
        PaymentAuthenticationException exception =
                new PaymentAuthenticationException(InternalStatus.INTERNAL_TRANSFER_NOT_SUPPORTED);

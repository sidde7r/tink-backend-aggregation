...
public class PaymentValidationExceptionHandlerTest extends ExceptionHandlerBaseTest {

    @Before
    public void setUp() {
        handler = new PaymentValidationExceptionHandler();
        super.setUp();
    ...
    public void shouldMarkMetricCancelledAndCancelOperation() {
        ...
        PaymentValidationException exception =
                new PaymentValidationException(InternalStatus.INVALID_DESTINATION_MESSAGE);

...
public class DebtorValidationExceptionHandlerTest extends ExceptionHandlerBaseTest {

    @Before
    public void setUp() {
        handler = new DebtorValidationExceptionHandler();
        super.setUp();
    ...
    public void shouldMarkMetricCancelledAndCancelOperation() {
        // given
        DebtorValidationException exception =

...
public class AuthenticationLoginExceptionHandlerTest {

    private AuthenticationLoginExceptionHandler objectUnderTest;
    ...
    public void whenExceptionIsAuthenticationShouldReturnAbortStatus() {
        ...
        Mockito.verify(agentLoginEventPublisherService).publishLoginAuthenticationErrorEvent(ex);
    }
}

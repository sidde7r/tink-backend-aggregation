...
public class CreditAgricoleUtilsTest {
    private static final String RANDOM_XML_TAG = "<?xml version=\"1.0\"?><tag>12345</tag><name>Tink</name><tag>67890</tag></utilisateurDTO>";
    ...
    public void shouldGetStringInTagsFromXMLResponse() {
        ...
        Assert.assertTrue(response.contains(EXPECTED_XML_VAL1) && response.contains(EXPECTED_XML_VAL2));
    }

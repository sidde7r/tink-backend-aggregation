...
public class ReferenceValidationExceptionHandlerTest extends ExceptionHandlerBaseTest {

    @Before
    public void setUp() {
        handler = new ReferenceValidationExceptionHandler();
        super.setUp();
    ...
    public void shouldMarkMetricCancelledAndCancelOperation() {
        ...
        ReferenceValidationException exception =
                new ReferenceValidationException(
                        "Message", InternalStatus.INVALID_DESTINATION_MESSAGE);

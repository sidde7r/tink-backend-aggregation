...
public class InsufficientFundsExceptionHandlerTest extends ExceptionHandlerBaseTest {

    @Before
    public void setUp() {
        handler = new InsufficientFundsExceptionHandler();
        super.setUp();
    ...
    public void shouldMarkMetricCanceledAndCancelOperation() {
        ...
        InsufficientFundsException exception =
                new InsufficientFundsException(
                        "Message", InternalStatus.BANK_CONNECTION_INTERRUPTED);
        ...
        Assertions.assertThat(signableOperation.getInternalStatus())
                .isEqualTo(InternalStatus.BANK_CONNECTION_INTERRUPTED.toString());

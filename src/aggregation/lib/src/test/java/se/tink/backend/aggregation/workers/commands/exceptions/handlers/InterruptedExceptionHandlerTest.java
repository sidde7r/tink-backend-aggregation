...
public class InterruptedExceptionHandlerTest extends ExceptionHandlerBaseTest {

    private InterruptedExceptionHandler handler;

    @Before
    public void setUp() {
        handler = new InterruptedExceptionHandler();
        super.setUp();

...
public class BankServiceLoginExceptionHandlerTest {

    private BankServiceLoginExceptionHandler objectUnderTest;
    ...
    @Test
    public void whenExceptionIsNotABankServiceShouldReturnEmptyResult() {
        // given
    ...
    @Test
    public void whenExceptionIsBankServiceShouldReturnAbortStatus() {
        // given
        BankServiceException ex = Mockito.mock(BankServiceException.class);
        // when
        Optional<AgentWorkerCommandResult> result = objectUnderTest.handle(ex, metricAction);
        // then
        ...
        Mockito.verify(agentLoginEventPublisherService).publishLoginBankServiceErrorEvent(ex);
    }
}

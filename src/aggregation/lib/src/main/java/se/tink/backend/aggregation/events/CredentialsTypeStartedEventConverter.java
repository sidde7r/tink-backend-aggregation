...
import se.tink.eventproducerservice.events.grpc.CredentialsRefreshCommandChainStartedProto.CredentialsRefreshCommandChainStarted.CredentialsTypes;

public class CredentialsTypeStartedEventConverter {
    private static final ImmutableMap<CredentialsType, CredentialsTypes> CREDENTIALS_TYPE_STARTED_EVENT_MAP =
    ...
    public static CredentialsTypes convert(CredentialsType type) {
        return CREDENTIALS_TYPE_STARTED_EVENT_MAP.getOrDefault(

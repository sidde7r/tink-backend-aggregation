...
public class RateLimitedExecutorService implements Managed {
    ...
    private static final ImmutableMap<String, Double> PROVIDERS_WITH_OVERRIDDEN_RATE_LIMITER =
            ImmutableMap.<String, Double>builder()
                    ...
                    .put("nxgen.uk.openbanking.barclays.BarclaycardV31Agent", 0.03)
                    .put("nxgen.uk.openbanking.barclays.BarclaycardV31BusinessAgent", 0.03)
                    .put("nxgen.uk.openbanking.barclays.BarclaysV31Agent", 0.03)
                    .put("nxgen.uk.openbanking.barclays.BarclaysV31BusinessAgent", 0.03)
                    .put("nxgen.uk.openbanking.barclays.BarclaysV31CorporateAgent", 0.03)
                    .put("nxgen.uk.openbanking.barclays.BarclaysV31WealthAgent", 0.03)

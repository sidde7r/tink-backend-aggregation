...
public class RateLimitedExecutorService implements Managed {
    ...
    private static final ImmutableMap<String, Double> PROVIDERS_WITH_OVERRIDDEN_RATE_LIMITER =
            ImmutableMap.<String, Double>builder()
                    ...
                    .put("nxgen.se.openbanking.handelsbanken.HandelsbankenSEAgent", 0.05)
                    ...
                    .put("nxgen.nl.creditcards.ICS.ICSAgent", 0.03)
                    .put("nxgen.nl.banks.openbanking.rabobank.RabobankAgent", 0.05)
                    .put("nxgen.nl.openbanking.knab.KnabAgent", 0.05)

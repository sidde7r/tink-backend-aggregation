...
public class RateLimitedExecutorService implements Managed {
    ...
    private static final ImmutableMap<String, Double> PROVIDERS_WITH_OVERRIDDEN_RATE_LIMITER =
            ImmutableMap.<String, Double>builder()
                    ...
                    .put("nxgen.se.openbanking.swedbank.SwedbankAgent", 0.01)
                    ...
                    .put("nxgen.se.openbanking.sebkort.circlek.CircleKMastercardSeAgent", 0.01)
                    ...
                    .put("nxgen.se.openbanking.sebkort.sas.SasEurobonusMastercardSeAgent", 0.01)
                    .put("nxgen.se.openbanking.sebkort.sj.SjPrioMastercardSeAgent", 0.01)
                    ...
                    .put("nxgen.uk.openbanking.barclays.BarclaycardV31Agent", 0.025)
                    .put("nxgen.uk.openbanking.barclays.BarclaycardV31BusinessAgent", 0.025)
                    .put("nxgen.uk.openbanking.barclays.BarclaysV31Agent", 0.025)
                    ...
                    .put("nxgen.uk.openbanking.firstdirect.FirstDirectV31Agent", 0.05)
                    .put("nxgen.uk.openbanking.halifax.HalifaxV31Agent", 0.05)
                    .put("nxgen.uk.openbanking.hsbc.HsbcV31BusinessAgent", 0.05)
                    .put("nxgen.uk.openbanking.hsbc.HsbcV31KineticAgent", 0.05)
                    .put("nxgen.uk.openbanking.handelsbanken.HandelsbankenCorporateAgent", 0.005)
                    .put("nxgen.uk.openbanking.lloyds.LloydsV31Agent", 0.05)
                    .put("nxgen.uk.openbanking.lloyds.LloydsV31BusinessAgent", 0.05)
                    .put("nxgen.uk.openbanking.lloyds.LloydsV31CorporateAgent", 0.05)
                    ...
                    .put("nxgen.pt.openbanking.atlanticoeuropa.AtlanticoEuropaAgent", 0.01)
                    .put("nxgen.pt.openbanking.bancobpi.BancoBpiAgent", 0.01)
                    .put("nxgen.pt.openbanking.bancoctt.BancoCttAgent", 0.01)
                    .put("nxgen.pt.openbanking.bancomontepio.BancoMontepioAgent", 0.01)
                    .put("nxgen.pt.openbanking.bankinter.BankinterAgent", 0.01)
                    .put("nxgen.pt.openbanking.big.BigAgent", 0.01)
                    .put("nxgen.pt.openbanking.bpg.BpgAgent", 0.01)
                    .put("nxgen.pt.openbanking.caixa.CaixaRedirectAgent", 0.01)
                    .put("nxgen.pt.openbanking.caixacrl.CaixaCrlAgent", 0.01)
                    .put("nxgen.pt.openbanking.cemah.CemahAgent", 0.01)
                    .put("nxgen.pt.openbanking.cofidis.CofidisAgent", 0.01)
                    .put("nxgen.pt.openbanking.creditoagricola.CreditoAgricolaAgent", 0.01)
                    .put("nxgen.pt.openbanking.eurobic.EurobicAgent", 0.01)
                    .put("nxgen.pt.openbanking.millenniumbcp.MillenniumBcpAgent", 0.01)
                    .put("nxgen.pt.openbanking.novobanco.NovoBancoAgent", 0.01)
                    .put("nxgen.pt.openbanking.novobancoacores.NovoBancoAcoresAgent", 0.01)
                    .put("nxgen.pt.openbanking.santander.SantanderAgent", 0.01)
                    .put("nxgen.pt.openbanking.unicre.UnicreAgent", 0.01)
                    .put("nxgen.fr.openbanking.bpcegroup.BpceGroupAgent", 0.04)
                    .put("nxgen.fr.openbanking.boursorama.BoursoramaAgent", 0.04)

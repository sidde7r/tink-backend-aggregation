...
public class RateLimitedExecutorService implements Managed {
    ...
    private static final ImmutableMap<String, Double> PROVIDERS_WITH_OVERRIDDEN_RATE_LIMITER =
            ImmutableMap.<String, Double>builder()
                    ...
                    .put("nxgen.serviceproviders.openbanking.sparebank.SparebankAgent", 0.0025)
                    ...
                    .put("nxgen.uk.openbanking.lloyds.LloydsV31Agent", 0.033)
                    .put("nxgen.uk.openbanking.lloyds.LloydsV31BusinessAgent", 0.033)
                    ...
                    .put("nxgen.fi.openbanking.handelsbanken.HandelsbankenAgent", 0.0025)

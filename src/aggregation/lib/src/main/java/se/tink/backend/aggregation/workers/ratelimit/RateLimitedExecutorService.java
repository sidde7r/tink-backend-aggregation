...
public class RateLimitedExecutorService implements Managed {
    ...
    private static final ImmutableMap<String, Double> PROVIDERS_WITH_OVERRIDDEN_RATE_LIMITER =
            ImmutableMap.<String, Double>builder()
                    ...
                    .put("nxgen.uk.openbanking.cashplus.CashplusAgent", 0.015)
                    .put("nxgen.uk.openbanking.handelsbanken.HandelsbankenCorporateAgent", 0.007)
                    .put("nxgen.uk.openbanking.lloyds.LloydsV31Agent", 0.04)
                    .put("nxgen.uk.openbanking.lloyds.LloydsV31BusinessAgent", 0.04)
                    .put("nxgen.uk.openbanking.nationwide.NationwideV31Agent", 0.07)
                    .put("nxgen.uk.openbanking.revolut.RevolutV31Agent", 0.04)

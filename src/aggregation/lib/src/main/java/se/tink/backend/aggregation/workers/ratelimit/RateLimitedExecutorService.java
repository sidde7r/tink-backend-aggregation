...
public class RateLimitedExecutorService implements Managed {
    ...
    private static final ImmutableMap<String, Double> PROVIDERS_WITH_OVERRIDDEN_RATE_LIMITER =
            ImmutableMap.<String, Double>builder()
                    .put("fraud.CreditSafeAgent", 0.2)
                    .put("abnamro.ics.IcsAgent", 16.)
                    .put("other.CSNAgent", 0.2)
                    .put("nxgen.dk.banks.danskebank.DanskeBankDKAgent", 0.02)
                    .put("nxgen.nl.openbanking.triodos.TriodosAgent", 0.04)
                    .put("nxgen.no.banks.danskebank.DanskeBankNOAgent", 0.02)
                    .put("nxgen.serviceproviders.openbanking.sparebank.SparebankAgent", 0.005)
                    .put("nxgen.se.openbanking.handelsbanken.HandelsbankenSEAgent", 0.04)
                    .put("nxgen.se.openbanking.nordea.NordeaSeAgent", 0.02)
                    .put("nxgen.se.banks.swedbank.fallback.SwedbankFallbackAgent.java", 0.1)
                    .put("nxgen.se.openbanking.swedbank.SwedbankAgent", 0.02)
                    .put("nxgen.se.openbanking.alandsbanken.AlandsbankenAgent", 0.06)
                    .put("nxgen.se.openbanking.business.danskebank.DanskebankBusinessAgent", 0.06)
                    .put("nxgen.se.openbanking.danskebank.DanskebankV31Agent", 0.06)
                    .put(
                            "nxgen.se.openbanking.business.handelsbanken.HandelsbankenSEBusinessAgent",
                            0.06)
                    .put("nxgen.se.openbanking.business.nordea.NordeaSeBusinessAgent", 0.06)
                    .put("nxgen.se.openbanking.business.seb.SebSEBusinessAgent", 0.06)
                    .put("nxgen.se.openbanking.entercard.coop.CoopMastercardAgent", 0.06)
                    .put("nxgen.se.openbanking.entercard.mervarde.MervardeMasterCardAgent", 0.06)
                    .put("nxgen.se.openbanking.entercard.moregolf.MoreGolfMastercardAgent", 0.06)
                    .put("nxgen.se.openbanking.entercard.remember.RememberMastercardAgent", 0.06)
                    .put("nxgen.se.openbanking.lansforsakringar.LansforsakringarAgent", 0.06)
                    .put("nxgen.se.openbanking.nordnet.NordnetAgent", 0.06)
                    .put("nxgen.se.openbanking.resursbank.ResursBankAgent", 0.06)
                    .put("nxgen.se.openbanking.sbab.SbabAgent", 0.06)
                    .put("nxgen.se.openbanking.sebkort.circlek.CircleKMastercardSeAgent", 0.02)
                    .put("nxgen.se.openbanking.sebkort.eurocard.EurocardSeAgent", 0.06)
                    .put("nxgen.se.openbanking.sebkort.finnair.FinnairMastercardSeAgent", 0.06)
                    .put("nxgen.se.openbanking.sebkort.ingo.IngoMastercardSeAgent", 0.06)
                    .put("nxgen.se.openbanking.sebkort.nk.NkNyckelnMastercardSeAgent", 0.06)
                    .put(
                    ...
                    .put(
                            ...
                            0.06)
                    .put("nxgen.se.openbanking.sebkort.saab.SaabMastercardSeAgent", 0.06)
                    .put("nxgen.se.openbanking.sebkort.sas.SasEurobonusMastercardSeAgent", 0.02)
                    .put("nxgen.se.openbanking.sebkort.sj.SjPrioMastercardSeAgent", 0.02)
                    .put("nxgen.se.openbanking.sebkort.wallet.WalletMastercardSeAgent", 0.06)
                    .put("nxgen.se.openbanking.sebopenbanking.SebAgent", 0.06)
                    .put("nxgen.se.openbanking.skandia.SkandiaAgent", 0.06)
                    .put("nxgen.se.openbanking.volvofinans.VolvoFinansAgent", 0.06)
                    .put("nxgen.se.openbanking.icabanken.IcaBankenAgent", 0.04)
                    .put("nxgen.nl.creditcards.ICS.ICSAgent", 0.01)
                    .put("nxgen.nl.banks.openbanking.rabobank.RabobankAgent", 0.01)
                    .put("nxgen.nl.openbanking.knab.KnabAgent", 0.04)
                    .put("nxgen.nl.openbanking.abnamro.AbnAmroAgent", 0.06)
                    .put("nxgen.nl.openbanking.ing.IngAgent", 0.06)
                    .put("nxgen.uk.creditcards.amex.v62.AmericanExpressV62UKAgent", 0.06)
                    .put("nxgen.uk.openbanking.barclays.BarclaycardV31Agent", 0.05)
                    .put("nxgen.uk.openbanking.barclays.BarclaycardV31BusinessAgent", 0.05)
                    .put("nxgen.uk.openbanking.barclays.BarclaysV31Agent", 0.05)
                    .put("nxgen.uk.openbanking.barclays.BarclaysV31BusinessAgent", 0.05)
                    .put("nxgen.uk.openbanking.barclays.BarclaysV31CorporateAgent", 0.05)
                    .put("nxgen.uk.openbanking.barclays.BarclaysV31WealthAgent", 0.05)
                    .put("nxgen.uk.openbanking.cashplus.CashplusAgent", 0.02)
                    .put("nxgen.uk.openbanking.handelsbanken.HandelsbankenCorporateAgent", 0.01)
                    .put("nxgen.uk.openbanking.lloyds.LloydsV31Agent", 0.066)
                    .put("nxgen.uk.openbanking.lloyds.LloydsV31BusinessAgent", 0.066)
                    .put("nxgen.uk.openbanking.nationwide.NationwideV31Agent", 0.1)
                    .put("nxgen.uk.openbanking.revolut.RevolutV31Agent", 0.066)
                    .put("nxgen.uk.openbanking.santander.SantanderV31Agent", 0.066)
                    ...
                    .put("nxgen.pt.openbanking.bancobpi.BancoBpiAgent", 0.02)
                    .put("nxgen.pt.openbanking.bancoctt.BancoCttAgent", 0.02)
                    .put("nxgen.pt.openbanking.bancomontepio.BancoMontepioAgent", 0.02)
                    .put("nxgen.pt.openbanking.bankinter.BankinterAgent", 0.02)
                    .put("nxgen.pt.openbanking.big.BigAgent", 0.02)
                    .put("nxgen.pt.openbanking.bpg.BpgAgent", 0.02)
                    .put("nxgen.pt.openbanking.caixa.CaixaRedirectAgent", 0.02)
                    .put("nxgen.pt.openbanking.caixacrl.CaixaCrlAgent", 0.02)
                    .put("nxgen.pt.openbanking.cemah.CemahAgent", 0.02)
                    .put("nxgen.pt.openbanking.cofidis.CofidisAgent", 0.02)
                    .put("nxgen.pt.openbanking.creditoagricola.CreditoAgricolaAgent", 0.02)
                    .put("nxgen.pt.openbanking.eurobic.EurobicAgent", 0.02)
                    .put("nxgen.pt.openbanking.millenniumbcp.MillenniumBcpAgent", 0.02)
                    .put("nxgen.pt.openbanking.novobanco.NovoBancoAgent", 0.02)
                    .put("nxgen.pt.openbanking.novobancoacores.NovoBancoAcoresAgent", 0.02)
                    .put("nxgen.pt.openbanking.santander.SantanderAgent", 0.02)
                    .put("nxgen.pt.openbanking.unicre.UnicreAgent", 0.02)
                    .put("nxgen.fr.openbanking.bpcegroup.BpceGroupAgent", 0.08)
                    .put("nxgen.fr.openbanking.boursorama.BoursoramaAgent", 0.08)
                    .put("nxgen.serviceproviders.openbanking.revolut.RevolutEEAAgent", 0.066)
                    .build();

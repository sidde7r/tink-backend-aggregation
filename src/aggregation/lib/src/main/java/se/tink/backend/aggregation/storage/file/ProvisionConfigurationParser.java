...
public class ProvisionConfigurationParser {
    // TODO: make this configurable from the
    // ./charts/tink-backend-aggregation/templates/aggregation-config.yaml
    // TODO: consider if all configuration should live in
    // ./charts/tink-backend-aggregation/values/aggregation-production.yaml
    private static final String PROVISION_CLIENT_CONFIGURATION_FILE =
            "data/provision/clients/config.yaml";

...
public class ForitsUtilsTest {
    ...
    public void calculateChallenge() {
        ...
        Assert.assertEquals("Challenge response", "06330390", s);
    }

    @Test
    public void calculateChallenge2() {
        String s =
                FortisUtils.calculateChallenge(
        ...
        Assert.assertEquals("Challenge response", "82720033", s);
    }

    @Test
    public void calculateChallenge3() {
        String s =
                FortisUtils.calculateChallenge(
        ...
        Assert.assertEquals("Challenge response", "18656806", s);
    }
}

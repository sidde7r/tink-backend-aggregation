...
public class AbnAmroCategories implements CategoryConfiguration {
    ...
    public static class Codes {
         ...
         * ABN AMRO
         *
         * EXPENSES_ENTERTAINMENT_VACATION has been replaced by EXPENSES_ENTERTAINMENT_ACCOMMODATION.
         * EXPENSES_SHOPPING_HOBBY and EXPENSES_ENTERTAINMENT_SPORT has been merged into EXPENSES_ENTERTAINMENT_HOBBY.
         * EXPENSES_WELLNESS_PHARMACY has been merged into EXPENSES_WELLNESS_HEALTHCARE.
         */
        public static final String EXPENSES_HOME_TAXES = "expenses:home.taxes";
        public static final String EXPENSES_ENTERTAINMENT_ACCOMMODATION = "expenses:entertainment.accommodation";
        public static final String EXPENSES_ENTERTAINMENT_LOTTERIES = "expenses:entertainment.lotteries";
        public static final String EXPENSES_WELLNESS_DAILYCARE = "expenses:wellness.dailycare";
    }
    ...
    @Override public String getShoppingHobbyCode() {
        return Codes.EXPENSES_ENTERTAINMENT_HOBBY;
    }

...
public class SebCategories implements CategoryConfiguration {
    ...
    public static class Codes {
        ...
        public static final String EXPENSES_HOUSE_COMMUNICATIONS = "expenses:house.communications";
        public static final String EXPENSES_HOUSE_EDUCATION = "expenses:house.education";
        public static final String EXPENSES_HOUSE_INCURENCES_FEES = "expenses:house.incurences-fees"; // Typo. Should be `expenses:home.insurances-fees`.
        public static final String EXPENSES_HOUSE_KIDS = "expenses:house.kids";
        public static final String EXPENSES_HOUSE_PETS = "expenses:house.pets";
        public static final String EXPENSES_HOUSE_SERVICES = "expenses:house.services";
        ...
        public static final String EXPENSES_PROVISIONS_GROCERIES = "expenses:provisions.groceries";
        public static final String EXPENSES_PROVISIONS_ALCOHOL_TOBACCO = "expenses:provisions.alcohol-tobacco";
        public static final String EXPENSES_PROVISIONS_OTHER = "expenses:provisions.other";
        ...
        public static final String EXPENSES_SHOPPING_FITMENT = "expenses:shopping.fitment";
        public static final String EXPENSES_SHOPPING_GARDEN = "expenses:shopping.garden";
        ...
        public static final String EXPENSES_SHOPPING_REPAIRS = "expenses:shopping.repairs";
        ...
        public static final String EXPENSES_ENTERTAINMENT_BOOKS = "expenses:entertainment.books";
        ...
        public static final String EXPENSES_UNCATEGORIZED = "expenses:uncategorized";
        public static final String EXPENSES_UNCATEGORIZED_OTHER = "expenses:uncategorized.other";
    ...
    public Set<String> getMerchantizeCodes() {
        return Sets.newHashSet(Codes.EXPENSES_FOOD_RESTAURANTS, Codes.EXPENSES_PROVISIONS_GROCERIES, Codes.EXPENSES_FOOD_COFFEE,
                Codes.EXPENSES_FOOD_BARS, Codes.EXPENSES_PROVISIONS_ALCOHOL_TOBACCO, Codes.EXPENSES_SHOPPING_CLOTHES,
                Codes.EXPENSES_SHOPPING_ELECTRONICS, Codes.EXPENSES_ENTERTAINMENT_HOBBY);
    }

    @Override
    public Set<String> getUnusualActivityExcludedCodes() {
        return Sets.newHashSet(Codes.EXPENSES_UNCATEGORIZED_OTHER, Codes.EXPENSES_MISC_OTHER, Codes.EXPENSES_MISC_OUTLAYS);
    }
    ...
    public Set<String> getSuggestExpensesFollowCodes() {
        return Sets.newHashSet(Codes.EXPENSES_PROVISIONS_GROCERIES, Codes.EXPENSES_PROVISIONS_ALCOHOL_TOBACCO, Codes.EXPENSES_FOOD_COFFEE, Codes.EXPENSES_FOOD_RESTAURANTS, Codes.EXPENSES_TRANSPORT_TAXI, Codes.EXPENSES_SHOPPING_CLOTHES);
    }
    ...
    public String getExpenseUnknownCode() {
        return Codes.EXPENSES_UNCATEGORIZED_OTHER;
    }
    ...
    @Override public String getServicesCode() {
        return Codes.EXPENSES_HOUSE_SERVICES;
    }
    ...
    @Override public String getGroceriesCode() {
        return Codes.EXPENSES_PROVISIONS_GROCERIES;
    }
    ...
    @Override public String getAlcoholTobaccoCode() {
        return Codes.EXPENSES_PROVISIONS_ALCOHOL_TOBACCO;
    }

 ...
 */
public class KirkbyConnectorServiceIntegrationTest extends ServiceIntegrationTest {

    private static final String CONFIG_FILE_PATH = "etc/kirkby/development-connector-server.yml";
    ...
    public static void beforeClassSetup() throws Exception {
        ...
        injector = Guice.createInjector(
                Modules.override(
                        ConnectorModulesFactory.build(configuration, Mockito.mock(JerseyEnvironment.class)))
                        .with(new MockModule()));
    }
}

...
import se.tink.backend.aggregation.provider.configuration.controller.ProviderServiceController;
import se.tink.backend.aggregation.provider.configuration.resource.ProviderServiceResource;

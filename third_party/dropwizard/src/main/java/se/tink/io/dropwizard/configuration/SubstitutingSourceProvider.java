package se.tink.io.dropwizard.configuration;
...
import se.tink.io.dropwizard.util.ByteStreams;
...
public class SubstitutingSourceProvider implements ConfigurationSourceProvider {
     ...
     * @param substitutor The custom {@link org.apache.commons.text.StringSubstitutor}
     *     implementation.
     */
    public SubstitutingSourceProvider(
            ConfigurationSourceProvider delegate, StringSubstitutor substitutor) {

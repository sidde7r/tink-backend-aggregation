...
public class SimpleTypeIonUnmarshallersTest {
    ...
    public void unmarshalDouble() throws Exception {
        assertEquals(
                new Double(123.456),
                DoubleIonUnmarshaller.getInstance().unmarshall(context("123.456")));
    }
    ...
    public void unmarshalInteger() throws Exception {
        assertEquals(
                new Integer(-999),
                IntegerIonUnmarshaller.getInstance().unmarshall(context("-999")));
    }
    ...
    public void unmarshalBigInteger() throws Exception {
        assertEquals(
                ...
                BigIntegerIonUnmarshaller.getInstance()
                        .unmarshall(context("123456789012345678901234567890")));
    }
    ...
    public void unmarshalBigDecimal() throws Exception {
        assertEquals(
                ...
                BigDecimalIonUnmarshaller.getInstance()
                        .unmarshall(context("1234567890.12345678901234567890")));
    }

    @Test
    public void unmarshalBoolean() throws Exception {
        assertEquals(
                Boolean.TRUE, BooleanIonUnmarshaller.getInstance().unmarshall(context("true")));
    }
    ...
    public void unmarshalFloat() throws Exception {
        assertEquals(
                new Float(123.456f),
                FloatIonUnmarshaller.getInstance().unmarshall(context("123.456")));
    }

    @Test
    public void unmarshalLong() throws Exception {
        assertEquals(
                new Long(123456L), LongIonUnmarshaller.getInstance().unmarshall(context("123456")));
    }

    @Test
    public void unmarshalByte() throws Exception {
        assertEquals(
                new Byte((byte) 123), ByteIonUnmarshaller.getInstance().unmarshall(context("123")));
    }
    ...
    public void unmarshalDate() throws Exception {
        ...
        assertEquals(
                calendar.getTime(),
                DateIonUnmarshaller.getInstance().unmarshall(context("2000-01-01T")));
    }
    ...
    public void unmarshalByteBuffer() throws Exception {
        ...
        assertEquals(
                ...
                ByteBufferIonUnmarshaller.getInstance().unmarshall(context("{{AQIDBAUG}}")));
    }
    ...
    public void unmarshalShort() throws Exception {
        assertEquals(
                ...
                ShortIonUnmarshaller.getInstance().unmarshall(context("1234")));
    }

    private static JsonUnmarshallerContext context(String ion) throws Exception {
        JsonParser parser =
                new IonFactory(IonSystemBuilder.standard().build())
                        .createParser(new StringInputStream(ion));

 ...
 * This can be useful for generating unit test cases.
 */
public class IndexValues implements Iterable<int[]> {
    private final int[] lengths;

    /**
     * Constructs an {@link Iterable} for all possible combination of array index values given the
     * array lengths. This can be useful for generating unit test cases.
     *
    ...
    private static class Iter implements Iterator<int[]> {
        private final int[] lengths;
        /**
         * Contains the next combination of array index values to be returned; null if the iterator
         * has exhausted all possible index values.
         */
        private int[] curr;
        ...
        /**
         * Returns the next combination of array index values, or null if the index value space has
         * been exhausted.
         */
        @Override
        public int[] next() {

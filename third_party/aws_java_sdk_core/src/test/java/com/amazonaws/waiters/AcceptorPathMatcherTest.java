...
public class AcceptorPathMatcherTest {
    ...
    public void pathMatcher_NullFinalResult() throws Exception {
        ...
        Assert.assertFalse(
                "Expected result not equals final result",
                new AcceptorPathMatcher().path(expectedResult, NullNode.getInstance()));
    }
    ...
    public void pathMatcher_ValidFinalResult() throws Exception {
        ...
        Assert.assertTrue(
                "Expected result not equals final result",
                new AcceptorPathMatcher().path(expectedResult, mapper.readTree("\"ACTIVE\"")));
    }
    ...
    public void pathMatcher_BooleanFinalResult() throws Exception {
        ...
        Assert.assertTrue(
                "Expected result not equals final result",
                new AcceptorPathMatcher().path(expectedResultBoolean, BooleanNode.TRUE));
    }
        ...
        Assert.assertFalse(
                ...
                new AcceptorPathMatcher()
                        .pathAll(
                                expectedResult,
                                mapper.readTree(
                                        "[\"running\", \"terminated\", \"running\", \"running\"]")));
    }
    ...
    public void pathAnyMatcherFinalResultEmptyArray() throws Exception {
        ...
        Assert.assertFalse(
                "Expected result not equals final result",
                new AcceptorPathMatcher().pathAny(expectedResult, mapper.readTree("[]")));
    }
    ...
    public void pathAnyMatcherNullFinalResult() throws Exception {
        ...
        Assert.assertFalse(
                "Expected result not equals final result",
                new AcceptorPathMatcher().pathAny(expectedResult, NullNode.getInstance()));
    }
}

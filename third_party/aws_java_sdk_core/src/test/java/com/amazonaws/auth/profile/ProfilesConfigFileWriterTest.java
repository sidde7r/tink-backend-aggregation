...
public class ProfilesConfigFileWriterTest {
    ...
    /**
     * Tests that the original credentials file is properly restored if the in-place modification
     * fails with error.
     */
    @Test
    public void testInPlaceModificationErrorHandling() throws IOException {
        ...
        // Insert [e] profile, which throws RuntimeException when the getProperties method is
        // called.
    ...
    /**
     * Loads the given credentials file and checks that it contains the same set of profiles as
     * expected.
     */

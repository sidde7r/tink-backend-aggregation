...
public class AWS4UnsignedPayloadRequest {
    ...
    private static final AWS4UnsignedPayloadSigner UNSIGNED_PAYLOAD_SIGNER =
            new AWS4UnsignedPayloadSigner(new SdkClock.MockClock(SIGNING_DATE));
    ...
    public void doesNotComputeContentHash_HTTPS() throws UnsupportedEncodingException {
        ...
        assertThat(
                request1.getHeaders().get("Authorization"),
                is(equalTo(request2.getHeaders().get("Authorization"))));
    }
    ...
    public void computesContentHash_HTTP() throws UnsupportedEncodingException {
        ...
        assertThat(
                request.getHeaders().get(X_AMZ_CONTENT_SHA256),
    ...
    public void setsContentSha256Header() throws UnsupportedEncodingException {
        ...
        UNSIGNED_PAYLOAD_SIGNER.sign(request1, CREDENTIALS);
        assertThat(
                request1.getHeaders().get(X_AMZ_CONTENT_SHA256), is(equalTo("UNSIGNED-PAYLOAD")));
    }
}

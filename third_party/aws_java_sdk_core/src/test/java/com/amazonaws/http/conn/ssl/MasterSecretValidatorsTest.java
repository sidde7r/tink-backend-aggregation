...
public class MasterSecretValidatorsTest {
    ...
    @Test
    public void java6() {
        assertMasterSecretValidatorImplForJavaVersion(
                PrivilegedMasterSecretValidator.class, jv(1, 6, 0, 90));
        assertMasterSecretValidatorImplForJavaVersion(
                NoOpMasterSecretValidator.class, jv(1, 6, 0, 91));
        assertMasterSecretValidatorImplForJavaVersion(
                NoOpMasterSecretValidator.class, jv(1, 6, 0, 92));
    }

    @Test
    public void java7() {
        assertMasterSecretValidatorImplForJavaVersion(
                PrivilegedMasterSecretValidator.class, jv(1, 7, 0, 50));
        assertMasterSecretValidatorImplForJavaVersion(
                NoOpMasterSecretValidator.class, jv(1, 7, 0, 51));
        assertMasterSecretValidatorImplForJavaVersion(
                NoOpMasterSecretValidator.class, jv(1, 7, 0, 52));
    }

    @Test
    public void java8() {
        assertMasterSecretValidatorImplForJavaVersion(
                PrivilegedMasterSecretValidator.class, jv(1, 8, 0, 30));
        assertMasterSecretValidatorImplForJavaVersion(
                NoOpMasterSecretValidator.class, jv(1, 8, 0, 31));
        assertMasterSecretValidatorImplForJavaVersion(
                NoOpMasterSecretValidator.class, jv(1, 8, 0, 32));
    }

    @Test
    public void java9() {
        assertMasterSecretValidatorImplForJavaVersion(
                NoOpMasterSecretValidator.class, jv(1, 9, 0, 0));
    }

    @Test
    public void unknownJavaVersion() {
        assertMasterSecretValidatorImplForJavaVersion(
                NoOpMasterSecretValidator.class, jv(1, 5, 0, 0));
    }
     ...
     * JavaVersion
     *
     * @param masterSecretValidatorImpl Expected implementation of {@link MasterSecretValidator}
    ...
    private static void assertMasterSecretValidatorImplForJavaVersion(
        ...
        assertThat(
                MasterSecretValidators.getMasterSecretValidator(javaVersion),
                instanceOf(masterSecretValidatorImpl));
    }

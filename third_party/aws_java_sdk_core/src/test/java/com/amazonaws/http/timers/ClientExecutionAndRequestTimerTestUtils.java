...
public class ClientExecutionAndRequestTimerTestUtils {
     ...
     */
    public static void assertClientExecutionTimerExecutorNotCreated(
     ...
     *
     * @param responseProxy Must by a spied {@link HttpResponseProxy}
     */
    ...
    public static void assertNumberOfTasksTriggered(
            ClientExecutionTimer clientExecutionTimer, int expectedNumberOfTasks) {
        assertNumberOfTasksTriggered(clientExecutionTimer.getExecutor(), expectedNumberOfTasks);
    }

    public static void assertNumberOfTasksTriggered(
            HttpRequestTimer requestTimer, int expectedNumberOfTasks) {
        assertNumberOfTasksTriggered(requestTimer.getExecutor(), expectedNumberOfTasks);
    }

    private static void assertNumberOfTasksTriggered(
            ScheduledThreadPoolExecutor timerExecutor, int expectedNumberOfTasks) {
        waitBeforeAssertOnExecutor();
     ...
     *
     * @param config {@link ClientConfiguration} for {@link HttpClientFactory}
     * @return Real implementation of {@link HttpClient} with ability to verify method calls or
     *     partially mock
     */
    public static ConnectionManagerAwareHttpClient createRawHttpClientSpy(
    ...
    public static void assertNumberOfRetries(HttpClient spyClient, int expectedNumberOfRequests) {
        try {
            verify(spyClient, times(expectedNumberOfRequests))

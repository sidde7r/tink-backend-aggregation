...
/**
 * Client request options such as client markers for individual {@link AmazonWebServiceRequest}s.
 */
@NotThreadSafe
public final class RequestClientOptions {
    /**
     * Used to enable mark-and-reset for non-mark-and-resettable non-file input stream for up to
     * 128K memory buffering by default. Add 1 to get around an implementation quirk of
     * BufferedInputStream.
     *
     * <p>Retries after reading {@link #DEFAULT_STREAM_BUFFER_SIZE} bytes would fail to reset the
    ...
    public static enum Marker {
        /**
         * Used to specify the http user_agent value. This marker is intended only for internal use
         * by the AWS SDK.
         */
        USER_AGENT,
        ;
    ...
    /**
     * Associates the given value with the given marker. Note the {@link Marker#USER_AGENT} is only
     * intended for internal use by the AWS SDK.
     */
    ...
    /**
     * Appends a user agent to the USER_AGENT client marker. This method is intended only for
     * internal use by the AWS SDK.
     */
    ...
    /**
     * Returns the mark-and-reset read limit; defaults to {@value #DEFAULT_STREAM_BUFFER_SIZE}.
     *
    ...
    /**
     * Copy the internal states of this <code>RequestClientOptions</code> to the target <code>
     * RequestClientOptions</code>.
     */

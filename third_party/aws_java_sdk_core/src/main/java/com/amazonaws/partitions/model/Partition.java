...
public class Partition {
    ...
    public Partition(
            @JsonProperty(value = "partition") String partition,
            @JsonProperty(value = "regions") Map<String, Region> regions,
            @JsonProperty(value = "services") Map<String, Service> services) {
    ...
    /**
     * Returns true if the region is explicitly configured in the partition or if the region matches
     * the {@link #regionRegex} of the partition.
     */
    public boolean hasRegion(String region) {
        return regions.containsKey(region)
                || matchesRegionRegex(region)
    ...
    /**
     * returns true if any of the services in the partition has a custom endpoint like s3 having
     * s3-external-1. TODO Remove this support as part of next major version. @Deprecated use the
     * {@link com.amazonaws.AmazonWebServiceClient#setEndpoint(String)} method for custom endpoints.
     */
    @Deprecated

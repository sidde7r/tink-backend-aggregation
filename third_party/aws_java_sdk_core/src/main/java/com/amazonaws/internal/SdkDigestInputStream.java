...
public class SdkDigestInputStream extends DigestInputStream implements MetricAware, Releasable {
    ...
    /**
     * Skips over and discards <code>n</code> bytes of data from this input stream, while taking the
     * skipped bytes into account for digest calculation. The <code>skip</code> method may, for a
     * variety of reasons, end up skipping over some smaller number of bytes, possibly <code>0
     * </code>. This may result from any of a number of conditions; reaching end of file before
     * <code>n</code> bytes have been skipped is only one possibility. The actual number of bytes
     * skipped is returned. If <code>n</code> is negative, no bytes are skipped.
     *

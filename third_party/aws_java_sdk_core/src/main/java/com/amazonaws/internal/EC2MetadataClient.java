...
public class EC2MetadataClient {
    ...
    /**
     * Connects to the Amazon EC2 Instance Metadata Service to retrieve the default credential
     * information (if any).
     *
     * @return The response from the Amazon EC2 Instance Metadata Service, or null if no credential
     *     information was available.
     * @throws IOException If any problems are encountered while connecting to the Amazon EC2
     ...
     * @return The text payload returned from the Amazon EC2 Instance Metadata service for the
     *     specified resource path.
     * @throws IOException If any problems were encountered while connecting to metadata service for
     *     the requested resource path.
     * @throws SdkClientException If the requested metadata service is not found.
     */
    ...
    /**
     * Reads a response from the Amazon EC2 Instance Metadata Service and returns the content as a
     * string.
     *
     * @param connection The connection to the Amazon EC2 Instance Metadata Service.
     * @return The content contained in the response from the Amazon EC2 Instance Metadata Service.
     * @throws IOException If any problems ocurred while reading the response.
     */
     ...
     *
     * @param resourcePath The resource portion of the URL.
     * @return A URL to the EC2 metadata service for the specified resource path.
     * @throws IOException If a valid URL could not be constructed.
     */

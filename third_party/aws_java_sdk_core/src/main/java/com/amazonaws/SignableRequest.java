...
/**
 * Represents a sign-able request being sent to an Amazon Web Service, including the parameters
 * being sent as part of the request, the endpoint to which the request should be sent, etc.
 *
...
public interface SignableRequest<T> extends ImmutableRequest<T> {
    ...
    /**
     * Sets the optional stream containing the payload data to include for this request. This is
     * used, for example, for S3 chunk encoding.
     *

...
public enum Classes {
     ...
     * instance; or null if such immediate subclass cannot be uniquely identified for the given
     * object instance.
     *
     * @param parentClass the parent class. The child class is {@link Object} if and only if the
     *     parent class is null.
    ...
    /**
     * Returns the jar file from which the given class is loaded; or null if no such jar file can be
     * located.
     */

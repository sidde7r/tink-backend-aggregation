...
/**
 * Used to perform length check to ensure the number of bytes read from the underlying input stream
 * is the same as the expected total.
 */
@NotThreadSafe
public class LengthCheckInputStream extends SdkFilterInputStream {
     ...
     *     false otherwise. Typically, this parameter should be set to false for uploading data to
     *     AWS, but set to true for receiving data from AWS.
     */
    public LengthCheckInputStream(InputStream in, long expectedLength, boolean includeSkipped) {
        super(in);
        if (expectedLength < 0) throw new IllegalArgumentException();
     ...
     * {@inheritDoc}
     *
     * @throws SdkClientException if the data length read has exceeded the expected total, or if the
     *     total data length is not the same as the expected total.
     */
    @Override
    ...
    private String diagnosticInfo() {
        return new StringBuilder()
                ...
                .append("; in.getClass()=")
                .append(in.getClass())
                .append("; markedSupported=")
                .append(markSupported())
                .append("; marked=")
                .append(marked)
                .append("; resetSinceLastMarked=")
                .append(resetSinceLastMarked)
                .append("; markCount=")
                .append(markCount)
                .append("; resetCount=")
     ...
     * {@inheritDoc}
     *
     * @throws SdkClientException if {@link #includeSkipped} is true and the data length skipped has

 ...
 *
 * <p>Under certain conditions (redirects), both response and exception may be null
 */
public final class HandlerAfterAttemptContext {
    ...
    private HandlerAfterAttemptContext(
    ...
    /**
     * @return the exception that was generated while processing the request, or null if the attempt
     *     succeeded
     */
    ...
    public static class HandlerAfterAttemptContextBuilder {
        ...
        /**
         * Fluent set for what the request should be on the eventual HandlerAfterAttemptContext
         * instance
         *
        ...
        /**
         * Fluent set for what the response should be on the eventual HandlerAfterAttemptContext
         * instance
         *
        ...
        /**
         * Fluent set for what the exception should be on the eventual HandlerAfterAttemptContext
         * instance
         *
         * @param exception exception generated by the request attempt, or null if the attempt was
         *     succcessful
         * @return the modified builder
         */

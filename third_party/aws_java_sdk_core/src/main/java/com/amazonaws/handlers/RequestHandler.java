 ...
 *     <p>Interface for addition request handling in clients. A request handler is executed on a
 *     request object <b>before</b> it is sent to the client runtime to be executed.
 */
@Deprecated

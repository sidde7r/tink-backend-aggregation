...
/**
 * Unmarshalls an AWS error response into an AmazonServiceException, or optionally, a subclass of
 * AmazonServiceException if this class is extended.
 */
@SdkProtectedApi
public class LegacyErrorUnmarshaller implements Unmarshaller<AmazonServiceException, Node> {
    ...
    /**
     * Constructs a new unmarshaller that will unmarshall AWS error responses as a generic
     ...
     * instantiating when populating the exception object with data from the AWS error response.
     *
     * @param exceptionClass The class of AmazonServiceException to create and populate when
     *     unmarshalling the AWS error response.
     */

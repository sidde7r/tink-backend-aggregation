...
public class PathMarshallers {
    ...
    /**
     * Marshaller for non greedy path labels. Value is URL encoded and then replaced in the request
     * URI.
     */
    ...
    /**
     * Marshaller for members marked with the idempotency trait. If the path value is null, a value
     * will be auto generated by the SDK.
     */
    ...
    private static class NonGreedyPathMarshaller implements PathMarshaller {
        ...
        public String marshall(String resourcePath, String paramName, String pathValue) {
            ...
            return resourcePath.replace(
                    String.format("{%s}", paramName), SdkHttpUtils.urlEncode(pathValue, false));
        }
    ...
    private static class GreedyPathMarshaller implements PathMarshaller {
        ...
        public String marshall(String resourcePath, String paramName, String pathValue) {
            assertStringNotEmpty(pathValue, paramName);
            return resourcePath.replace(
                    String.format("{%s+}", paramName), trimLeadingSlash(pathValue));
        }
        ...
        public String marshall(String resourcePath, String paramName, String pathValue) {
            if (pathValue != null && pathValue.isEmpty()) {
                throw new IllegalArgumentException(
                        paramName
                                + " must not be empty. If not set a value will be auto generated");
            }
            return resourcePath.replace(

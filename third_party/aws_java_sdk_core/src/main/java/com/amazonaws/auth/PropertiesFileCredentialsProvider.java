 ...
 * properties file provided on initialization.
 *
...
public class PropertiesFileCredentialsProvider implements AWSCredentialsProvider {
    ...
    /**
     * Creates a new PropertiesFileCredentialsProvider that will attempt to load a custom file from
     * the path specified to read AWS security credentials.
     *
     ...
     *     <p>For example,
     *     <ul>
     *       <li>/etc/somewhere/credentials.properties
     *     </ul>
     */
    ...
    public AWSCredentials getCredentials() {
        try {
            ...
            throw new SdkClientException(
                    "Unable to load AWS credentials from the " + credentialsFilePath + " file", e);
        }
    }

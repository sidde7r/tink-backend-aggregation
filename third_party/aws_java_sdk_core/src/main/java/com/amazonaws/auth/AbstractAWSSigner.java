...
/**
 * Abstract base class for AWS signing protocol implementations. Provides utilities commonly needed
 * by signing protocols such as computing canonicalized host names, query string parameters, etc.
 *
 * <p>Not intended to be sub-classed by developers.
 */
public abstract class AbstractAWSSigner implements Signer {
    ...
    protected String getCanonicalizedQueryString(Map<String, List<String>> parameters) {
        ...
        /**
         * Signing protocol expects the param values also to be sorted after url encoding in
         * addition to sorted parameter names.
         */
    ...
    /**
     * Returns the request's payload contents as a String, without processing any query string
     * params (i.e. no form encoding for query params).
     *
     * @param request The request
     * @return the request's payload contents as a String, not including any form encoding of query
     *     string params.
     */
    ...
    /**
     * Returns the request's payload contents as binary data, without processing any query string
     * params (i.e. no form encoding for query params).
     *
     * @param request The request
     * @return The request's payload contents as binary data, not including any form encoding of
     *     query string params.
     */
     ...
     *
     * <p>Returns either a {@link BasicSessionCredentials} or a {@link BasicAWSCredentials} object,
    ...
    /**
     * Returns the current time minus the given offset in seconds. The intent is to adjust the
     * current time in the running JVM to the corresponding wall clock time at AWS for request
     * signing purposes.
     *
     ...
     */
    protected abstract void addSessionCredentials(

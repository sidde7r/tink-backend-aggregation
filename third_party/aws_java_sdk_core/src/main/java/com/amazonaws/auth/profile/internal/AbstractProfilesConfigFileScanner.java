...
/**
 * An abstract template class for the generic operation that involves scanning through a profile
 * configuration file. Subclass should implement the abstract methods to define the actions when
 * different components of the profiles file are detected.
 */
public abstract class AbstractProfilesConfigFileScanner {
    ...
    /**
     * Action to be performed when the scanner reaches the end of a profile section. This method is
     * invoked either at the start of a new profile section, or at the end of the file.
     */
     ...
     *
     * @param profileName The name of the profile where this property is declared.
     * @param propertyName The name of the property.
     * @param propertyValue The value of the property.
     * @param isSupportedProperty Whether this is a supported property according to the
     *     specification of credential profiles file.
     * @param line The original line of text where the property is declared.
     */
    protected abstract void onProfileProperty(
            String profileName,
            String propertyName,
     ...
     *
     * @param scanner The scanner for the credentials file input.
     */
    ...
    /**
     * Returns the profile name if this line indicates the beginning of a new profile section.

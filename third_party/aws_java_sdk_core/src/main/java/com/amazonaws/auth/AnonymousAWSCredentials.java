 ...
 * Using anonymous credentials will result in requests not being signed before sending to the
 * service. Any service that does not accept unsigned requests will return a service exception in
 * this case.
 */

 ...
 * <b>strongly</b> recommended to explicitly call {@link #close()} to release the async thread.
 */
public class InstanceProfileCredentialsProvider implements AWSCredentialsProvider, Closeable {
    ...
    /**
     * The default InstanceProfileCredentialsProvider that can be shared by multiple
     ...
     *     - ensures that {@link EC2CredentialsFetcher#getCredentials()} is only hit when this
     *     CredentialProvider is actually required
     */
    public static InstanceProfileCredentialsProvider createAsyncRefreshingProvider(
    ...
    private InstanceProfileCredentialsProvider(
        ...
        credentialsFetcher =
                new EC2CredentialsFetcher(new InstanceMetadataCredentialsEndpointProvider());
    ...
    /**
     * Returns a singleton {@link InstanceProfileCredentialsProvider} that does not refresh
     * credentials asynchronously.
     *
     * <p>See {@link #InstanceProfileCredentialsProvider(boolean)} or {@link

...
public class RoleInfo implements Cloneable {
     ...
     *
     * <p>Use the role session name to uniquely identify a session when the same role is assumed by
     ...
     * name is also used in the ARN of the assumed role principal. This means that subsequent
     ...
     * to ensure the role's trust policy checks for the external ID that the third party generated.
     * Each time the third party assumes the role, they should pass the customer's external ID. The
     * external ID is useful in order to help third parties bind a role to the customer who created
     * it. For more information about the external ID, see <a href=
     * "http://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-user_externalid.html"
     * >How to Use an External ID When Granting Access to Your AWS Resources to a Third Party</a> in
     * the <i>Using IAM</i>.
     */
    ...
    /**
     * Default constructor for RoleInfo object. Callers should use the setter or fluent setter
     ...
     *     subsequent cross-account API requests using the temporary security credentials will
     ...
     * the <i>Using IAM</i>.
     *
     * @param externalId A unique identifier that is used by third parties when assuming roles in
     *     their customers' accounts. For each role that the third party can assume, they should
     *     instruct their customers to ensure the role's trust policy checks for the external ID
     *     that the third party generated. Each time the third party assumes the role, they should
     *     pass the customer's external ID. The external ID is useful in order to help third parties
     *     bind a role to the customer who created it. For more information about the external ID,
     *     see <a href=
     *     "http://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-user_externalid.html"
     *     >How to Use an External ID When Granting Access to Your AWS Resources to a Third
     *     Party</a> in the <i>Using IAM</i>.
     */
     ...
     * the <i>Using IAM</i>.
     *
     * @return A unique identifier that is used by third parties when assuming roles in their
     *     customers' accounts. For each role that the third party can assume, they should instruct
     *     their customers to ensure the role's trust policy checks for the external ID that the
     *     third party generated. Each time the third party assumes the role, they should pass the
     *     customer's external ID. The external ID is useful in order to help third parties bind a
     *     role to the customer who created it. For more information about the external ID, see <a
     *     href=
     *     "http://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_create_for-user_externalid.html"
     *     >How to Use an External ID When Granting Access to Your AWS Resources to a Third
     *     Party</a> in the <i>Using IAM</i>.
     ...
     */
    public void setLongLivedCredentialsProvider(
     ...
     * @return Returns a reference to this object so that method calls can be chained together.
     */
    public RoleInfo withLongLivedCredentialsProvider(
            AWSCredentialsProvider longLivedCredentialsProvider) {
    ...
    public boolean equals(Object obj) {
        ...
        if (other.getExternalId() != null
                && other.getExternalId().equals(this.getExternalId()) == false) return false;
    ...
    public int hashCode() {
        ...
        hashCode =
                prime * hashCode
                        + ((getLongLivedCredentialsProvider() == null)
                                ? 0
                                : getLongLivedCredentialsProvider().hashCode());
        return hashCode;
    }

...
public enum ProgressEventType {
    ...
    //////////////////////////////////////////////////////////////////////////
    /**
     * A general byte transfer event that happens during sending a request or reading a response.
     */
    @Deprecated
    BYTE_TRANSFER_EVENT,
    ...
    /**
     * Event indicating that the client has started sending the AWS API request. This type of event
     * is guaranteed to be only fired once during a request-response cycle, even when the request is
     * retried.
     */
    CLIENT_REQUEST_STARTED_EVENT,

    /**
     * Event indicating that the client has started sending the HTTP request. The request progress
     * listener will be notified of multiple instances of this type of event if the request gets
     * retried.
     */
    HTTP_REQUEST_STARTED_EVENT,

    /**
     * Event indicating that the client has finished sending the HTTP request. The request progress
     * listener will be notified of multiple instances of this type of event if the request gets
     * retried.
     */
    ...
    /**
     * Event indicating that the HTTP request content is reset, which may or may not be caused by
     * the retry of the request.
     */
    HTTP_REQUEST_CONTENT_RESET_EVENT,

    /**
     * Event indicating that a failed request is detected as retryable and is ready for the next
     * retry.
     */
    CLIENT_REQUEST_RETRY_EVENT,

    /**
     * Event indicating that the client has started reading the HTTP response. The request progress
     * listener will be notified of this event only if the client receives a successful service
     * response (i.e. 2XX status code).
     */
    HTTP_RESPONSE_STARTED_EVENT,

    /**
     * Event indicating that the client has finished reading the HTTP response. The request progress
     * listener will be notified of this event only if the client receives a successful service
     * response (i.e. 2XX status code).
     */
    ...
    /**
     * Event indicating that the client has received a successful service response and has finished
    ...
    /**
     * Returns true if this event type is a transfer event, which may involve multiple request cycle
     * events.
     *
    ...
    /**
     * Returns true if this event type is related to the execution of a single http request-response
     * to AWS; false otherwise.
     */

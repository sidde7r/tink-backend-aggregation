 ...
 * part of the request, the endpoint to which the request should be sent, etc. Members of this class
 * should be considered read-only and not mutated
 *
...
public interface ImmutableRequest<T> {
    ...
    /**
     * Returns the service endpoint (ex: "https://ec2.amazonaws.com") to which this request should
     * be sent.
     *
    ...
    /**
     * Returns the optional value for time offset for this request. This will be used by the signer
     * to adjust for potential clock skew. Value is in seconds, positive values imply the current
     * clock is "fast", negative values imply clock is slow.
     *
    ...
    /**
     * Returns the optional raw stream containing the payload data to include for this request, with
     * all progress stream wrappers. Not all requests contain payload data.
     *
     * @return The optional raw stream containing the payload data to include for this request, with
     *     all progress stream wrappers removed.
     */

...
public class ClientConfiguration {
    ...
    /**
     * The default time a connection can be idle in the connection pool before it must be validated
     ...
     *
     * <p>The default configuration is to use {@link Protocol#HTTP}.
     */
    ...
    /**
     * Controls whether {@link java.net.Socket}s created by the client should use the default {@link
     * java.net.ProxySelector} when connecting to the remote host to find an appropriate proxy or
     * connect directly to the host.
     *
     * <p>Note this property is only guaranteed to be honored when using the default connection
     * factories.
     */
     ...
     *
     * <p>Actual TCP KeepAlive values (timeout, number of packets, etc) are configured via the
     ...
     *
     * <p>Response metadata is typically used for troubleshooting issues with AWS support staff when
     * services aren't acting as expected.
     *
     * <p>While this feature is useful for debugging it adds overhead and disabling it may be
     * desired in high throughput applications.
     */
     ...
     *
     * <p>The detail of HTTP Expect Continue is defined at <a
     * href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec8.html#sec8.2.3">Use of the 100
    ...
    /** The maximum number of throttled retries if the initial request fails. */
    ...
    public ClientConfiguration(ClientConfiguration other) {
        ...
        this.maxConsecutiveRetriesBeforeThrottling =
                other.getMaxConsecutiveRetriesBeforeThrottling();
    }
    ...
    /**
     * @deprecated Replaced by {@link #setUserAgentPrefix(String)} and {@link
     *     #setUserAgentSuffix(String)}
    ...
    /**
     * @deprecated Replaced by {@link #withUserAgentPrefix(String)} and {@link
    ...
    /**
     * Sets the HTTP user agent prefix header used in requests and returns the updated
     * ClientConfiguration object.
     *
     * @param prefix The string to prefix to user agent to use when sending requests.
     * @return The updated ClientConfiguration object.
    ...
    /**
     * Returns the HTTP user agent header suffix to add to the end of the user agent header on all
     * requests.
     *
    ...
    /**
     * Sets the HTTP user agent suffix header used in requests and returns the updated
     * ClientConfiguration object.
     *
     * @param suffix The string to suffix to user agent to use when sending requests.
     * @return The updated ClientConfiguration object.
    ...
    /**
     * Returns the Java system property for proxy host depending on {@link #getProtocol()}: i.e. if
     * protocol is https, returns the value of the system property https.proxyHost, otherwise
    ...
    /**
     * Returns the optional proxy host the client will connect through. Returns either the proxyHost
     * set on this object, or if not provided, checks the value of the Java system property for
     * proxy host according to {@link #getProtocol()}: i.e. if protocol is https, returns the value
     * of the system property https.proxyHost, otherwise returns value of http.proxyHost.
     *
    ...
    /**
     * Returns the Java system property for proxy port depending on {@link #getProtocol()}: i.e. if
     * protocol is https, returns the value of the system property https.proxyPort, otherwise
     * returns value of http.proxyPort. Defaults to {@link this.proxyPort} if the system property is
     * not set with a valid port number.
     */
    ...
    /**
     * Returns the optional proxy port the client will connect through. Returns either the proxyPort
     * set on this object, or if not provided, checks the value of the Java system property for
     * proxy port according to {@link #getProtocol()}: i.e. if protocol is https, returns the value
     * of the system property https.proxyPort, otherwise returns value of http.proxyPort.
     *
    ...
    /**
     * Returns the Java system property for proxy user name depending on {@link #getProtocol()}:
     * i.e. if protocol is https, returns the value of the system property https.proxyUser,
    ...
    /**
     * Returns the optional proxy user name to use if connecting through a proxy. Returns either the
     * proxyUsername set on this object, or if not provided, checks the value of the Java system
     * property for proxy user name according to {@link #getProtocol()}: i.e. if protocol is https,
     * returns the value of the system property https.proxyUser, otherwise returns value of
     * http.proxyUser.
     *
    ...
    /**
     * Returns the Java system property for proxy password depending on {@link #getProtocol()}: i.e.
     * if protocol is https, returns the value of the system property https.proxyPassword, otherwise
    ...
    /**
     * Returns the optional proxy password to use if connecting through a proxy. Returns either the
     * proxyPassword set on this object, or if not provided, checks the value of the Java system
     * property for proxy password according to {@link #getProtocol()}: i.e. if protocol is https,
     * returns the value of the system property https.proxyPassword, otherwise returns value of
     * http.proxyPassword.
     *
    ...
    /**
     * Returns the Java system property for nonProxyHosts. We still honor this property even {@link
     * #getProtocol()} is https, see
    ...
    /**
     * Returns the optional hosts the client will access without going through the proxy. Returns
     * either the nonProxyHosts set on this object, or if not provided, checks the value of the Java
     * system property for nonProxyHosts according to {@link #getProtocol()}: i.e. if protocol is
     * https, returns null, otherwise returns value of http.nonProxyHosts.
     *
    ...
    /**
     * Returns the list of authentication methods that should be used when authenticating against an
     * HTTP proxy, in the order they should be attempted.
     *
     * @return An unmodifiable view of the proxy authentication methods that should be attempted, in
     *     order.
     */
    ...
    /**
     * Configure the list of authentication methods that should be used when authenticating against
     * an HTTP proxy, in the order they should be attempted. Any methods not included in this list
     * will not be attempted. If one authentication method fails, the next method will be attempted,
     * until a working method is found (or all methods have been attempted).
     *
     * <p>Setting this value to null indicates using the default behavior, which is to try all
     * authentication methods in an unspecified order.
     *
     * @param proxyAuthenticationMethods The proxy authentication methods to be attempted, in the
     *     order they should be attempted.
     */
    public void setProxyAuthenticationMethods(
            List<ProxyAuthenticationMethod> proxyAuthenticationMethods) {
        if (proxyAuthenticationMethods == null) {
            this.proxyAuthenticationMethods = null;
        } else {
            ValidationUtils.assertNotEmpty(
                    proxyAuthenticationMethods, "proxyAuthenticationMethods");
            this.proxyAuthenticationMethods =
                    Collections.unmodifiableList(
                            new ArrayList<ProxyAuthenticationMethod>(proxyAuthenticationMethods));
        }
    }
     ...
     * @return The updated ClientConfiguration object.
     */
    public ClientConfiguration withProxyAuthenticationMethods(
            List<ProxyAuthenticationMethod> proxyAuthenticationMethods) {
     ...
     * object. User could specify whether the RetryPolicy should honor maxErrorRetry set by {@link
     ...
     *
     * @param maxErrorRetry The maximum number of retry attempts for failed retryable requests. This
     ...
     *
     * <p>This feature requires buffering the entire response (for non-streaming APIs) into memory
     * to enforce a hard timeout when reading the response. For APIs that return large responses
     * this could be expensive.
     *
     * <p>
     *
     * <p>The request timeout feature doesn't have strict guarantees on how quickly a request is
     ...
     * should not be used when absolute precision is needed. <b>Note:</b> This feature is not
     ...
     *
     * <p><b>Note:</b> This feature is not compatible with Java 1.6.
     *
     * @param requestTimeout The amount of time to wait (in milliseconds) for the request to
     *     complete before giving up and timing out.
     * @see {@link ClientConfiguration#setClientExecutionTimeout(int)} to enforce a timeout across
     *     all retries
     */
     ...
     * <p>
     *
     * <p>The client execution timeout feature doesn't have strict guarantees on how quickly a
     * request is aborted when the timeout is breached. The typical case aborts the request within a
     * few milliseconds but there may occasionally be requests that don't get aborted until several
     ...
     *
     * <p>This may be used together with {@link ClientConfiguration#setRequestTimeout(int)} to
    ...
    /**
     * Sets the amount of time (in milliseconds) to allow the client to complete the execution of an
     * API call. This timeout covers the entire client execution except for marshalling. This
     * includes request handler execution, all HTTP request including retries, unmarshalling, etc.
     *
     * <p>This feature requires buffering the entire response (for non-streaming APIs) into memory
     * to enforce a hard timeout when reading the response. For APIs that return large responses
     ...
     * <p><b>Note:</b> This feature is not compatible with Java 1.6.
     *
     * @param clientExecutionTimeout The amount of time (in milliseconds) to allow the client to
     *     complete the execution of an API call. A value of '0' disables this feature.
     * @see {@link ClientConfiguration#setRequestTimeout(int)} to enforce a timeout per HTTP request
     */
     ...
     *
     * <p>Retry throttling is a feature which intelligently throttles retry attempts when a large
     * percentage of requests are failing and retries are unsuccessful, particularly in scenarios of
     * degraded service health. In these situations the client will drain its internal retry
     * capacity and slowly roll off from retry attempts until requests begin to succeed again. At
     * that point the retry capacity pool will begin to refill and retries will once again be
     * permitted.
     *
     * <p>In situations where retries have been throttled this feature will effectively result in
     * fail-fast behavior from the client. Because retries are circumvented exceptions will be
     * immediately returned to the caller if the initial request is unsuccessful. This will result
     * in a greater number of exceptions being returned up front but prevents requests being tied up
     * attempting subsequent retries which are also likely to fail.
     *
     * @return true if retry throttling will be used
     */
    public boolean useThrottledRetries() {
        return throttleRetries
                || getSystemProperty(SDKGlobalConfiguration.RETRY_THROTTLING_SYSTEM_PROPERTY)
                        != null;
    }
     ...
     * attempting subsequent retries which are also likely to fail.
     *
     * @param use true if throttled retries should be used
     */
     ...
     *
     * <p>Note: This does not guarantee that each failed request will be retried up to this many
     * times. Depending on the configured {@link RetryPolicy} and the number of past failed and
     * successful requests, the actual number of retries attempted may be less.
     *
     * <p>This has a default value of {@link #DEFAULT_MAX_CONSECUTIVE_RETRIES_BEFORE_THROTTLING}.
     *
     * @param maxConsecutiveRetriesBeforeThrottling The maximum number of consecutive retries.
     */
    public void setMaxConsecutiveRetriesBeforeThrottling(
            int maxConsecutiveRetriesBeforeThrottling) {
        this.maxConsecutiveRetriesBeforeThrottling =
                ValidationUtils.assertIsPositive(
     ...
     */
    public ClientConfiguration withMaxConsecutiveRetriesBeforeThrottling(
            int maxConsecutiveRetriesBeforeThrottling) {
     ...
     *
     * <p>This is only a <b>hint</b>, and the operating system may choose not to honor it. When
     * using this option, users should <b>always</b> check the operating system's configured limits
     * and defaults. Most OS's have a maximum TCP buffer size limit configured, and won't let you go
     ...
     *
     * <p>Most users do not need to concern themselves with which signature algorithm is being used,
     * as the defaults will be sufficient. This setting exists only so advanced users can opt in to
     * newer signature protocols which have not yet been made the default for a particular
     * service/region.
     *
     * <p>Not all services support all signature algorithms, and configuring an unsupported
     * signature algorithm will lead to authentication failures. Use me at your own risk, and only
     * after consulting the documentation for the service to ensure it actually does supports your
     * chosen algorithm.
     *
     * <p>If non-null, the name returned from this method is used to look up a {@code Signer} class
     ...
     *
     * <p>Tuning this setting down (together with an appropriately-low setting for Java's DNS cache
     ...
     * connections more frequently.
     *
     * <p>By default, it is set to {@code -1}, i.e. connections do not expire.
     *
     ...
     *
     * <p>Tuning this setting down reduces the likelihood of a race condition (wherein you begin
     ...
     * having to re-establish new connections more frequently.
     *
     * <p>By default, it is set to one minute (60000ms).
     *
    ...
    /**
     * Returns the amount of time (in milliseconds) that a connection can be idle in the connection
     * pool before it must be validated to ensure it's still open. This "stale connection check"
     * adds a small bit of overhead to validate the connection. Setting this value to larger values
     * may increase the likelihood that the connection is not usable, potentially resulting in a
     * {@link tink.org.apache.http.NoHttpResponseException}. Lowering this setting increases the
     * overhead when leasing connections from the connection pool. It is recommended to tune this
     * setting based on how long a service allows a connection to be idle before closing.
     *
     * <p>A non positive value disables validation of connections.
     *
     * <p>The default value is {@value #DEFAULT_VALIDATE_AFTER_INACTIVITY_MILLIS} milliseconds.
     */
    ...
    /**
     * Sets the amount of time (in milliseconds) that a connection can be idle in the connection
     * pool before it must be validated to ensure it's still open. This "stale connection check"
     * adds a small bit of overhead to validate the connection. Setting this value to larger values
     * may increase the likelihood that the connection is not usable, potentially resulting in a
     * {@link tink.org.apache.http.NoHttpResponseException}. Lowering this setting increases the
     ...
     * <p>The default value is {@value #DEFAULT_VALIDATE_AFTER_INACTIVITY_MILLIS} milliseconds.
     *
     * @param validateAfterInactivityMillis The allowed time, in milliseconds, a connection can be
     *     idle before it must be re-validated.
     */
     ...
     */
    public ClientConfiguration withValidateAfterInactivityMillis(
    ...
    /**
     * Returns the DnsResolver for resolving AWS IP addresses. Returns the {@link
     * SystemDefaultDnsResolver} by default if not explicitly configured by the user.
     */
    ...
    /**
     * Sets the response metadata cache size. By default, it is set to {@value
    ...
    /**
     * Sets if use expect continue should be enabled. By default, it is set to {@value

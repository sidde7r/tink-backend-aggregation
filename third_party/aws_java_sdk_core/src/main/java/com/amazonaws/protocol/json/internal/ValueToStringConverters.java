...
public class ValueToStringConverters {
    ...
    /** Identity converter. */
    public static final ValueToString<String> FROM_STRING =
            new ValueToString<String>() {
                @Override
    ...
    public static final ValueToString<Integer> FROM_INTEGER =
            new ValueToString<Integer>() {
                @Override
    ...
    public static final ValueToString<Long> FROM_LONG =
            new ValueToString<Long>() {
                @Override
    ...
    public static final ValueToString<Short> FROM_SHORT =
            new ValueToString<Short>() {
                @Override
    ...
    public static final ValueToString<Float> FROM_FLOAT =
            new ValueToString<Float>() {
                @Override
    ...
    public static final ValueToString<Double> FROM_DOUBLE =
            new ValueToString<Double>() {
                @Override
    ...
    public static final ValueToString<Boolean> FROM_BOOLEAN =
            new ValueToString<Boolean>() {
                @Override
    ...
    public static final ValueToString<Date> FROM_DATE =
            new ValueToString<Date>() {
                @Override
    ...
    public static final ValueToString<String> FROM_JSON_VALUE_HEADER =
            new ValueToString<String>() {
                @Override
                public String convert(String val) {

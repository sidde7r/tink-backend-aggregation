...
class ClientConnectionRequestFactory {
    ...
    /**
     * Returns a wrapped instance of {@link ConnectionRequest} to capture the necessary performance
     * metrics.
     *
    ...
    /**
     * The handler behind the dynamic proxy for {@link ConnectionRequest} so that the latency of the
     * {@link ConnectionRequest#get(long, java.util.concurrent.TimeUnit)} can be captured.
     */

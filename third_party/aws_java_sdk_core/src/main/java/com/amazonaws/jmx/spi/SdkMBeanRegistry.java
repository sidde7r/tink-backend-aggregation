...
public interface SdkMBeanRegistry {
    /**
     * Returns true if the registration of the admin MBean under the given object name succeeded;
     * false otherwise.
     */
    public boolean registerMetricAdminMBean(String objectName);

    /**
     * Returns true if the unregistration of the MBean under the given object name succeeded; false
     * otherwise.
     */
    public boolean unregisterMBean(String objectName);

    /**
     * Returns true if the the MBean under the given object name is currently registered; false
     * otherwise.
     */
    ...
    public static class Factory {
        ...
        static {
            ...
            try {
                ...
                LogFactory.getLog(SdkMBeanRegistry.class)

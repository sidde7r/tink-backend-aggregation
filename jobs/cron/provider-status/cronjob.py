...
### Queries
PROVIDERS_QUERY = "sum(tink_circuit_broken_providers{cluster='aggregation', environment='production', className!~'abnamro.*|.*abstract.*|demo.DemoAgent|nxgen.demo.*|fraud.CreditSafeAgent'}) by (provider, market)"
